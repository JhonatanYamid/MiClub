...
include("procedures/accesoevento.php");
include("cmp/seo.php");
									...
									<div class="widget-box transparent" id="recent-box">
										<div class="widget-header">
											<h4 class="widget-title lighter smaller">
												<i class="ace-icon fa fa-users orange"></i>Ingrese código
														...
														<form class="form-horizontal formvalida" id="frmfrmBuscar" name="frmfrmBuscar" role="form" action="<?php echo SIMUtil::lastURI() ?>" method="get">
															...
															<div id="busqueda_pantalla_acceso" class="col-xs-12 col-sm-8">
																<div class="input-group">
																	...
																	<input type="text" name="qryString" id="busqueda_acceso" class="form-control search-query busqueda_acceso" placeholder="Ingrese código">
																	<input type="hidden" name="action" value="search">
																	<!-- <span class="input-group-btn">
																		<select name="IDTipoBusqueda" id="IDTipoBusqueda" class="form-control">
																			<option value="1">Ingrese placa | documento | accion</option>
	...
	<script>
		$("#IDTipoBusqueda").change(function() {
			if ($("#IDTipoBusqueda").val() == 1) {
				$("#busqueda_acceso").attr("placeholder", "Ingrese placa | documento | accion");
				$("#busqueda_nombre").val("");
