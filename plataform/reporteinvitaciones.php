<?
	...
	include( "procedures/reporteinvitaciones.php" );
	include( "cmp/seo.php" );
?>
	</head>
															...
															<form class="form-horizontal formvalida" id="frmfrmBuscar" name="frmfrmBuscar" role="form" action="<?php echo SIMUtil::lastURI()?>" method="get">
																...
																<div class="col-xs-12 col-sm-8">
																	...
																	<div class="input-group">
																		...
																		<input type="text" id="FechaInicio" name="FechaInicio" placeholder="Fecha Ingreso" class="col-xs-12 calendar " title="Fecha Ingreso" value="<?php  if( $_GET["FechaInicio"]=="0000-00-00" || $frm["FechaInicio"]=="" ) echo date("Y-m-d"); else echo $frm["FechaInicio"]; ?>" <?php if($newmode=="updateingreso") echo "readonly"; ?>>
																		<input type="hidden" name="action" value="search">
																	</div>
																	...
																	<div class="input-group">
																		...
																		<span class="input-group-btn">
																			...
																			<button type="button" class="btn btn-primary btn-sm btnRedirect" rel="reporteinvitaciones.php?action=search">
																				Ver Todos
																			</button>
																		</span>
																</div>
