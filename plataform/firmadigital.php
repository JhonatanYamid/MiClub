...
https://appdev.miclubapp.com/plataform/encuestasinfinita.php?action=edit&id=751&IDModulo=135
 <form id="form" action="./encuestasinfinita.php??action=edit&tabencuesta=responderencuesta&id=<?print_r($_GET["id"])?>&IDModulo=#" method="post">
 <!-- <form id="form" action="window.open('./encuestasinfinita.php?action=edit&id=<?print_r($_GET['id'])?>&IDModulo=135')" method="post"> -->
 
    <input type="hidden" name="base64" value="" id="base64">
    <button id="btnLimpiar">Limpiar</button>
    <button id="saveandfinish" class="btn btn-success">Guardar y Finalizar</button>
    <input onclick="window.opener.location.reload(); window.close();" value="Cerrar">
</form>
