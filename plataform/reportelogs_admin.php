<?
	...
	include( "procedures/reportelogs_admin.php" );
	include( "cmp/seo.php" );
?>
	</head>
										...
										<div class="widget-box transparent" id="recent-box">
											<div class="widget-header">
												<h4 class="widget-title lighter smaller">
													<i class="ace-icon fa fa-users orange"></i>CONSULTAR LOG ADMINISTRADOR
												</h4>
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="input-group">
																		...
																		<span class="input-group-btn">
																			...
																			<button type="button" class="btn btn-primary btn-sm btnRedirect" rel="reportelogs_admin.php?action=search">
																				Ver Todos
																			</button>
																		</span>
																	</div>
