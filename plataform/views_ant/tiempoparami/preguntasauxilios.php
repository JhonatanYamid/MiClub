        ...
        ?>
            ...
            <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                <td align="center" width="64">
                    <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPreguntaAuxiliosInfinito=" . $r->IDPreguntaAuxiliosInfinito ?>&tabencuesta=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
                </td>
                ...
                <td align="center" width="64">
                    <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPregunta&id=<?php echo $frm[$key]; ?>&IDPreguntaAuxilios=<? echo $r->IDPreguntaAuxiliosInfinito ?>&tabpreguntaauxilios=formulario&IDAuxilios=<?php echo $frm[$key]; ?>"></a>
                </td>
            </tr>
        <?php
        }
