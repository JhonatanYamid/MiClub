			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal formvalida" role="form" method="POST" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Documento', LANGSESSION); ?> </label>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8"><input type="text" class="col-xs-12 mandatory" id="Nombre" name="Nombre" placeholder="<?= SIMUtil::get_traduccion('', '', 'Ingreseelnombredeldomiciliario', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Nombredeldomiciliario', LANGSESSION); ?>" value="<?php echo $frm["Nombre"]; ?>"></div>
							</div>
						</div>
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'día', LANGSESSION); ?> </label>
								<div class="col-sm-8"><input type="date" class="col-xs-12 mandatory" id="Fecha" name="Fecha" placeholder="" class="col-xs-12 mandatory" title=" <?= SIMUtil::get_traduccion('', '', 'día', LANGSESSION); ?>" value="<?php echo $frm["Fecha"]; ?>"></div>
							</div>
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8"><input type="time" class="col-xs-12 mandatory" id="Hora" name="Hora" placeholder="" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Horadeingresoaproximada', LANGSESSION); ?>" value="<?php echo $frm["Hora"]; ?>"></div>
							</div>
						</div>
						<div class="form-group first">
							<div class="col-xs-12 col-sm-6">
						...
						<div id="Ingreso" class="form-group first <?php if ($frm["Estado"] != "R") {
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="date" class="col-xs-12" id="FechaIngreso" name="FechaIngreso" placeholder="" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Fechadeingreso', LANGSESSION); ?>" value="<?php echo $frm["FechaIngreso"]; ?>">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Fechadeingreso', LANGSESSION); ?> </label>
