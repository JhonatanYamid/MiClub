<form class="form-horizontal formvalida" role="form" method="post" id="EditCampoFormularioEvento<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        if ($_GET[IDCampoFormularioEvento]) {
                $EditCampoFormularioEvento = $dbo->fetchAll("CampoFormularioEvento", " IDCampoFormularioEvento = '" . $_GET["IDCampoFormularioEvento"] . "' ", "array");
                $action = "ModificaCampoFormularioEvento";
        ?>
                <input type="hidden" name="IDCampoFormularioEvento" id="IDCampoFormularioEvento" value="<?php echo $EditCampoFormularioEvento[IDCampoFormularioEvento] ?>" />
        <?php
        }
        ?>
        ...
        <div class="form-group first ">
                ...
                <div class="col-xs-12 col-sm-6">
                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TipodeCampo', LANGSESSION); ?> </label> </label>
...
<table id="simple-table" class="table table-striped table-bordered table-hover">
        ...
        <tbody id="listacontactosanunciante">
                ...
                $r_documento = &$dbo->all("CampoFormularioEvento", "IDEvento = '" . $frm[$key]  . "'");
                ...
                ?>
                        ...
                        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                <td align="center" width="64">
                                        <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDCampoFormularioEvento=" . $r->IDCampoFormularioEvento ?>&tabevento=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
                                </td>
                                ...
                                <td align="center" width="64">
                                        <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaCampoFormularioEvento&id=<?php echo $EditCampoFormularioEvento[$key]; ?>&IDCampoFormularioEvento=<? echo $r->IDCampoFormularioEvento ?>&tabevento=formulario"></a>
                                </td>
                        </tr>
                <?php
                }
