...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'PermiteMostrarHistorial', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoMostrarHistorial', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'PermiteMostrarHistorial',
                    index: 'PermiteMostrarHistorial',
                    align: "left"
                },
                {
                    name: 'LabelMostrarHistorial',
                    index: 'LabelMostrarHistorial',
                    align: "left"
                },
