<form class="form-horizontal formvalida" role="form" method="post" id="EditPredio<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        <div class="form-group first ">
                ...
                <div class="col-xs-12 col-sm-6">
                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Predio', LANGSESSION); ?>: </label>

                        <div class="col-sm-8">
                                <input type="text" id="Predio" name="Predio" placeholder="<?= SIMUtil::get_traduccion('', '', 'Predio', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Predio', LANGSESSION); ?>" value="<?php echo $EditPredio["Predio"] ?>">
                        </div>
                </div>
                ...
                ?>
                        ...
                        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                <td align="center" width="64">
                                        <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPredio=" . $r->IDPredio ?>&tabsocio=predios" class="ace-icon glyphicon glyphicon-pencil"></a>
                                </td>
                                <td><?php echo $r->Predio; ?></td>
                                <td align="center" width="64">
                                        <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPredio&id=<?php echo $frm[$key]; ?>&IDPredio=<? echo $r->IDPredio ?>&tabsociodo=predios"></a>
                                </td>
                        </tr>
                <?php
                }
