                  ...
                  ?>
							...
							<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										  <input type="text" id="FechaVencimiento" name="FechaVencimiento" placeholder="Fecha Vencimiento" class="col-xs-12 calendar" title="Fecha Vencimiento" value="<?php echo $EditLicenciaSocio["FechaVencimiento"] ?>" >
										</div>
								</div>
              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDLicenciaSocio=".$r->IDLicenciaSocio?>&tabsocio=licencias" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
                              <td><?php echo $r->Categoria; ?></td>
                              <td><?php echo $r->FechaVencimiento; ?></td>
                              <td align="center" width="64">
                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaLicenciaSocio&id=<?php echo $frm[$key];?>&IDLicenciaSocio=<? echo $r->IDLicenciaSocio ?>&tabsociodo=licencias" ></a>                                </td>
                      </tr>
                      <?php
                      }
                      ?>
