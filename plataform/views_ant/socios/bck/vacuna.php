...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		<h4 class="widget-title lighter smaller">
			<i class="ace-icon fa fa-users orange"></i>Información de vacuna <?php echo strtoupper(SIMReg::get( "title" ))?>
		</h4>
	</div>
				...
				<div class="col-xs-12">
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
						<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Vacunado tercera dosis </label>
										<div class="col-sm-8">
										...
										<div class="col-sm-8">
											<select name="IDVacunaMarca" id="IDVacunaMarca" class="form-control">
												...
												<?php foreach($marcaVacunas as $value){ ?>
                                  					<option <?php if($frm_vacuna['IDVacunaMarca']==$value["IDVacunaMarca"]) {echo " selected "; }?>value="<?php echo $value["IDVacunaMarca"]?>"><?php echo $value["Nombre"]?></option>                               
												<?php } ?>
											</select>                                           
                                        </div>
								</div>
						...
						<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-4">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Lugar segunda cita</label>
										<div class="col-sm-8">
                                            <input type="text" id="LugarCitaSegunda" name="LugarCitaSegunda" placeholder="Lugar tercera cita" class="col-xs-12" title="LugarCitaSegunda" value="<?php echo $frm_vacuna["LugarCitaSegunda"];?>">
                                        </div>
								</div>
								<div  class="col-xs-12 col-sm-4">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Lugar tercera cita</label>
										<div class="col-sm-8">
                                            <input type="text" id="LugarTerceraDosis" name="LugarTerceraDosis" placeholder="Lugar tercera cita" class="col-xs-12" title="LugarTerceraDosis" value="<?php echo $frm_vacuna["LugarTerceraDosis"];?>">
                                        </div>
								</div>
						</div>					
                        <div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-4">
										...
										<div class="col-sm-8">
                                            <input type="text" id="FechaSegundaDosis" name="FechaSegundaDosis" placeholder="Fecha segunda dosis" class="col-xs-12 calendar" title="FechaSegundaDosis" value="<?php echo $frm_vacuna["FechaSegundaDosis"];?>">
                                        </div>
								</div>
								<div  class="col-xs-12 col-sm-4">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Fecha tercer dosis</label>
										<div class="col-sm-8">
                                            <input type="text" id="FechaTerceraDosis" name="FechaTerceraDosis" placeholder="Fecha tercera dosis" class="col-xs-12 calendar" title="FechaTerceraDosis" value="<?php echo $frm_vacuna["FechaTerceraDosis"];?>">
                                        </div>
								</div>                         		                               
                        </div>
                        <div  class="form-group first ">
                                ...
                                <div  class="col-xs-12 col-sm-4">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Certificado segunda dosis</label>
										<div class="col-sm-8">
										<?php if ($frm_vacuna["ImagenSegundaDosis"]) { ?>
											...
											<br/>
											<br/>
                                            <input type="file" id="ImagenSegundaDosis" name="ImagenSegundaDosis" class="col-xs-12" title="ImagenSegundaDosis" value="<?php echo $frm_vacuna["ImagenSegundaDosis"];?>">
                                        </div>
								</div>
								<div  class="col-xs-12 col-sm-4">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Certificado tercera dosis</label>
										<div class="col-sm-8">
								...
								<div class="col-xs-12 col-sm-6">
									...
									<?php if($campos_vacuna["Valores"]!=null && $campos_vacuna["Valores"]!=""):?>
										...
										<?php foreach($campos as $option):?>											
											<option value="<?php echo $option?>" <?php if($option==$campo["Valor"]){echo 'selected';}?>><?php echo $option?></option>
										<?php endforeach;?>
										</select>
									<?php else:?>
