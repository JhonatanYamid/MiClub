			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
						...
						<a href="procedures/excel-usuarios.php?IDClub=<?php echo SIMUser::get("club") . $otos_parametros; ?>"><img src="assets/img/xls.gif" >Exportar</a>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Club', 'Nombre', 'Email', 'Usuario', 'Autorizado', 'Eliminar' ],
					colModel:[
						{name:'Editar',index:'Club', align:"center"},
						{name:'Club',index:'Club', align:"left"},
						{name:'Nombre',index:'Nombre', align:"left"},
						{name:'Email',index:'Email', align:"left"},
						{name:'User',index:'User', align:"left"},
						{name:'Autorizado',index:'Autorizado', align:"center"},
