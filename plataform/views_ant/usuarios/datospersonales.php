			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo usuario </label>
								<div class="col-sm-8">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Area empresa </label>

								<div class="col-sm-8">
									<input type="text" id="AreaEmpresa" name="AreaEmpresa" placeholder="Area empresa" class="col-xs-12 " title="Area empresa" value="<?php echo $frm["AreaEmpresa"]; ?>">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
