                        ...
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8"> <input type="text" id="Descripcion" name="Descripcion" placeholder="Descripcion" class="form-control" title="Descripcion" value="<?php echo $frm["Descripcion"] ?>" required></div>
