...
<script type="text/javascript">
        ...
        jQuery(grid_selector).jqGrid({
            ...
            url: 'includes/async/administrarPropiedadesTalega.async.php<?= $url_search ?>',
            datatype: "json",
            colNames: ['nombre', 'Eliminar'],
            colModel: [
                {name: 'nombre', index: 'nomnre', align: "left"},
            ...
            width: 855,
            multiselect: true,
            editurl: "includes/async/administrarPropiedadesTalega.async.php",
