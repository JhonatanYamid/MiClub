            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        ...
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-cuestionarioluker.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'NivelDeRolAlCualPerteneceDentroDeLaOrganizacion', 'NombreDelProcesoOAreaDondeSeEncuentraSuRol',
                'NivelDeEstratoSocieconomico', 'NumeroDePersonasQueComponenElNucleoFamiliarPrincipal',
                'NumeroDePersonasDeLaFamiliaQueTienenUnTrabajo', 'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                    index: '',
                ...
                {
                    name: 'NivelDeRolAlCualPerteneceDentroDeLaOrganizacion',
                    index: 'NivelDeRolAlCualPerteneceDentroDeLaOrganizacion',
                    align: "center"
                },
                {
                    name: 'NombreDelProcesoOAreaDondeSeEncuentraSuRol',
                    index: 'NombreDelProcesoOAreaDondeSeEncuentraSuRol',
                    align: "center"
                },
                {
                    name: 'NivelDeEstratoSocieconomico',
                    index: 'NivelDeEstratoSocieconomico',
                    align: "center"
                },
                {
                    name: 'NumeroDePersonasQueComponenElNucleoFamiliarPrincipal',
                    index: 'NumeroDePersonasQueComponenElNucleoFamiliarPrincipal',
                    align: "center"
                },
                {
                    name: 'NumeroDePersonasDeLaFamiliaQueTienenUnTrabajo',
                    index: 'NumeroDePersonasDeLaFamiliaQueTienenUnTrabajo',
                    align: "center"
                },
