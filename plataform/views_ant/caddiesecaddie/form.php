                        ...
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" id="Accion" name="Accion" placeholder="Número de Derecho" class="col-xs-12 mandatory autocomplete-ajax-funcionario" title="número de derecho" value="<?php echo utf8_decode($r_socio["Nombre"] . " " . $r_socio["Apellido"]) ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select name="IDServiciosCaddie" id="IDServiciosCaddie">
                                            ...
                                            $sql_servicios = "Select IDServiciosCaddie,Nombre From ServiciosCaddie  Where Activo = '1' Order by IDServiciosCaddie";
                            ...
                            <div class="form-group first">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8"> <input type="text" id="Categoria" name="Categoria" placeholder="" class="form-control mandatory" title="Categoria" value="<?php echo $frm["Categoria"] ?>" required></div>
