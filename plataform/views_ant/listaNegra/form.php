				...
				<div class="col-xs-12">
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
							<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Numero Derecho </label>
										<div class="col-sm-8"><input type="text" id="NumeroDerecho" name="NumeroDerecho" placeholder="Numero Derecho" class="col-xs-12 mandatory" title="Numero Derecho" value="<?php echo $frm["NumeroDerecho"];?>"></div>
								</div>
								<?php endif; ?>
							</div>
							<div  class="form-group first ">
								...
								<?php if(SIMUser::get("club")==10 || SIMUser::get("club")==8): ?>
								<div  class="col-xs-12 col-sm-6">									
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo tarjeta </label>
										<div class="col-sm-8">
