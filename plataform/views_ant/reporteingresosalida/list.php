...
<script>
	<?php if (SIMUser::get("club") == 10) : ?>
		colNames = ['Tipo', 'Tipo Usuario', 'Accion', 'Documento', 'Nombre', 'Departamento', 'Cargo', 'Predio', 'Fecha/Hora entrada', 'Mecanismo entrada', 'Placa entrada', 'Otros Datos', 'Usuario entrada', 'Fecha/Hora salida', 'Mecanismo salida', 'Placa salida', 'Usuario salida'];
		colModel = [{
				name: 'Tipo',
				index: 'Accion',
				align: "left",
			...
			{
				name: 'MecanismoSalida',
				index: 'MecanismoSalida',
				align: "left",
				search: false
			},
			{
	...
	<?php else : ?>
		colNames = ['Tipo', 'Tipo Usuario', 'Accion', 'Documento', 'Nombre', 'Departamento', 'Cargo', 'Predio', 'Tipo Movimiento', 'Fecha/Hora', 'Mecanismo', 'Otros Datos', 'Usuario'],
			colModel = [{
					name: 'Tipo',
					index: 'Accion',
					align: "left",
