        	...
        	<tr>
            	<td valign="top">
                  ...
                  <tr>
                    ...
                    <td>
                      <textarea rows="4" cols="3" id="Valor" name="Valor" class="form-control mandatory"><?php echo $EditServicioCampo["Valor"] ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>Obligatorio?</td>
                  ...
                  <tr>
                    <td>Orden</td>
                    <td><input id="Orden" type="number" size="25" title="Orden" name="Orden" class="input mandatory" value="<?php echo $EditServicioCampo["Orden"] ?>" /></td>
                  </tr>
                  </table>
