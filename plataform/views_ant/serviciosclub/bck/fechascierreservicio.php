      ...
      endwhile; ?>
              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <?php
                              ...
                              $r_documento =& $dbo->all( "ServicioCierre" , "IDServicio = '" . $frm[$key]  ."' Order by FechaInicio DESC");
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo "?mod=" . SIMReg::get( "mod" ) . "&action=edit&ids=" . $_GET["ids"] ."&IDServicioCierre=".$r->IDServicioCierre?>&tab=fechas" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
                  ...
                  elseif($r->Tee10=="S")
                    echo " - Tee 10"
                              ...
                              <td align="center" width="64">
                                      <a href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaServicioCierre&ids=<?php echo $_GET["ids"];?>&IDServicioCierre=<? echo $r->IDServicioCierre ?>&tab=fechas" class="ace-icon glyphicon glyphicon-remove"></a>                                </td>
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                             ...
                             <td align="center" width="64"></td>
                              ...
                              <td align="center" width="64"></td>
                              <td align="center" width="64"></td>
                              <td align="center"><input type="submit" id="EliminarSeleccion" value="Eliminar Seleccion" >
