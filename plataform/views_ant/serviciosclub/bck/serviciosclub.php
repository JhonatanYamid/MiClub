  ...
  //categorias
    ...
    break;
     ...
     case "EliminaServicioPropiedad":
        $id = $dbo->query( "DELETE FROM ServicioPropiedad WHERE IDServicioPropiedad   = '".$_GET["IDServicioPropiedad"]."' LIMIT 1" );
        SIMHTML::jsAlert("Eliminacion Exitoso");
  ...
  //Caracteristica
    ...
    break;
     ...
     case "EliminaServicioAdicional":
        $id = $dbo->query( "DELETE FROM ServicioAdicional WHERE IDServicioAdicional   = '".$_GET["IDServicioAdicional"]."' LIMIT 1" );
        SIMHTML::jsAlert("Eliminacion Exitoso");
