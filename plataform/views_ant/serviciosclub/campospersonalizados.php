              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo "?mod=" . SIMReg::get( "mod" ) . "&action=edit&id=" . $_GET[id] ."&IDServicioCampo=".$r->IDServicioCampo?>&tab=campos" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
                              <td><?php echo $r->Nombre; ?></td>
                              <td><?php echo $r->Tipo; ?></td>
                              <td><?php echo $r->Valor; ?></td>
                              <td><?php echo $r->Publicar; ?></td>
                              <td align="center" width="64">
                                      <a href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaServicioCampo&id=<?php echo $frm[ $key ];?>&IDServicioCampo=<? echo $r->IDServicioCampo ?>&tab=campos" class="ace-icon glyphicon glyphicon-remove"></a>                                </td>
                      </tr>
                      <?php
                      }
                      ?>
