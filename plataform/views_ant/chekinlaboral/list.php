 ...
 <script type="text/javascript">
     jQuery(function($) {
         ...
         jQuery(grid_selector).jqGrid({
             ...
             datatype: "json",
             colNames: ['<?= SIMUtil::get_traduccion('', '', 'TipoUsuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'NumeroDocumento ', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Detalle ', LANGSESSION); ?>'],
             colModel: [{
                     name: 'TipoUsuario',
                     index: 'TipoUsuario',
                     align: "center"
