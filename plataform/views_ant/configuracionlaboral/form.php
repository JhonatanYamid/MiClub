                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto ver mis permisos
                                </label>
                                <div class="col-sm-8">
                                    <input id=LabelMisPermisos type=text size=25 name=LabelMisPermisos class="input mandatory" title="Orden" value="<?= $frm["LabelMisPermisos"] ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto filtro aprobar vacaciones
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Días de anticipaci&oacute;n para solicitar vacaciones
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    M&aacute;ximo días para aprobar vacaciones
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto Estado Pendiente Vacaciones
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto Estado Pendiente Certificado
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Permitir días a remunerar en dinero
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto días a remunerar en dinero
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Texto días a tomar de vacaciones
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    M&iacute;nimo días de vacaciones en dinero
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Correo notificación certificados
                                </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    <?= SIMUtil::get_traduccion('', '', 'Textoadjuntararchivo', LANGSESSION); ?>
                                </label>
                                <div class="col-sm-8">
