	   			...
	   			<div class="timeline-container">
	   				<div class="timeline-label">
	   					<span class="label label-primary arrowed-in-right label-lg">
	   						<b><?= SIMUtil::get_traduccion('', '', 'Preguntasyrespuestas', LANGSESSION); ?></b>
	   					</span>
	   				</div>
	   										...
	   										<h5 class="widget-title smaller">
	   											<a href="#" class="blue">
	   												<?php
														...
														echo "(" . SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION) . ")" . (isset($nombre_cliente) ? $nombre_cliente . " " . $apellido_cliente : '<em>N/A</em>');;
