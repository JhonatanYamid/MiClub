					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm" name="frm" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
							...
							<div  class="form-group first ">
                              ...
                              <div  class="form-group first ">
    	                        ...
    	                        <div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Desde </label>
										<div class="col-sm-8">
											<input type="text" id="Desde" name="Desde" placeholder="Desde" class="col-xs-12" title="Desde" value="<?php echo $frm["Desde"]; ?>" >años
										</div>
								</div>

								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Hasta </label>
										<div class="col-sm-8">
											<input type="text" id="Hasta" name="Hasta" placeholder="Hasta" class="col-xs-12 mandatory" title="Hasta" value="<?php echo $frm["Hasta"]; ?>" >años
										</div>
								</div>
