						...
						<div class="tabbable">
								...
								<?php if (SIMNet::req("action") == "edit") : ?>
									...
									<li class="<?php if ($_GET[tabnoticias] == "likes") echo "active"; ?>">
										<a data-toggle="tab" href="#likes">
											<i class="green ace-icon fa fa-thumbs-up bigger-120"></i>
											<?= SIMUtil::get_traduccion('', '', 'megusta', LANGSESSION); ?>
										</a>
									</li>
							...
							<div class="tab-content">
								...
								<?php if (SIMNet::req("action") == "edit") : ?>
									...
									<div id="likes" class="tab-pane fade <?php if ($_GET[tabnoticias] == "comentarios") echo "in active"; ?>">
