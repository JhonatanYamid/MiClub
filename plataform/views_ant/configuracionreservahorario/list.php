...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Texto Header Horario', 'Texto Header Resumen', 'Texto Boton Seleccionar Hijo', 'Texto Header Seleccionar Hijo', 'Texto Header Seleccion Hijo',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'LabelHeaderHorario',
                    index: 'LabelHeaderHorario',
                    align: "left"
                },
                {
                    name: 'LabelHeaderResumen',
                    index: 'LabelHeaderResumen',
                    align: "left"
                },
                {
                    name: 'LabelBotonSeleccionarHijo',
                    index: 'LabelBotonSeleccionarHijo',
                    align: "left"
                },
                {
                    name: 'LabelHeaderSeleccionarHijo',
                    index: 'LabelHeaderSeleccionarHijo',
                    align: "left"
                },
                {
                    name: 'LabelHeaderSeleccionHijo',
                    index: 'LabelHeaderSeleccionHijo',
                    align: "left"
                },
