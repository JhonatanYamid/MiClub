	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Codigo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Nombre', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Horaentrada', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Iniciodealmuerzo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Findealmuerzo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Horasalida', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Observaciones', LANGSESSION); ?>', 
			...
			colModel: [
				...
				{name: 'Entrada',index: 'Entrada',align: "left"},
				{name: 'AlmuerzoInicio',index: 'AlmuerzoInicio',align: "left"},
				{name: 'AlmuerzoFin',index: 'AlmuerzoFin',align: "left"},
				{name: 'Salida',index: 'Salida',align: "left"},
