				...
				<div class="col-xs-12">
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Solicitante', LANGSESSION); ?> </label>
								<div class="col-sm-8">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<select name="IDMotivo" id="IDMotivo" class="form-control" <?php if ($_GET["action"] == "edit") {
																									echo " disabled";
																								} ?>>
										<?php foreach ($motivo as $key => $value) { ?>
											<option <?php if ($frm['IDMotivo'] == $key) {
														echo " selected ";
							...
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Remunerado', LANGSESSION); ?>: </label>
								<div class="col-sm-8">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="DiasHabiles" name="DiasHabiles" placeholder="<?= SIMUtil::get_traduccion('', '', 'DiasHabiles', LANGSESSION); ?>" class="col-xs-12 mandatory" title="DiasTomar" value="<?php echo $frm["DiasHabiles"]; ?>" <?php if ($_GET["action"] == "edit") {
																																																																			echo " disabled";
																																																																		} ?>>
								</div>
							</div>
