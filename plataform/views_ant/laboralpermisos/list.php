...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaInicio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaFin', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'DiasATomar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
