 ...
 <script type="text/javascript">
     jQuery(function($) {
         ...
         jQuery(grid_selector).jqGrid({
             ...
             datatype: "json",
             colNames: ['<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'NumeroDocumento ', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Detalle ', LANGSESSION); ?>'],
             colModel: [
                 { name: 'Nombre', index: 'Nombre', align: "left" },
                 { name: 'NumeroDocumento', index: 'NumeroDocumento', align: "left" },
                 { name: 'Detalle', index: '', align: "center" },
             ],
             rowNum: 100,
             rowList: [20, 40, 100],
             sortname: 'Nombre',
