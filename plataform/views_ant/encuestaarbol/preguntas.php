		...
		<table id="simple-table" class="table table-bordered table-hover">
			...
			?>
				<tr>
					...
					<td>
						<select name="IDEncuestaArbolPreguntaSiguiente<?php echo $i; ?>" id="IDEncuestaArbolPreguntaSiguiente<?php echo $i; ?>">
							<option value=""></option>
							<?php
							...
							while ($r_preg = $dbo->fetchArray($qry_preg_club)) : ?>
								<option value="<?php echo $r_preg["IDPreguntaEncuestaArbol"]; ?>" <?php if ($r_preg["IDPreguntaEncuestaArbol"] == $valor_opciones["IDEncuestaArbolPreguntaSiguiente"]) echo "selected";  ?>><?php echo $r_preg["EtiquetaCampo"]; ?></option>
							<?php
							endwhile;
							?>
						</select>
