...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input name="ColorFondoEvento" type="color" value="<?php if (empty($frm["ColorFondoEvento2"])) { echo "#FFFFFF"; } else{ echo $frm["ColorFondoEvento2"]; }    ?>" />
            </div>
        </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Habilitar Wompi? </label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup( SIMResources::$sinoNum , $frm["PasarelaWompi"] , 'PasarelaWompi' , "class='input '" ) ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> URL Wompi </label>
            <div class="col-sm-8">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Api Key Wompi </label>
            <div class="col-sm-8">
                <input type="text" id="ApiKeyWompi" name="ApiKeyWompi" placeholder="ApiKey Wompi" class="col-xs-12" title="ApiKey Wompi" value="<?php echo $frm["ApiKeyWompi"]; ?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
