<form class="form-horizontal formvalida" role="form" method="post" id="EditRegla<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      <tr>
                              ...
                              <th>Nombre Regla</th>
                              <th>Descripcion</th>
                              <th>N&uacute;mero maximo de invitados por d&iacute;a</th>
                              <th>Publicar</th>
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDRegla=".$r->IDRegla?>&tabclub=invitaciones" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
                              <td><?php echo $r->Nombre; ?></td>
                              <td><?php echo $r->Descripcion; ?></td>
                              <td><?php echo $r->MaximoInvitadoDia; ?></td>
                              <td><?php echo $r->Publicar; ?></td>
                              <td align="center" width="64">
                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaRegla&id=<?php echo $frm[$key];?>&IDRegla=<? echo $r->IDRegla ?>&tabclub=invitaciones" ></a>                                </td>
                      </tr>
                      <?php
                      }
                      ?>
