<form class="form-horizontal formvalida" role="form" method="post" id="EditTipoSocioModulo<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
                  ...
                  if( $_GET["IDTipoSocioModulo"] )
                  {
                          ...
                          ?>
                          <input type="hidden" name="IDTipoSocioModulo" id="IDTipoSocioModulo" value="<?php echo $EditTipoSocioModulo["IDTipoSocioModulo"]?>" />
                          <?php
                  }
                  ?>
										...
										<div class="col-sm-8">
												<select class="TipoSocio" name="TipoSocio" class="form-control">
													...
													while ($row_tipo=$dbo->fetchArray($r_tipo)){ ?>
														<option value="<?php echo $row_tipo["Nombre"]; ?>" <?php if($row_tipo["Nombre"]==$EditTipoSocioModulo["TipoSocio"]) echo "selected"; ?>><?php echo $row_tipo["Nombre"]; ?></option>
													<?php } ?>
												</select>
											<?
              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDTipoSocioModulo=".$r->IDTipoSocioModulo?>&tabclub=tiposociomodulo" class="ace-icon glyphicon glyphicon-pencil"></a>                        </td>
                              ...
                              <td align="center" width="64">
                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaModuloTipoSocio&id=<?php echo $frm[$key];?>&IDTipoSocioModulo=<? echo $r->IDTipoSocioModulo ?>&tabclub=tiposociomodulo" ></a>    </td>
                      </tr>
                      <?php
                      }
                      ?>
