              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDCampoDirectorioClub=".$r->IDCampoDirectorioClub?>&tabclub=parametros&tabparametro=camposdirectorioclub" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
                              <td><?php echo $r->Nombre; ?></td>
                              <td><?php echo $r->Descripcion; ?></td>
                              <td><?php echo $r->Publicar; ?></td>
                              <td align="center" width="64">
                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaCampoDirectorioClub&id=<?php echo $frm[$key];?>&IDCampoDirectorioClub=<? echo $r->IDCampoDirectorioClub ?>&tabclub=parametros&tabparametro=camposdirectorioclub" ></a>                                </td>
                      </tr>
                      <?php
                      }
                      ?>
