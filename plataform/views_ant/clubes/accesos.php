        ...
        <form name="frmproAcceso" id="frmproAcceso" action="?mod=<?php echo SIMReg::get("mod") ?>" method="post" class="formvalida" enctype="multipart/form-data">
          ...
          while ($r_pade = $dbo->object($qry_padre)) : ?>
                  ...
                  -->
                        ...
                        <tr>
                          <td>Texto Boton Ejemplo Formato</td>
                          <td><input id="LabelBotonEjemploFormato" type="text" size=25 width="50%" name="LabelBotonEjemploFormato" class="col-xs-12" title="LabelBotonEjemploFormato" value="<?= $EditParametroAcceso["LabelBotonEjemploFormato"]; ?>"></td>
                        </tr>
