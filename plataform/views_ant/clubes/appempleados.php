  ...
  -->
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <?php
												...
												$oCuerpo->Width= 300;
												//$oCuerpo->EnterMode = "p";
												$oCuerpo->Value =  $EditAppEmpleado["MensajeWebView1"];
												$oCuerpo->Create() ;
											?>
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <?php
												...
												$oCuerpo->Width= 300;
												//$oCuerpo->EnterMode = "p";
												$oCuerpo->Value =  $EditAppEmpleado["MensajeWebView2"];
												$oCuerpo->Create() ;
											?>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 1</label>
            <div class="col-sm-8">
                <input id="UrlWebView1" type=text size=25 name="UrlWebView1" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView1"] ?>">
        ...
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 2</label>
            <div class="col-sm-8">
                <input id="UrlWebView2" type=text size=25 name="UrlWebView2" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView2"] ?>">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Encabezado Web View 3</label>
            <div class="col-sm-8">
                <input id="MensajeWebView3" type=text size=25 name="MensajeWebView3" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["MensajeWebView3"] ?>">

            </div>
        </div>
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 3</label>
            <div class="col-sm-8">
                <input id="UrlWebView3" type=text size=25 name="UrlWebView3" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView3"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Encabezado Web View 4</label>
            <div class="col-sm-8">
                <input id="MensajeWebView4" type=text size=25 name="MensajeWebView4" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["MensajeWebView4"] ?>">

            </div>
        </div>
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 4</label>
            <div class="col-sm-8">
                <input id="UrlWebView4" type=text size=25 name="UrlWebView4" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView4"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Encabezado Web View 5</label>
            <div class="col-sm-8">
                <input id="MensajeWebView5" type=text size=25 name="MensajeWebView5" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["MensajeWebView5"] ?>">

            </div>
        </div>
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 5</label>
            <div class="col-sm-8">
                <input id="UrlWebView5" type=text size=25 name="UrlWebView5" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView5"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Encabezado Web View 6</label>
            <div class="col-sm-8">
                <input id="MensajeWebView6" type=text size=25 name="MensajeWebView6" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["MensajeWebView6"] ?>">

            </div>
        </div>
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Url Web View 6</label>
            <div class="col-sm-8">
                <input id="UrlWebView6" type=text size=25 name="UrlWebView6" class="col-xs-12" title="Url Web View" value="<?=$EditAppEmpleado["UrlWebView6"] ?>">
            </div>
        </div>
    </div>
