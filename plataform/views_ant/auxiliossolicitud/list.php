            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-AuxiliosSolicitud.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio/Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Auxilio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TipoRechazo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fechasolicitud', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
