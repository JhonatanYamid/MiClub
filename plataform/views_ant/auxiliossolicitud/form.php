                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6 first">
                                ...
                                ?>
                                <label class="col-sm-4 control-label no-padding-right" for="Usuario"> <?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <input type="text" id="Usuario" name="Usuario" placeholder="<?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?>" class="col-xs-12 mandatory" title="Usuario" value="<?php echo $rowUser["Nombre"]; ?>" readonly="readonly">
                            ...
                            <div class="col-xs-12 col-sm-6 first">
                                ...
                                <div class="col-sm-8"><input type="text" id="FechaTrCr" name="FechaTrCr" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaSolicitud', LANGSESSION); ?>" class="col-xs-12 mandatory" title="FechaTrCr" value="<?php echo $frm["FechaTrCr"]; ?>" readonly="readonly"></div>
                            </div>
