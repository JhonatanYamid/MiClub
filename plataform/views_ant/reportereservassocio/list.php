...
if( SIMNet::req("action") == "search" )
{
	...
	foreach($_GET as $id_campo => $valor_campo):
		...
		$url_otros .= "&".$id_campo ."=". $valor_campo;
	endforeach;
	// echo $url_search;
}//end if
	...
	<div class="widget-box transparent" id="recent-box">
		<div class="widget-header">
			<h4 class="widget-title lighter smaller">
				<i class="ace-icon fa fa-users orange"></i>REPORTE RESERVAS
			</h4>
		...
		<div class="widget-body">
			<div class="widget-main padding-4">
				<div class="row">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="get" name="frm" id="frm" action="" enctype="multipart/form-data">
                       ...
                       <button class="btn btn-info btnEnviar" type="button" rel="frm" >
						...
						<a href="procedures/excel-reserva.php?IDClub=<?php echo SIMUser::get("club").$url_otros; ?>"><img src="assets/img/xls.gif" >Exportar Todas</a>
