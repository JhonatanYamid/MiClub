                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="time" id="HoraFinDisponible" name="HoraFinDisponible" placeholder="<?= SIMUtil::get_traduccion('', '', 'HoraFinEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraFinEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraFinEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraFinEntrega', LANGSESSION); ?>" value="<?php echo $frm["HoraFinDisponible"]; ?>">
                                </div>
                            </div>
                        </div>
