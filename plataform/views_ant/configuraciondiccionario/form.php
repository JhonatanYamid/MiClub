					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
							...
							<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
                                        ...
                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Abreviatura </label>

										<div class="col-sm-8">
											<input type="text" id="Abreviatura" name="Abreviatura" placeholder="Abreviatura" class="col-xs-12 mandatory" title="Abreviatura" value="<?php echo $frm["Abreviatura"]; ?>" >
										</div>
								</div>
								<div  class="col-xs-12 col-sm-6">
