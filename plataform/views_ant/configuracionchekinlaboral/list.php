            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <!--  <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-entrelomascenso.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Textointro', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Textoconfirmacioningreso', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoConfirmacionSalida', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'TextoConfirmacionIngreso',
                    index: 'TextoConfirmacionIngreso',
                    align: "left"
                },
                {
                    name: 'TextoConfirmacionSalida',
                    index: 'TextoConfirmacionSalida',
                    align: "left"
                },
                {
                    name: 'Activo',
