...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Nombre', 'Texto Seleccionar Elemento', 'Numero De Dias', 'Hora Apertura',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'LabelSeleccionarElemento',
                    index: 'LabelSeleccionarElemento',
                    align: "left"
                },
                {
                    name: 'NumeroDiasMostrar',
                    index: 'NumeroDiasMostrar',
                    align: "left"
                },
                {
                    name: 'HoraApertura',
