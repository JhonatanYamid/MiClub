            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-registrocanes.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Raza', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fechadeingreso', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaFin', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'AQuienPertenece', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'AQuienPertenece',
                    index: 'AQuienPertenece',
                    align: "left"
                },
