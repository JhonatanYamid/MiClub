...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'EmailNotificacionContenido', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'CorreoNotificacionComentarioNoticia', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'EmailNotificacionContenido',
                    index: 'EmailNotificacionContenido',
                    align: "left"
                },
                {
                    name: 'CorreoNotificacionComentarioNoticia',
                    index: 'CorreoNotificacionComentarioNoticia',
                    align: "left"
                },
