...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio/Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Periodo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Días', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Diascompensatorio', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'DiasCompensatorio',
                    index: 'DiasCompensatorio',
                    align: "left"
                },
                {
                    name: 'Eliminar',
