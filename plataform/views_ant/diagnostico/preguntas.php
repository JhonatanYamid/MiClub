	...
	<div class="col-xs-12 col-sm-12">
		...
		<table id="simple-table" class="table table-bordered table-hover">
			<tr>
				...
				<td><?= SIMUtil::get_traduccion('', '', 'TerminarEncuesta', LANGSESSION); ?>?</td>
				<!--<td>Ir a pregunta</td>-->
		...
		?>
			...
			<tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
				<td align="center" width="64">
					<a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPreguntaDiagnostico=" . $r->IDPreguntaDiagnostico ?>&tabencuesta=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
				</td>
				...
				<td align="center" width="64">
					<a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPregunta&id=<?php echo $frm[$key]; ?>&IDPreguntaDiagnostico=<? echo $r->IDPreguntaDiagnostico ?>&tabpregunta=formulario"></a>
				</td>
			</tr>
		<?php
		}
