...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	...
	<div class="form-group first">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Diagnosticopara', LANGSESSION); ?>: </label>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Pesomaximopermitido(seenviaranotificacioncuandosupereelpeso)', LANGSESSION); ?></label>

			<div class="col-sm-8">
				<input id="PesoMaximo" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'Pesomaximopermitido(seenviaranotificacioncuandosupereelpeso)', LANGSESSION); ?>" name="PesoMaximo" class="input" value="<?php echo $frm["PesoMaximo"] ?>" />
			</div>
		</div>
	</div>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'PermitediligenciaraBeneficiarios', LANGSESSION); ?>?</label>
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Mostrarenunasolapantallatodaslaspreguntas', LANGSESSION); ?>?</label>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Emaildenotificacioncuandosesupereelpeso', LANGSESSION); ?></label>

			<div class="col-sm-8">
				<input id="EmailAlerta" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'Emaildenotificacioncuandosesupereelpeso', LANGSESSION); ?>" name="EmailAlerta" class="input" value="<?php echo $frm["EmailAlerta"] ?>" />
			</div>
		</div>
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Obligatoriollenardiagnosticoparacontinuarenapp', LANGSESSION); ?> ?</label>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Mensajeparacuandolaencuestadecomoresultadoenelpesopermitido', LANGSESSION); ?></label>
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Mensajeparacuandolaencuestadecomoresultadomasdelpesopermitido', LANGSESSION); ?></label>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-12">
			...
			<div class="col-sm-8">
				...
				<input type="radio" name="DirigidoAGeneral" id="DirigidoAGeneral" value="GE" title="DirigidoA" <?php if ($frm["DirigidoAGeneral"] == "GE") echo "checked"; ?> /><?= SIMUtil::get_traduccion('', '', 'GrupodeUsuarios', LANGSESSION); ?>
	...
	<div id="EmpleadoGrupo" class="form-group first " style="<?php if ($frm["DirigidoAGeneral"] == "GE") echo "";
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				<a href="grupoempleado.php?action=add"><?= SIMUtil::get_traduccion('', '', 'CrearGrupo', LANGSESSION); ?></a>

				<br>
				<a id="agregar_invitadoGrupoEmpleado" href="#"><?= SIMUtil::get_traduccion('', '', 'Agregar', LANGSESSION); ?></a> | <a id="borrar_invitadoGrupoEmpleado" href="#"><?= SIMUtil::get_traduccion('', '', 'Borrar', LANGSESSION); ?></a>
				<br>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				<select name="IDGrupoSocio" id="IDGrupoSocio" class="form-control">
					<option value=""><?= SIMUtil::get_traduccion('', '', 'SeleccioneelGrupo', LANGSESSION); ?></option>
					<?php
