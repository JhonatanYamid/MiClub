              ...
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                      ...
                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                              <td align="center" width="64">
                                      <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDLicenciaInvitado=".$r->IDLicenciaInvitado?>&tabinvitado=licencias&refiere=porteria" class="ace-icon glyphicon glyphicon-pencil"></a>                                </td>
