				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TextoContacto', LANGSESSION); ?> </label>

								<div class="col-sm-8">
									<input type="text" id="LabelRegistro" name="LabelRegistro" placeholder="<?= SIMUtil::get_traduccion('', '', 'TextoContacto', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'TextoContacto', LANGSESSION); ?>" value="<?php echo $frm["LabelRegistro"]; ?>">
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="LabelBuscador" name="LabelBuscador" placeholder="<?= SIMUtil::get_traduccion('', '', 'TextoBuscador', LANGSESSION); ?>" class="col-xs-12 " title="<?= SIMUtil::get_traduccion('', '', 'TextoBuscador', LANGSESSION); ?>" value="<?php echo $frm["LabelBuscador"]; ?>">
								</div>
							</div>
