		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto1File&id=" . $frm[$key] . "&IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto2File&id=" . $frm[$key] . "&IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto3File&id=" . $frm[$key] . "&IDModulo='" . $_GET["IDModulo"] . "'"; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto4File&id=" . $frm[$key] . "&IDModulo='" . $_GET["IDModulo"] . "'"; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=NoticiaFile&id=" . $frm[$key] . "&IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=FotoPortada&id=" . $frm[$key] . "&IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
				<?php
				} else {
				?>
