			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
						...
						<a href="procedures/excel-participante.php?sql=<?php echo base64_encode(trim($sql)); ?>"><img src="assets/img/xls.gif" >Exportar</a>			
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Carrera', 'Transaccion Payu', 'Nombre', 'Documento', 'Telefono','Email', 'Categoria', 'Talla', 'Estado', 'Eliminar' ],
					colModel:[						
						{name:'Editar',index:'', align:"center"},	
						{name:'Carrera',index:'Carrera', align:"left"},
						{name:'TransaccionPayu',index:'TransaccionPayu', align:"left"},
						...
						{name:'Talla',index:'Talla', align:"left"},						
