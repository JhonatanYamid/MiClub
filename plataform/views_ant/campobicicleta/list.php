	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Etiquetadelcampo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'tipo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Obligatorio', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Orden', LANGSESSION); ?>', 
			...
			colModel: [
				...
				{name: 'EtiquetaCampo', index: 'EtiquetaCampo', align: "left"},
				{name: 'TipoCampo', index: 'TipoCampo', align: "left"},
				{name: 'Obligatorio', index: 'Obligatorio', align: "left"},
				{name: 'Orden', index: 'Orden', align: "left"},
