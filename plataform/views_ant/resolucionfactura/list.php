	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
						<?php if($IDClub == $idPadre) echo "'".SIMUtil::get_traduccion('', '', 'sede', LANGSESSION)."',";?>
					   '<?= SIMUtil::get_traduccion('', '', 'Numero', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'rango', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'consecutivofacturas', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'consecutivorecibos', LANGSESSION); ?>', 
			...
			colModel: [
				...
				<?php if($IDClub == $idPadre){?>
					{name: 'Club',index: 'Club',align: "left"},
                <?}?>
				{name: 'Numero',index: 'Numero',align: "left"},
				{name: 'Fecha',index: 'Fecha',align: "left"},
				{name: 'Rango',index: 'Rango',align: "left"},
				{name: 'ConsecutivoFacturas',index: 'ConsecutivoFacturas',align: "left"},
				{name: 'ConsecutivoRecibos',index: 'ConsecutivoRecibos',align: "left"},
