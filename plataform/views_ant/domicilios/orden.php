<form class="form-horizontal formvalida" role="form" method="post" id="frmOrden" name="frmOrden" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" class="form-control">
                    ...
                    <?php
                    $sql_grupos = "Select * From RestauranteDomicilio Where IDClub = '" . SIMUser::get("club") . "'";
    ...
    <?php
    $sql = "SELECT IDCategoriaProducto, Nombre FROM CategoriaProducto WHERE IDClub = '" . SIMUser::get("club") . "' ORDER BY Orden ASC";
    $query = $dbo->query($sql);
