...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		<h4 class="widget-title lighter smaller">
			<i class="ace-icon fa fa-users orange"></i><?= SIMUtil::get_traduccion('', '', 'listadode', LANGSESSION); ?> <?= strtoupper(SIMUtil::get_traduccion('', '', SIMReg::get("titleB"), LANGSESSION)); ?>
		</h4>
	</div>
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
					   ...
					   '<?= SIMUtil::get_traduccion('', '', 'valorenfactura', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'valordedescuento', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'requiereadmin', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'activo', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'disponibledesde', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'disponiblehasta', LANGSESSION); ?>', 
			...
			colModel: [
				...
				{name: 'TipoCalculo', index: 'TipoCalculo', align: "left"},
				{name: 'EnFactura', index: 'EnFactura', align: "left"},
				{name: 'ValorDescuento', index: 'ValorDescuento', align: "left"},
				{name: 'PermisoAdmin', index: 'PermisoAdmin', align: "left"},
				{name: 'Activo', index: 'Activo', align: "left"},
				{name: 'DisponibleDesde', index: 'DisponibleDesde', align: "left"},
				{name: 'DisponibleHasta', index: 'DisponibleHasta', align: "left"},
			...
			onSelectRow: function(id) {
				var row = jQuery(grid_selector).jqGrid('getRowData', id);
				if (row.Editar != ''){
