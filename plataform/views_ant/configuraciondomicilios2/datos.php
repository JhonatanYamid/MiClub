                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" id="TiempoMinimoCancelacion" name="TiempoMinimoCancelacion" placeholder="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" value="<?php echo $frm["TiempoMinimoCancelacion"]; ?>"><?= SIMUtil::get_traduccion('', '', 'minutos', LANGSESSION); ?>
                                </div>
                            </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Pedidominimo', LANGSESSION); ?>
                                    $? </label>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>
                                </label>
