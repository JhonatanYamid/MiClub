		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Introduccion Buscador', 'Label Buscador', 'Activo', 'Eliminar' ],
					colModel:[						
						{name:'Editar',index:'', align:"center"},
						{name:'IntroduccionBuscador', index:'IntroduccionBuscador', align:"left"},
						{name:'LabelBuscador', index:'LabelBuscador', align:"left"},
