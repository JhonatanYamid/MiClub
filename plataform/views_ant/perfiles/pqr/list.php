						...
						<form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-pqr.php">
							<table>
								<tr>
									...
									<td>
										<a href="dashboardpqrsocio.php" target="_blank" class="btn btn-success">Dashboard</a>
									</td>
								<tr>
							</table>
						</form>
							...
							<table>
								<tr>
									...
									<td>
										...
										<input type="hidden" name="IDUsuario" id="IDUsuario" value="<?php echo SIMUser::get("IDUsuario"); ?>">
										<input type="hidden" name="IDPerfil" id="IDPerfil" value="<?php echo SIMUser::get("IDPerfil"); ?>">
										<input class="btn btn-info" type="submit" name="exppqr" id="exppqr" value="Exportar Pqr Eliminados">
										<!-- <a href="procedures/excel-pqr.php?IDClub=<?php echo SIMUser::get("club"); ?>&IDUsuario=<?php echo SIMUser::get("IDUsuario"); ?>&IDPerfil=<?php echo SIMUser::get("IDPerfil"); ?>"><img src="assets/img/xls.gif" >Exportar</a>-->
									</td>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['Editar', 'Numero', 'Fecha', 'Tipo', 'Area', 'Tipo Socio', 'Socio', 'Predio', 'Asunto', 'Descripcion', 'Estado', 'Responsable', 'Eliminar'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
