					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm" name="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<? if (!empty($frm["Icono"])) {
										echo "<img src='" . DIRECTORIO_ROOT . $frm["Icono"] . "' width='300px' height='300px'>";
									?>
										<a href="<? echo $script . ".php?action=delfotoIcono&foto=$frm[Icono]&campo=Icono&id=" . $frm[IDCategoriaDirectorio]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
									<?
									} // END if
									?>
								</div>
