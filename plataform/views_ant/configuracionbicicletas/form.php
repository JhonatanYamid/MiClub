                ...
                <div class="col-xs-12">
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelBotonSolicitarBicicleta">Texto del boton de solicitud: </label>
                                <div class="col-sm-8"><input type="text" id="LabelBotonSolicitarBicicleta" name="LabelBotonSolicitarBicicleta" placeholder="Solicitar Bicicleta" class="col-xs-12 mandatory" title="Texto del boton de solicitud" value="<?php echo $frm["LabelBotonSolicitarBicicleta"]; ?>"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelFechaSolicitarBicicleta">Texto del boton de fecha de solicitud: </label>
                                <div class="col-sm-8"><input type="text" id="LabelFechaSolicitarBicicleta" name="LabelFechaSolicitarBicicleta" placeholder="Fecha de Solicitud" class="col-xs-12 mandatory" title="Texto del boton de fecha de solicitud" value="<?php echo $frm["LabelFechaSolicitarBicicleta"]; ?>"></div>
                            </div>

                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelLugarSolicitarBicicleta">Texto del boton de lugar de solicitud: </label>
                                <div class="col-sm-8"><input type="text" id="LabelLugarSolicitarBicicleta" name="LabelLugarSolicitarBicicleta" placeholder="Lugar de Solicitud" class="col-xs-12 mandatory" title="Texto del boton del lugar de solicitud" value="<?php echo $frm["LabelLugarSolicitarBicicleta"]; ?>"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelBotonSolicitarBicicleta">Texto del boton de historial de bicicletas: </label>
                                <div class="col-sm-8"><input type="text" id="LabelVerMiHistorialBicicleta" name="LabelVerMiHistorialBicicleta" placeholder="Ver Historial" class="col-xs-12 mandatory" title="Texto del boton de historial de bicicletas" value="<?php echo $frm["LabelVerMiHistorialBicicleta"]; ?>"></div>
                            </div>

                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelFechaSolicitarBicicleta">Texto del boton para refrescar pagina: </label>
                                <div class="col-sm-8"><input type="text" id="LabelRefrescarBicicleta" name="LabelRefrescarBicicleta" placeholder="Refrescar Bicicleta" class="col-xs-12 mandatory" title="Texto del boton para refrescar pagina" value="<?php echo $frm["LabelRefrescarBicicleta"]; ?>"></div>
                            </div>
                        </div>
                        
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">¿Permite cancelar bicicleta?: </label>
                                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteCancelarBicicleta"], 'PermiteCancelarBicicleta', "class='input mandatory'") ?>
                            </div>

                            <div class="col-xs-12 col-sm-6 cancelar">
                                <label class="col-sm-4 control-label no-padding-right" for="LabelBotonCancelarBicicleta">Texto del boton de cancelar solicitud: </label>
                                <div class="col-sm-8"><input type="text" id="LabelBotonCancelarBicicleta" name="LabelBotonCancelarBicicleta" placeholder="Cancelar Solicitud" class="col-xs-12 " title="Texto del boton de cancelar solicitud" value="<?php echo $frm["LabelBotonCancelarBicicleta"]; ?>"></div>
                            </div>
                        </div>
