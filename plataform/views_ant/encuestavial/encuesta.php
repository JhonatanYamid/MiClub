...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id="PesoMaximo" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'PesoMaximo', LANGSESSION); ?>" name="PesoMaximo" class="input" value="<?php echo $frm["PesoMaximo"] ?>" />
            </div>
        </div>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id="MensajePesoPermitido" type="text" size="25" title=" <?= SIMUtil::get_traduccion('', '', 'Mensajeparacuandolaencuestadecomoresultadoenelpesopermitido', LANGSESSION); ?>" name="MensajePesoPermitido" class="input" value="<?php echo $frm["MensajePesoPermitido"] ?>" />
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id="MensajePesoSuperado" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'Mensajeparacuandolaencuestadecomoresultadomasdelpesopermitido', LANGSESSION); ?>" name="MensajePesoSuperado" class="MensajePesoSuperado" value="<?php echo $frm["MensajePesoSuperado"] ?>" />
            </div>
        </div>
    </div>
    <!-- Fin Notificación -->
