                        ...
                        <div class="form-group first ">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" id="Tipo" name="Tipo">
                                                ...
                                                <optgroup label="Elegantes">
                                                    ...
                                                    <option value="rating" <?php if ($frm["Tipo"] == "rating") echo "selected"; ?>>Estrella</option>
                                                    <option value="imagen" <?php if ($frm["Tipo"] == "imagen") echo "selected"; ?>>Imagen</option>
                                                    <option value="imagenarchivo" <?php if ($frm["Tipo"] == "imagenarchivo") echo "selected"; ?>>imagen archivo</option>
                                                </optgroup>
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea id="Valores" name="Valores" cols="10" rows="5" class="col-xs-12" title="Descripcion"><?php echo $frm["Valores"]; ?></textarea>
                                    </div>
                                </div>
