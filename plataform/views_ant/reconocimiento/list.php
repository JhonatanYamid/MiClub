				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div id="jqGrid_container">
							...
							<form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-reconocimiento.php">
							<table>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Usuario Reconocido', 'Grupo reconocido','Usuario que Reconoce', 'Comentario', 'Eliminar' ],
					colModel:[
						{name:'Editar',index:'', align:"center"},
						{name:'UsuarioReconocido',index:'UsuarioReconocido', align:"left"},
						{name:'GrupoReconocido',index:'GrupoReconocido', align:"left"},
						{name:'UsuarioReconoce',index:'UsuarioReconoce', align:"left"},
