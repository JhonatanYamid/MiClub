                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permiso Modulos Domicilio
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Domicilio 1 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio1"], 'PermisoDomicilio1', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Domicilio 2 </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Domicilio 3 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio3"], 'PermisoDomicilio3', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Domicilio 4 </label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permiso Modulos Checkin Funcionarios
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Turnos </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoTurnos"], 'PermisoTurnos', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Dia no laboral </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Planificacion diaria</label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoPlanificacionDiaria"], 'PermisoPlanificacionDiaria', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Check-in Funcionarios </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Novedades</label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permisos modulos de Noticias
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permisos modulos de Encuentas
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permisos modulos de Documento
                            </h3>
                        </div>
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permisos modulos de Auxilios
                            </h3>
                        </div>
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Los siguientes permisos son en general para los modulos que se activen
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> Permisos para las reservas
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Puede ver el modulo de agenda en el App </label>
                                <div class="col-sm-8">
