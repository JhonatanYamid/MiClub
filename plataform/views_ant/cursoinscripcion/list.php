		...
		<div class="widget-main padding-4">
			<div class="row">
				<div class="col-xs-12">
					...
					<a href="procedures/excel-curso-inscripcion.php?IDClub=<?php echo SIMUser::get("club") . $otos_parametros; ?>"><img src="assets/img/xls.gif">Exportar</a>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['Editar', 'Numero', 'Socio', 'Curso', 'Nivel', 'Sede', 'Dia', 'FechaInicio', 'Hora', 'Entrenador', 'Estado', 'Eliminar'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
