					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="Nombre" name="Nombre" placeholder="<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>" value="<?php echo utf8_encode($frm["Nombre"]); ?>">
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="Responsable" name="Responsable" placeholder="<?= SIMUtil::get_traduccion('', '', 'Responsable', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Responsable', LANGSESSION); ?>" value="<?php echo utf8_encode($frm["Responsable"]); ?>">
								</div>
							</div>
