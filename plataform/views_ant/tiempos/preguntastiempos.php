<form class="form-horizontal formvalida" role="form" method="post" id="EditPregunta<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    if ($_GET[IDPreguntaTiempos]) {
        $EditPregunta = $dbo->fetchAll("PreguntaTiempos", " IDPreguntaTiempos = '" . $_GET["IDPreguntaTiempos"] . "' ", "array");
        $action = "ModificaPregunta";
    ?>
        <input type="hidden" name="IDPreguntaTiempos" id="IDPreguntaTiempos" value="<?php echo $EditPregunta[IDPreguntaTiempos] ?>" />
    <?php
    }
    ?>
    ...
    <div class="clearfix form-actions">
        <div class="col-xs-12 text-center">
            ...
            <input type="hidden" name="IDTiempos" id="IDTiempos" value="<?php echo $frm[$key] ?>" />
...
<table id="simple-table" class="table table-striped table-bordered table-hover">
    ...
    <tbody id="listacontactosanunciante">
        ...
        $r_documento = &$dbo->all("PreguntaTiempos", "IDTiempos = '" . $frm[$key]  . "'");
        ...
        ?>
            ...
            <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                <td align="center" width="64">
                    <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPreguntaTiempos=" . $r->IDPreguntaTiempos ?>&tabencuesta=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
                </td>
                ...
                <td align="center" width="64">
                    ...
                    <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPregunta&id=<?php echo $EditPregunta[$key]; ?>&IDPreguntaTiempos=<? echo $r->IDPreguntaTiempos ?>&tabpreguntatiempos=formulario&IDTiempos=<?php echo $frm[$key]; ?>" ></a>
                </td>
            </tr>
        <?php
        }
