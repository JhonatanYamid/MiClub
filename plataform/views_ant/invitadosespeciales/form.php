				...
				<form class="form-horizontal formvalida" role="form" method="post" name="frm" id="frm" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
                            ...
                            <div  class="form-group first ">
                                ...
                                <div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										  <input type="text" id="FechaFin" name="FechaFin" placeholder="Fecha Fin" class="col-xs-12 <?php if($newmode!="updateingreso") echo "calendar"; ?> " title="Fecha Fin" value="<?php  if($frm["FechaFin"]=="0000-00-00" || $frm["FechaFin"]=="" ) echo date("Y-m-d"); else echo $frm["FechaFin"]; ?>" <?php if($newmode=="updateingreso") echo "readonly"; ?>>
										</div>
								</div>
							...
							for($cont_invitado=1;$cont_invitado<=5;$cont_invitado++):
								...
								$IDInvitadoEdit = $array_datos_invitados[$cont_invitado]["IDInvitado"];
								if(!empty($IDInvitadoEdit)):
									$datos_invitado_edit = $dbo->fetchAll( "Invitado", " IDInvitado = '" . $IDInvitadoEdit . "' ", "array" );
									$datos_placa_edit = $dbo->getFields( "VehiculoInvitacion" , "Placa" , "IDVehiculo = '".$frm["IDVehiculo"]."'" );
								endif;
                            ...
                            <div class="col-sm-12">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="smaller">
													Invitado <?php if($cont_invitado!=1): echo "Grupo " . $cont_invitado; endif; ?>
												</h4>
											</div>
                                                    	...
                                                    	<div  class="form-group first ">
                                                                ...
                                                                <div  class="col-xs-12 col-sm-6">
                                                                 ...
                                                                 <div  class="col-xs-12 col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                          <input id="Apellido<?php echo $cont_invitado; ?>" type="text" size="25" title="Apellido" name="Apellido<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input " value="<?php if(!empty($datos_invitado_edit["Apellido"])){ echo $datos_invitado_edit["Apellido"]; } ?>"  />
                                                                        </div>
                                                                </div>
                                                            ...
                                                            <div  class="form-group first ">
                                                                ...
                                                                <div  class="col-xs-12 col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                          <input id="Email<?php echo $cont_invitado; ?>" type="text" size="25" title="Email" name="Email<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input " value="<?php if(!empty($datos_invitado_edit["Email"])){ echo $datos_invitado_edit["Email"]; } ?>"  />
                                                                        </div>
                                                                </div>
                                                                 ...
                                                                 <div  class="col-xs-12 col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                        <input id="Telefono<?php echo $cont_invitado; ?>" type="text" size="25" title="Telefono" name="Telefono<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input" value="<?php if(!empty($datos_invitado_edit["Telefono"])){ echo $datos_invitado_edit["Telefono"]; } ?>" />
                                                             ...
                                                             <div  class="form-group first ">
                                                                ...
                                                                <div  class="col-xs-12 col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                          <input type="text" id="FechaNacimiento<?php echo $cont_invitado; ?>" name="FechaNacimiento<?php echo $cont_invitado; ?>" placeholder="Fecha Nacimiento" class="col-xs-12 calendar" title="Fecha Nacimiento" value="<?php if(!empty($datos_invitado_edit["FechaNacimiento"])){ echo $datos_invitado_edit["FechaNacimiento"]; } ?>" >
                                                                        </div>
                                                                </div>

                                                                 <div  class="col-xs-12 col-sm-6">
                                                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo Sangre | Nombre Evento </label>

                                                                        <div class="col-sm-8">
                                                                        <input id="TipoSangre<?php echo $cont_invitado; ?>" type="text" size="25" title="TipoS angre" name="TipoSangre<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input" value="<?php if(!empty($datos_invitado_edit["TipoSangre"])){ echo $datos_invitado_edit["TipoSangre"]; } ?>" />
                                                              ...
                                                              <div  class="form-group first ">
                                                                  <?php
                                                                    if(SIMUser::get("club") == 16)
                                                                    {
                                                                  ?>                                                                    
                                                                      <div  class="col-xs-12 col-sm-6">
                                                                          <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Carnet </label>
                                                                          <div class="col-sm-8">
                                                                            <input id="NumeroCarnet<?php echo $cont_invitado; ?>" type="text" size="25" title="Numero Carnet" name="NumeroCarnet"  alt="<?php echo $cont_invitado; ?>" class="input" value="<?php if(!empty($datos_invitado_edit["NumeroCarnet"])){ echo $datos_invitado_edit["NumeroCarnet"]; } ?>" />
                                                                          </div>
                                                                      </div>
                                                             ...
                                                             <div  class="form-group first ">
                                                                ...
                                                                <?php if($cont_invitado==1): ?>


                                                                 <div  class="col-xs-12 col-sm-6">
                                                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo Invitado. </label>

                                                                        <div class="col-sm-8">
                                                                          <?php  foreach(SIMResources::$tipoinvitado as $key_tipo => $dato_tipo): ?>
                                                                  <input type="radio" name="TipoInvitado<?php echo $cont_invitado; ?>" id="TipoInvitado<?php echo $cont_invitado; ?>" value="<?php echo $dato_tipo; ?>" <?php if($frm["TipoInvitacion"]==$dato_tipo) echo "checked"; ?>><?php echo $dato_tipo; ?>
                                                                <?php endforeach;?>
                                                                        </div>
                                                                </div>

                                                                 <div  class="col-xs-12 col-sm-6">
                                                                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Es cabeza de invitacion? </label>

                                                                            <div class="col-sm-8">
																		  	                              <input type="radio" name="CabezaInvitacion<?php echo $cont_invitado; ?>" id="CabezaInvitacion<?php echo $cont_invitado; ?>" value="S" <?php if($cont_invitado==1) echo "checked"; ?>>S</option>
                                                                            <input type="radio" name="CabezaInvitacion<?php echo $cont_invitado; ?>" id="CabezaInvitacion<?php echo $cont_invitado; ?>" value="S">N</option>
	                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                            ...
                                                            <?php
															$cont_vehiculo=1;
															for($cont_vehiculo=1;$cont_vehiculo<=3;$cont_vehiculo++): ?>
                                  <div  class="form-group first ">
                                    <div  class="col-xs-12 col-sm-4">
                                      <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Placa </label>
                                      <div class="col-sm-8">
                                        <input id="Placa<?php echo $cont_vehiculo; ?>" type="text" size="25" title="Placa" name="Placa<?php echo $cont_vehiculo; ?>" alt="<?php echo $cont_vehiculo; ?>" class="input autocomplete-ajax_vehiculo" value="<?php if(!empty($datos_placa_edit) && $cont_vehiculo == 1){ echo $datos_placa_edit; } ?>"  />
