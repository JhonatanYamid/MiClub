...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        datatype: "json",
        colNames: ['Registrar Ingreso', 'Documento Invitado', 'Nombre Invitado', 'Tipo', 'Predio', 'Fecha Desde', 'Fecha de Hasta', 'Socio','Observacion', 'Accion','Fecha Creacion Inv', 'Creado Por'],
        colModel: [{
                name: 'Ingreso',
                index: 'Ingreso',
                align: "center"
