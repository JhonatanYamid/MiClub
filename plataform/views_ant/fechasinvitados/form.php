					...
					<form class="form-horizontal formvalida" role="form" method="post" name="frm" id="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="Fecha" name="Fecha" placeholder="<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>" value="<?php echo $frm["Fecha"] ?>">
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<textarea rows="5" cols="50" id="Motivo" name="Motivo" class="input"><?php echo $frm["Motivo"] ?></textarea>
								</div>
							</div>
