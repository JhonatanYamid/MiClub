					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<?php echo $frm["Numero"]; ?>
									<input type="hidden" name="Numero" value="<?php echo $frm["Numero"]; ?>">
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-12">
								...
								<div class="col-sm-6">
									...
									<input type="text" id="Accion" name="Accion" placeholder="<?= SIMUtil::get_traduccion('', '', 'AccionNombreApellidoNumeroDocumento', LANGSESSION); ?>" class="col-xs-12 mandatory autocomplete-ajax" title="<?= SIMUtil::get_traduccion('', '', 'Accion', LANGSESSION); ?>" <?php if ($_GET["action"] != "add") echo "readonly"; ?> value="<?php echo $r_socio["Apellido"] . " " . $r_socio["Nombre"] . $label_accion ?>">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									...
									<input type="text" id="Fecha" name="Fecha" placeholder="<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>" class="col-xs-12 <?php if ($_GET["action"] != "add") echo "";
																																																																			...
																																																																			else echo date("Y-m-d"); ?>" readonly='readonly'>
						...
						<div class="form-group first">
							<div class="col-sm-12">
								...
								<?= SIMUtil::get_traduccion('', '', 'Notificartambienalarea', LANGSESSION); ?>: <select name="IDAreaInteres" id="IDAreaInteres">
									<option value=""></option>
									<?php
									$sql_area_club = string;
						...
						<div class="row">
							<div class="col-xs-12 col-sm-10 col-sm-offset-1">
								<div class="timeline-container">
									...
									<?
									$sql_detalle = "SELECT IDDetallePqr,IDPqr,IDUsuario,IDSocio,Fecha,Respuesta,Archivo,MostrarSocio,CorreoRespuestaSocio
													...
													<div class="widget-box transparent">
														...
														<div class="widget-body">
															<div class="widget-main">
																...
																<p>
																	Correo socio donde se envia la respuesta:
																	<?php

																	echo $detalle->CorreoRespuestaSocio; ?>
																</p>
