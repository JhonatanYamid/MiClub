    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input type="hidden" id="IDSeccionGaleria2" name="IDSeccionGaleria2" value="<?php echo $frm["IDSeccionGaleria2"]; ?>">
                <input type="text" id="NombreSeccion" name="NombreSeccion" class="input" value="<?php echo $dbo->getFields("SeccionGaleria2", "Nombre", "IDSeccionGaleria2 = '" . $frm["IDSeccionGaleria2"] . "'") ?>" readonly>
                <a href="PopupSeccionGaleria2.php" target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=1000'); return false;" class="ace-icon glyphicon glyphicon-search"></a>
