...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="time" id="HoraInicioDomicilios" name="HoraInicioDomicilios" placeholder="<?= SIMUtil::get_traduccion('', '', 'HoraInicioEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraInicioEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraInicioEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'HoraInicioEntrega', LANGSESSION); ?>" value="<?php echo $frm["HoraInicioDomicilios"]; ?>">
            </div>
        </div>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="number" id="TiempoMinimoPedido" name="TiempoMinimoPedido" placeholder="Tiempo Minimo Pedido" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Tiempominimoparahacerpedido', LANGSESSION); ?>" value="<?php echo $frm["TiempoMinimoPedido"]; ?>"><?= SIMUtil::get_traduccion('', '', 'minutos', LANGSESSION); ?>
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="text" id="IntervaloEntrega" name="IntervaloEntrega" placeholder="<?= SIMUtil::get_traduccion('', '', 'IntervaloEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'IntervaloEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'IntervaloEntrega', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'IntervaloEntrega', LANGSESSION); ?>" value="<?php echo $frm["IntervaloEntrega"]; ?>"><?= SIMUtil::get_traduccion('', '', 'minutos', LANGSESSION); ?>
            </div>
        </div>
