				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
                        ...
                        <div  class="form-group first ">
                            ...
                            <div  class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Label pregunta fecha de tecrea dosis
                                </label>
                                <div class="col-sm-8">
                                    <input id=LabelFechaTerceraDosis type=text size=25  name=LabelFechaTerceraDosis class="input" title="Label Fecha Tercera Dosis" value="<?=$frm["LabelFechaTerceraDosis"]?>">
                                </div>
                            </div>

														<div  class="col-xs-12 col-sm-6">
																<label class="col-sm-4 control-label no-padding-right" for="form-field-1">
																		Label pregunta cargar certificado tercera vacuna
																</label>
																<div class="col-sm-8">
																		<input id=LabelCertificadoTerceraVacuna type=text size=25  name=LabelCertificadoTerceraVacuna class="input" title="Label Certificado" value="<?=$frm["LabelCertificadoTerceraVacuna"]?>">
																</div>
														</div>
                        </div>
                        ...
                        <div  class="form-group first ">
                            <div  class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Obligatorio lugar tercera vacuna?
                                </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["ObligatorioLugarTerceraVacuna"] , 'ObligatorioLugarTerceraVacuna' , "class='input mandatory'" ) ?>
                                </div>
                            </div>
                            <div  class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Obligatorio fecha tercera vacuna?
                                </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["ObligatorioFechaTerceraVacuna"] , 'ObligatorioFechaTerceraVacuna' , "class='input mandatory'" ) ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div  class="form-group first ">
                            <div  class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                                    Obligatorio certificado tercera vacuna?
                                </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["ObligatorioCertificadoTerceraVacuna"] , 'ObligatorioCertificadoTerceraVacuna' , "class='input mandatory'" ) ?>
                                </div>
                            </div>
                        </div>
