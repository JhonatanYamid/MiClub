...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'MensajeCancelacion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'MensajeSolicitar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
				},
				{
					...
					index: 'MensajeCancelacion',
					align: "left"
				},
				{
					name: 'MensajeSolicitar',
					index: 'MensajeSolicitar',
					align: "left"
				},
				{
					name: 'Eliminar',
