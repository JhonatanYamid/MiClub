					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm" name="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<input type="text" id="ComentarioCategoria" name="ComentarioCategoria" placeholder="<?= SIMUtil::get_traduccion('', '', 'ComentariosCategoria', LANGSESSION); ?>" class="col-xs-12" title="ComentarioCategoria" value="<?php echo $frm["ComentarioCategoria"]; ?>">
								</div>
							</div>
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="col-sm-8">
									<? if (!empty($frm["Icono"])) {
										echo "<img src='" . CLUB_ROOT . $frm["Icono"] . "' >";
									?>
