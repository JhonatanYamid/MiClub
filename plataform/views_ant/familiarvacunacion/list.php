            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-vacunacionfamiliar.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Socio', 'Tipo Documento', 'Numero Documento', 'Nombres', 'Apellidos',
                'Fecha De Nacimiento', 'Edad', 'Eps', 'Parentesco', 'CiudadDondeReside', 'Correo Electronico', 'Celular',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'CiudadDondeReside',
                    index: 'CiudadDondeReside',
                    align: "left"
                },
                {
