...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $(".TipoCampoIngresos").change(function() {
            if ($(this).val() == 'select') {
                $(".ContentOrigenDatos").show("slow");
            } else {
                $(".ContentOrigenDatos").hide("slow");
            }
        });
        $(".OrigenDatos").change(function() {
            if ($(this).val() == 'Tablas') {
                $(".selecttabla").show("slow");
                $(".opcionesrespuesta").hide("slow");
            } else if ($(this).val() == "Manual") {
                $(".selecttabla").hide("slow");
                $(".opcionesrespuesta").show("slow");
            }
        });
