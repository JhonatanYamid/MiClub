	...
	<div class="widget-box transparent" id="recent-box">
		<div class="widget-header">
			<h4 class="widget-title lighter smaller">
				<i class="ace-icon fa fa-users orange"></i>Contratista Pendiente de salida
			</h4>
       ...
       <div class="page-header">
							<h1>
								<a href="#" id="veringresado">Pendiente salida</a>
								<small>
			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
                        ...
                        <a href="procedures/excel-pendientessalida.php?IDClub=<?php echo SIMUser::get("club"); ?>"><img src="assets/img/xls.gif" >Exportar</a>								
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selectoringresado).jqGrid({
					...
					url:'includes/async/reportesalidas.async.php<?=$url_search ?>',
					datatype: "json",
					...
					width:855,
					multiselect: true,
					editurl: "includes/reportesalidas.async.php",
