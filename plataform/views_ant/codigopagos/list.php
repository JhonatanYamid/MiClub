							...
							<table>
								<tr>
										...
										<td>
											...
											<input class="btn btn-info" type="submit" name="expbono" id="expbono" value="Exportar" >
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Documento','Socio', 'Codigo', 'Valor', 'Disponible', 'Creado Por ','FechaCreacion','FechaRedimido','Eliminar' ],
					colModel:[
						...
						{name:'Valor',index:'Valor', align:"left"},
						...
						{name:'FechaRedimido',index:'FechaRedimido', align:"left"},
