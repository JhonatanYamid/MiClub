...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Cantidad CaddiesEspecial', 'Texto Espera', 'Texto Explicacion Seleccion Caddie', 'Texto Seleccion Servicio', 'Texto Mis Reservas Caddies',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'CantidadCaddiesEspecial',
                    index: 'CantidadCaddiesEspecial',
                    align: "left"
                },
                {
                    name: 'TextoEspera',
                ...
                {
                    name: 'LabelExplicacionSeleccionCaddie',
                    index: 'LabelExplicacionSeleccionCaddie',
                    align: "left"
                },
                {
                    name: 'LabelSeleccionServicio',
                    index: 'LabelSeleccionServicio',
                    align: "left"
                },
                {
                    name: 'LabelMisReservasCaddies',
                    index: 'LabelMisReservasCaddies',
                    align: "left"
                },
