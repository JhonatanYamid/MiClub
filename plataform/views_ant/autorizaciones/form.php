                                        ...
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group first ">
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="NumeroDocumento<?php echo $cont_invitado; ?>" type="text" size="25" title="Numero Documento" name="NumeroDocumento<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input autocomplete-ajax_tblinvitado txtPistola" value="<?php if (!empty($datos_invitado_edit["NumeroDocumento"])) {
                                            ...
                                            <div class="form-group first ">
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="Predio<?php echo $cont_invitado; ?>" type="text" size="25" title="Predio" name="Predio<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input" value="<?php if (!empty($datos_invitado_edit["Predio"])) {
                                            ...
                                            ?>
                                                <div class="form-group first ">
                                                    <div class="col-xs-12 col-sm-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="ARL<?php echo $cont_invitado; ?>" type="text" size="25" title="ARL" name="ARL<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="input " value="<?php if (!empty($datos_invitado_edit["ARL"])) {
                                                ...
                                                <div class="form-group first ">
                                                    <div class="col-xs-12 col-sm-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="FechaVencimientoArl<?php echo $cont_invitado; ?>" type="text" size="25" title="ARL" name="FechaVencimientoArl<?php echo $cont_invitado; ?>" alt="<?php echo $cont_invitado; ?>" class="col-xs-12 calendar" value="<?php if (!empty($datos_invitado_edit["FechaVencimientoArl"])) {
