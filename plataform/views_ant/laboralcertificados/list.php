...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Usuarioqueautoriza', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Tipo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fechas', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Anombrede', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Comentario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'ComentarioAprobacion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaAprobación', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
