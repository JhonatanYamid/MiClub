...
$fechats = strtotime($fecha_actual); 
    ...
    case 0: $dia_txt= "D"; break;
    case 1: $dia_txt= "L"; break;
    case 2: $dia_txt= "M"; break;
    case 3: $dia_txt= "MI"; break;
    case 4: $dia_txt= "J"; break;
    case 5: $dia_txt= "V"; break;
    case 6: $dia_txt= "S"; break;
}  
											...
											<tr>
												...
												<td valign="top">
													...
													<!-- <?php if($CampoObservacionGeneral == "S"  && $datos_invitado["ObservacionGeneral"] != '' ){ ?> -->
															...
															<td>&nbsp;
																Club Canje: <?php echo $datos_invitado["ObservacionGeneral"] ?>
															</td>
														</tr>
													<!-- 	<?php } ?> -->
														<?php
											...
											<tr>
												...
												<?php
															...
															<?php
																...
																<span class="bigger-110" >Predio al que se dirige:</span>
													...
													while ($row_predio_socios = $dbo->fetchArray( $result_predios )){
														...
														?>
															...
															<input id="PredioIngresoSocio<?php echo $contador_predio_s ?>"  name="PredioIngresoSocio" type="radio" class="ace" value="<?php echo  $regid/* $datos_socio["IDSocio"] */; ?>" />
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
						...
						<div class="clearfix form-actions">
								<div class="col-xs-12 text-center">
                                    ...
                                    <input type="hidden" name="IDClub" id="IDClub" value="<?php if(empty(SIMUser::get("club")/* $frm["IDClub"] */)) echo SIMUser::get("club"); else echo $frm["IDClub"];  ?>" />
											...
											<tr>
												<td colspan="2">
													<div style="overflow:scroll;height:200px;">
														...
														$sql_log_acceso = "Select * From LogAcceso Where IDInvitacion = '" . $id_registro . "' and ( DATE_FORMAT(FechaIngreso,'%Y-%m-%d') = '" . date("Y-m-d") . "' or DATE_FORMAT(FechaSalida,'%Y-%m-%d') = '" . date("Y-m-d") . "')   $condicion_log_acceso Order by IDLogAcceso Desc";
