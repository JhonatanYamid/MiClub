																	...
																	<tr>
																		<td width=800px>
																			...
																			if($dbo->rows($r_campos)>0){ ?>
																					...
																					<table class="table table-striped table-bordered table-hover">
																						<?php while($r=$dbo->object($r_campos)){  ?>
																						<tr>
								...
								if($datos_invitacion["CabezaInvitacion"]=="S"):
									...
									$contador_grupo++;
										if($nucleo_socio=="1"):
											...
											$resp=SIMWebService::get_reservas_socio( SIMUser::get("club"), $id_registro, $Limite, $IDReserva, $IDUsuario);
											$resp_como_invitado=SIMWebServiceApp::get_reservas_socio_invitado(SIMUser::get("club"),$id_registro,0);
