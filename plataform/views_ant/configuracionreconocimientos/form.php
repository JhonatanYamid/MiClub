                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Imagen Cultura de segridad y salud en el trabajo </label>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="LabelBotonDetalle" name="LabelBotonDetalle" placeholder="Label Reconocer Seguridad" class="col-xs-12 mandatory" title="Label Reconocer Seguridad" value="<?php echo $frm["LabelBotonDetalle"]; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="LabelBotonEnviarReconocimiento" name="LabelBotonEnviarReconocimiento" placeholder="Label Reconocer Seguridad" class="col-xs-12 mandatory" title="Label Reconocer Seguridad" value="<?php echo $frm["LabelBotonEnviarReconocimiento"]; ?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="LabelRazonReconocer" name="LabelRazonReconocer" class="col-xs-12 mandatory" title="Label Reconocer Seguridad" value="<?php echo $frm["LabelRazonReconocer"]; ?>">
                                </div>
                            </div>
                        </div>
