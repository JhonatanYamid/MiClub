...
include("procedures/registrarconsumoqr.php");
include("cmp/seo.php");
                                                        ...
                                                        <form class="form-horizontal formvalida" id="frmfrmBuscarAlimentosCasino" name="frmfrmBuscarAlimentosCasino" role="form" action="<?php echo SIMUtil::lastURI() ?>" method="GET">
                                                            ...
                                                            <div id="busqueda_pantalla_acceso" class="col-xs-12 col-sm-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="qryString" id="busqueda_acceso" placeholder="<?= SIMUtil::get_traduccion('', '', 'IngreseCedula', LANGSESSION); ?> QR" class="form-control search-query busqueda_acceso">
