...
const BASE_URL = URLBASE+"services/club.php";
const CLUB_ID = document.getElementById("IDClub").value;
const SERVICIO_ID = document.getElementById("IDServicio").value;
const APP_VERSION = "33";
const USER = 'tokengenerico';
const PASS = 'M1Club123*';
...
function makeGETTokenRequest<T>(): Promise<ServerResponse<T>> {
    const headers = new Headers();
    headers.append("Accept", "application/json");
    const formData = new FormData();
