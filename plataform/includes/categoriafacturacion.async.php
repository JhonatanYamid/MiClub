...
if($IDClub != $idPadre)
	$where .= " AND IDCategoriaFacturacion IN (SELECT IDCategoriaFacturacion FROM CategoriaFacturacionClub WHERE IDClub = $IDClub)";
...
switch( $oper )
{
	...
	case "del":
		...
		$sql_delete = "DELETE FROM CategoriaFacturacion WHERE IDCategoriaFacturacion = '" . $_POST["id"] . "' LIMIT 1";
		//echo "<br>";
