...
$array_valida = array(  
	 "IDSesion" => "IDSesion" , "IDRegistro" => "IDRegistro" , "Inicio" => "Inicio" , "Datos" => "Datos" 	
); 
...
<tr>
			...
			<tr>
			<td  class="columnafija" > IDRegistro </td><td><input id=IDRegistro type=text size=25  name=IDRegistro class="input mandatory " title="IDRegistro" value="<?=$frm[IDRegistro] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDSesion ?></td> <td nowrap><? echo $r->IDRegistro ?></td> <td nowrap><? echo $r->Inicio ?></td> <td nowrap><? echo $r->Datos ?></td> 
