<?php
include("/var/www/vhosts/calzadocaprino.com/httpdocs/newsite/admin/config.inc.php");
...
$sub = $total/4;
echo "SELECT * FROM Producto WHERE 1 LIMIT 0, ".round($sub)."";


$QryProdu = $dbo->query( "SELECT * FROM Producto WHERE 1 LIMIT 0, ".round($sub)."");
