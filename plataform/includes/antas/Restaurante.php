...
SIMReg::setFromStructure( array(
					"title" => $dbo->getFields( "Club" , "Nombre" , "IDClub = '".$_SESSION[IDClub]."'")." :: " ." Restaurante",
					"table" => "Restaurante",
					"key" => "IDRestaurante",
					"mod" => "Restaurante"
) );
...
<tr>
  <td  class="columnafija" >Lugar</td>
  <td><input id=Lugar type=text size=25  name=Lugar class="input" title="Lugar" value="<?=$frm[Lugar] ?>"></td>
</tr>
<tr>
  <td  class="columnafija" >Menu</td>
  <td><textarea rows="5" id=Menu cols=60 wrap=virtual class="input mandatory" title="Menu" name=Menu><?=$frm[Menu]?>
  </textarea></td>
</tr>
<tr>
  <td  class="columnafija" >Horario</td>
  <td><textarea rows="5" id=Horario cols=60 wrap=virtual class="input" title="Horario" name=Horario><?=$frm[Horario]?>
  </textarea></td>
</tr>
<tr>
  <td  class="columnafija" >Localizacion</td>
  <td><input id=Localizacion type=text size=25  name=Localizacion class="input " title="Localizacion" value="<?=$frm[Localizacion] ?>"></td>
</tr>
<tr>
  <td> Imagen  </td>
  <td><?php 
							...
							{
								?>
    <img alt="<?php echo $frm["RestauranteFile"] ?>" src="<?php echo IMGEVENTO_ROOT.$frm["RestauranteFile"]?>"> <a href="<? echo "?mod=" . SIMReg::get( "mod" ) . "&action=DelImgNot&cam=RestauranteFile&id=" .$frm[ $key ]?>"><img src='images/trash.png' border='0'></a>
    <?php 
							}
							else
							{
    ...
    <?php 
			...
			<input type="button" onclick="location.href='?mod=Pais'" class="submit" value="Cancelar" name="submit">
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
				    ...
				    <input type="button" onclick="location.href='?mod=Restaurante&action=add'" class="submit" value="Crear Nuevo <?php  echo strtoupper( SIMReg::get( "table" ) ); ?>" name="submit2" ></th>
