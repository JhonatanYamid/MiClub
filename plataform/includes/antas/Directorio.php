...
SIMReg::setFromStructure( array(
					"title" => $dbo->getFields( "Club" , "Nombre" , "IDClub = '".$_SESSION[IDClub]."'")." :: " . " Directorio",
					"table" => "Directorio",
					"key" => "IDDirectorio",
					"mod" => "Directorio"
) );
		...
		<table class="adminform">
			...
			<tr>
			  <td colspan=2 align=center>
			    ...
			    <input type="button" onclick="location.href='?mod=Directorio'" class="submit" value="Cancelar" name="submit">
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
				    ...
				    <input type="button" onclick="location.href='?mod=Directorio&action=add'" class="submit" value="Crear Nuevo <?php  echo strtoupper( SIMReg::get( "table" ) ); ?>" name="submit2" ></th>
