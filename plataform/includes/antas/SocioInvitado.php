...
$array_valida = array(  
	 "Nombre" => "Nombre" , "NumeroDocumento" => "NumeroDocumento" 	
); 
...
<tr>
  ...
  <td><input id=NumeroDocumento type=text size=25  name=NumeroDocumento class="input" title="Numero Documento" value="<?=$frm[NumeroDocumento] ?>"></td>
</tr>
<tr>
  <td  class="columnafija" >Nombre</td>
  <td><input id=Nombre type=text size=25  name=Nombre class="input mandatory " title="Nombre" value="<?=$frm[Nombre] ?>"></td>
</tr>
<tr>
  <td  class="columnafija" >Fecha Ingreso</td>
  <td><input id="FechaIngreso" type="text" size="10" title="Fecha Ingreso" name="FechaIngreso" class="input mandatory calendar" value="<?php echo $frm["FechaIngreso"] ?>" readonly /></td>
</tr>
<tr>
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
					<th class=title colspan=6   ><?php echo strtoupper( SIMReg::get( "title" ) ) . ": Listado"?>
...
<td nowrap><?php echo $dbo->getFields( "Socio" , "Nombre" , "IDSocio = '".$r->IDSocio."'") . " " . $dbo->getFields( "Socio" , "Apellido" , "IDSocio = '".$r->IDSocio."'"); ?></td> <td nowrap><? echo $r->Nombre ?></td>
<td nowrap><? echo $r->FechaIngreso ?></td> 
