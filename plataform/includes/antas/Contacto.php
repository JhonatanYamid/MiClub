...
SIMReg::setFromStructure( array(
					"title" => $dbo->getFields( "Club" , "Nombre" , "IDClub = '".$_SESSION[IDClub]."'")." :: " . " Contactenos",
					"table" => "Contacto",
					"key" => "IDContacto",
					"mod" => "Contacto"
) );
...
<div id="tabsform">
	<div id="">
		...
		<table class="adminform">
			...
			<tr>
			<td  class="columnafija" > Socio </td><td><?php echo $dbo->getFields( "Socio" , "Nombre" , "IDSocio = '" . $frm["IDSocio"] . "'" ) . " " . $dbo->getFields( "Socio" , "Apellido" , "IDSocio = '" . $frm["IDSocio"] . "'" )?> </td>
			</tr>
			<tr>
			  <td  class="columnafija" >Comentario</td>
			  <td><?php echo $frm["Comentario"]?></td>
			  </tr>
			<tr>
			  <td  class="columnafija" > Fecha </td>
			  <td><?php echo $frm["FechaTrCr"]?></td>
			  </tr>
            
			<tr>
			  <td colspan=2 align=center><input type="button" onclick="location.href='?mod=Contacto'" class="submit" value="Regresar" name="submit">
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
				    ...
				    <input type="button" onclick="location.href='?mod=Contacto&action=add'" class="submit" value="Crear Nuevo <?php  echo strtoupper( SIMReg::get( "table" ) ); ?>" name="submit2" ></th>
...
<td nowrap><? echo $dbo->getFields( "Socio" , "Nombre" , "IDSocio = '" . $r->IDSocio . "'" ) . " " . $dbo->getFields( "Socio" , "Apellido" , "IDSocio = '" . $r->IDSocio . "'" )  ?></td>
<td nowrap><? echo substr($r->Comentario,0,100); ?></td> 
<td nowrap><? echo substr($r->FechaTrCr,0,10); ?></td> 
</tr>
<? } // END for
?>
<tr>
