...
SIMNotify::capture( SIMResources::$mensajes[ SIMNet::req("m") ]["msg"] , SIMResources::$mensajes[ SIMNet::req("m") ]["type"] );	
		...
		switch ( $action ) {
			...
			case "delete" :
				...
				SIMHTML::jsAlert("Parametro Eliminado Correctamente");
...
<div id="tabsform">
	<div id="">
		...
		<table class="adminform">
			...
			<tr>
				<td  class="columnafija" > Valor </td><td><textarea rows="5" id=Valor cols=60 wrap=virtual class="input" title="Valor" name=Valor><?=$frm[Valor]?></textarea></td>
			</tr>
			<tr>
				<td  class="columnafija" > Email </td><td><textarea rows="5" id=Valor cols=60 wrap=virtual class="input" title="Email" name=Email><?=$frm[Email]?></textarea></td>
			</tr>
			<tr>
				<td  class="columnafija" > Recomendaciones </td><td><textarea rows="5" id=Recomendaciones cols=60 wrap=virtual class="input" title="Recomendaciones" name=Recomendaciones><?=$frm[Recomendaciones]?></textarea></td>
			</tr>
			<tr>
			...
			<input type="button" onclick="location.href='?mod=Parametros'" class="submit" value="Cancelar" name="submit">
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
					<th class=title colspan=15   ><?php echo strtoupper( SIMReg::get( "title" ) ) . ": Listado"?></th>
					
				</tr>


<tr>
					<th class=texto colspan=15  ><?php echo $result["info"]?></th>
