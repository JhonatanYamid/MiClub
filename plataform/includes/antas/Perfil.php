...
SIMNotify::capture( SIMResources::$mensajes[ SIMNet::req("m") ]["msg"] , SIMResources::$mensajes[ SIMNet::req("m") ]["type"] );	
		...
		switch ( SIMNet::req( "action" ) ) {
			...
			case "delete" :
				...
				SIMHTML::jsAlert("Perfil Eliminado Correctamente");
	...
	<div id="">
		...
		<table class="adminform">
			...
			<tr>
			  ...
			  <td><textarea name="Descripcion" id="Descripcion" rows="5" cols="40" class="input" ><?=$frm[Descripcion]; ?></textarea></td>
			  </tr>
			<tr>
			  <td  class="columnafija" >Nombre Modulo</td>
			  <td><input id="Nombre2" type="text" size="25"  name="NombreModulo" class="input mandatory " title="NombreModulo" value="<?=$frm[NombreModulo] ?>" /></td>
			  </tr>
			<tr>
			<td colspan=2 align=center>
			
			<input type=submit name=submit value="<? echo $submit_caption ?>" class=submit>
			<input type=button name=submit value="Cancelar" class=submit onclick="location.href='?mod=Perfil'">
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
                    ...
                    <input type="button" onclick="location.href='?mod=Perfil&action=add'" class="submit" value="Crear Nuevo <?php  echo strtoupper( SIMReg::get( "table" ) ); ?>" name="submit2" >
                    </th>
