...
$table = "ConfiguracionObjetosPrestados";
$key = "IDConfiguracionObjetosPrestados";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionobjetosprestadosusuario";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "LabelSubtitulo" => $row["LabelSubtitulo"],
            "LabelPendientesPorEntregar" => $row["LabelPendientesPorEntregar"],
            "LabelEntregados" => $row["LabelEntregados"],
