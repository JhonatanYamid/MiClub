...
$table = "ConfiguracionTiempos";
$key = "IDConfiguracionTiempos";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuraciontiempos";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionTiempos WHERE IDConfiguracionTiempos = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Nombre" => $row["Nombre"],
            "LabelBotonResponderTiempos" => $row["LabelBotonResponderTiempos"],
