...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionCheckinLaboral WHERE IDConfiguracionCheckinLaboral = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Nombre" => $row["Nombre"],
            "TextoIntro" => $row["TextoIntro"],
            "TextoConfirmacionIngreso" => $row["TextoConfirmacionIngreso"],
            "TextoConfirmacionSalida" => $row["TextoConfirmacionSalida"],
            "Activo" => $row["Activo"],
