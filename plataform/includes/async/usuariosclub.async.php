...
switch( $oper )
{
		...
		foreach( $array_buqueda->rules as $key_busqueda => $search_object )
		{
			switch ($search_object->field) {
				case 'qryString':
					...
					$where .= " AND ( Nombre LIKE '%" . $search_object->data . "%' OR Email LIKE '%" . $search_object->data . "%' OR User LIKE '%" . $search_object->data . "%' )  ";
				break;
				case 'Club':
	...
	case "searchurl":
		...
		if( !empty( $qryString ) )
		{
			...
			$where .= " AND ( Nombre LIKE '%" . $qryString . "%' OR Email LIKE '%" . $qryString . "%' OR User LIKE '%" . $qryString . "%')  ";
		}//end if
	break;
}
