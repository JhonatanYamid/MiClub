...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM TipoReservaHotel WHERE IDTipoReservaHotel = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
                ...
                case 'qryString':
                    ...
                    break;
                case 'Tipo':
                    $where .= " AND ( Tipo LIKE '%" . $search_object->data . "%' )";

                    break;
                case 'LabelTipo':
                    $where .= " AND ( LabelTipo LIKE '%" . $search_object->data . "%' )";
