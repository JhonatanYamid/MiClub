...
//SELECT c.Nombre, t.Nombre as Tipo, c.Publicar FROM CategoriaPqr c, TipoPqr t WHERE c.IDTipoPqr=t.IDTipoPqr

//sql anterior
//$sql = "SELECT  * FROM " . $table  $where . "ORDER BY $sidx $sord LIMIT " . $start . ",".$limit;

$sql = "SELECT c.IDCategoriaPqr, c.Nombre, t.Nombre as Tipo, c.Publicar FROM CategoriaPqr c, TipoPqr t WHERE c.IDTipoPqr=t.IDTipoPqr  and  c.IDClub = '" . SIMUser::get("club") . "' ORDER BY $sidx $sord LIMIT " . $start . ",".$limit;
