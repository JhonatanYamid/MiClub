...
$table = "ConfiguracionTalonera";
$key = "IDConfiguracionTalonera";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuraciontalonera";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "LabelServicioComprar" => $row["LabelServicioComprar"],
            "LabelTipoPaquete" => $row["LabelTipoPaquete"],
