...
$table = "ConfiguracionDirectorioSocio";
$key = "IDConfiguracionDirectorioSocio";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuraciondirectoriosocio";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionDirectorioSocio WHERE IDConfiguracionDirectorioSocio = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
