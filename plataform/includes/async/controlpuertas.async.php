...
while($row = $dbo->fetchArray($result)) {
	...
	$botones = '<a href="javaScript:void(0);" class="AbrirPuerta" id="'.$row[$key].'" title="Abrir Puerta"><i class="ace-icon fa fa-unlock bigger-130"/></a>&nbsp;&nbsp;';
	...
	$attr = "rev=\"reload_grid\"";
		$responce->rows[$i]['cell'] = array(
										...
										"AccionPuerta" => '<center>' . $botones . '</center>',
									);
