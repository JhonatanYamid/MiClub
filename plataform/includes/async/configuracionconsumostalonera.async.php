...
$script = "configuracionconsumostalonera";
...
switch ($oper) {
	...
	case "del":
		...
		$sql_delete = "DELETE FROM ConfiguracionConsumosTalonera WHERE IDConfiguracionConsumosTalonera = '" . $_POST["id"] . "' LIMIT 1";
		//echo "<br>";
		$qry_delete = $dbo->query($sql_delete);

		$_GET["page"] = 1;
		$_GET['rows'] = 100;
		$_GET['sidx'] = "IDConfiguracionConsumosTalonera ASC";
		$_GET['sord'] = "ASC";
...
$sql = "SELECT * FROM ConfiguracionConsumosTalonera" . $where . "  " . $str_limit;
//exit;
//var_dump($sql);
