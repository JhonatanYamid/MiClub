...
$table = "ConfiguracionEncuestaArbol";
$key = "IDConfiguracionEncuestaArbol";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionencuestaarbol";
...
if (!$sidx) $sidx = "IDConfiguracionEncuestaArbol";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Nombre" => $row["Nombre"],
            "TextoBotonHistorial" => $row["TextoBotonHistorial"],
            "MostrarBotonHistorial" => $row["MostrarBotonHistorial"],
