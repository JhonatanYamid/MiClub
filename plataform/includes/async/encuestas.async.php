...
$table = "Encuesta";
$key = "IDEncuesta";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' AND " . $table . ".IDModulo=''";
$script = "encuestas";
...
while ($row = $dbo->fetchArray($result)) {
	...
	if ($origen <> "mobile")
		...
		$responce->rows[$i]['cell'] = array(
			...
			"Copiar" => '<a class="green" href="' . $script . '.php?action=copiarEncuesta&id=' . $row[$key] . '' . '"><i class="ace-icon fa fa-files-o bigger-130"/></a>',
