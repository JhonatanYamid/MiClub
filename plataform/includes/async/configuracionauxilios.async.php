...
$table = "ConfiguracionAuxilios";
$key = "IDConfiguracionAuxilios";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionauxilios";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionAuxilios WHERE IDConfiguracionAuxilios = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
