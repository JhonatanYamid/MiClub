...
while ($row = $dbo->fetchArray($result)) {
	...
	$responce->rows[$i]['cell'] = array(
		...
		"NumeroHabitacion" => utf8_encode($row["NumeroHabitacion"]),
		"Descripcion" => $row["Descripcion"],
		"Torre" => $dbo->getFields("Torre", "Nombre", "IDTorre = '" . $row["IDTorre"] . "'"),
		"Tipo" => $dbo->getFields("TipoHabitacion", "Nombre", "IDTipoHabitacion = '" . $row["IDTipoHabitacion"] . "'"),
