...
$table = "ConfiguracionEncuesta";
$key = "IDConfiguracionEncuesta";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionencuesta";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionEncuesta WHERE IDConfiguracionEncuesta = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "PermiteMostrarHistorial" => $row["PermiteMostrarHistorial"],
            "LabelMostrarHistorial" => $row["LabelMostrarHistorial"],
