<?php
	...
	{	
		...
		$sql_ingreso = $dbo->query("Update SocioInvitadoEspecial Set Ingreso = 'S', FechaIngreso = NOW() Where IDSocioInvitadoEspecial = '".$datos_invitacion["IDSocioInvitadoEspecial"]."' and IDpadre = '".$datos_invitacion["IDInvitado"]."'");
		if($datos_invitacion["CabezaInvitacion"]=="S"):
			$sql_ingreso_grupo = $dbo->query("Update SocioInvitadoEspecial Set Ingreso = 'S', FechaIngreso = NOW() Where  IDPadre = '".$datos_invitacion["IDInvitado"]."' and FechaInicio = '".$datos_invitacion["FechaInicio"]."' and FechaFin = '".$datos_invitacion["FechaFin"]."'");
		endif;
		//respoder
