...
$table = "Clasificado";
$key = "IDClasificado";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' AND " . $table . ".IDUsuario <> '' ";
...
while ($row = $dbo->fetchArray($result)) {
	...
	if ($origen <> "mobile")
		$responce->rows[$i]['cell'] = array(
			...
			"Funcionario" =>  $dbo->getFields("Usuario", "Nombre", "IDUsuario = '" . $row["IDUsuario"] . "'"),
			"Nombre" => $row["Nombre"],
			"Descripcion" => $row["Descripcion"],
			"Estado" => $dbo->getFields("EstadoClasificado", "Nombre", "IDEstadoClasificado = '" . $row["IDEstadoClasificado"] . "'"),
