...
switch( $oper )
{
	...
	case "del":
		...
		$sql_delete = "DELETE FROM InformacionFactura WHERE IDInformacionFactura = '" . $_POST["id"] . "' LIMIT 1";
		//echo "<br>";
	...
	case "form":
		...
		switch ($proceso) {
			...
			case 'departamentos':
				...
				echo SIMHTML::formPopup('DepartamentoDian', 'Nombre', 'Nombre', 'IDDepartamentoDian', $idDepartamento, SIMUtil::get_traduccion('', '', 'seleccioneuno', LANGSESSION), '', 'onchange="selCiudades()"', "AND IDPaisDian = $idPais");
				exit;
			break;
			...
			case 'ciudades':
				...
				echo SIMHTML::formPopup('CiudadDian', 'Nombre', 'Nombre', 'IDCiudadDian', $idCiudad, SIMUtil::get_traduccion('', '', 'seleccioneuno', LANGSESSION), '', '', "AND IDDepartamentoDian = $idDepartamento");
				exit;
			break; 
		}
