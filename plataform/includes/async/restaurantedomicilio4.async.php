...
$where = " WHERE RD.IDClub = '" . SIMUser::get("club") . "'" . $condicion_restaurante;
$whereCou = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "restaurantedomicilio" . $version;
...
//echo "SELECT COUNT(*) AS count FROM " . $table." RD" . $whereCou . "    ";
