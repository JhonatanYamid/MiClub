...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM FamiliaresVacunacion WHERE IDFamiliaresVacunacion = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
    ...
    case "search":
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
                ...
                case 'qryString':
                    $where .= " AND ( Nombres LIKE '%" . $search_object->data . "%' )";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "CiudadDondeReside" => $row["CiudadDondeReside"],
