...
$table = "MotivosCalificacion";
$key = "IDMotivosCalificacion";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "motivoscalificacion";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM MotivosCalificacion WHERE IDMotivosCalificacion = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
