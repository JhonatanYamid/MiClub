...
$where = " WHERE RD.IDClub = '" . SIMUser::get("club") . "'" . $condicion_restaurante . " AND  (RD.DirigidoA = 'S' OR RD.DirigidoA = 'T') ";
$whereCou = " WHERE $table.IDClub = '" . SIMUser::get("club") . "'  AND ($table.DirigidoA = 'S' OR $table.DirigidoA = 'T') ";
