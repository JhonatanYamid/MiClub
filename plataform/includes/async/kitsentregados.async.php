...
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' AND IDCarrera='" . $IDCarrera . "' AND KitEntregado='S'";
...
$page = $_GET['page']; // get the requested page 1
$limit = $_GET['rows']; // get how many rows we want to have into the grid 100
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "UsuarioQueEntrega" => $dbo->getFields("Usuario", "Nombre", "IDUsuario = '" . $row["IDUsuarioEntregaKit"] . "'"),
            "Nombre" => $row["Nombre"],
            ...
            "FechaEntrega" =>  $row["FechaEntregaKit"],
