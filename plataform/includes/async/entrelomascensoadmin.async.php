...
$table = "EntreLomasCenso";
$key = "IDEntreLomasCenso";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "entrelomascensoadmin";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Casa" => $row["Casa"],
            "PersonasQueHabitan" => $row["PersonasQueHabitan"],
            "Vehiculos" => $row["Vehiculos"],
            "Mascotas" => $row["Mascotas"],
            "LlamarEnCasoDeEmergencia" => $row["LlamarEnCasoDeEmergencia"],
