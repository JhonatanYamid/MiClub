...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM TipoVehiculo WHERE IDTipoVehiculo = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
    ...
    case "search":
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
                ...
                case 'Socio':
                    $where .= " WHERE (  S.Nombre LIKE '%" . $search_object->data . "%' or S.Apellido LIKE '%" . $search_object->data . "%'  )  ";
                    break;
                ...
                case 'Descripcion':
                    $where .= " WHERE ( Descripcion LIKE '%" . $search_object->data . "%' )";
                    break;
