...
$table = "GameGolfCategoriaFormato";
$key = "IDGameGolfCategoriaFormato";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script ="gamegolfcategoriaformato";
		...
		foreach( $array_buqueda->rules as $key_busqueda => $search_object )
		{
			switch ($search_object->field) {
				case 'qryString':
					...
					$where .= " AND ( Nombre LIKE '%" . $search_object->data . "%' OR  Descripcion LIKE '%" . $search_object->data . "%')";
				break;
