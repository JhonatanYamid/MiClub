...
$where = " WHERE CE.IDClub = '" . SIMUser::get("club") . "' AND CE.IDCaddiesEcaddie=DisponibilidiadCaddiesEcaddie.IDCaddiesEcaddie";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM Festivos WHERE IDFestivo = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
        print_r($sql_delete);
        exit;
...
$sql = "SELECT DISTINCT MIN(
    IDDisponibilidiadCaddiesEcaddie)," . $table . ".*,CE.Nombre FROM " . $table . ",CaddiesEcaddie CE " . $where . " GROUP BY DisponibilidiadCaddiesEcaddie.IDCaddiesEcaddie ORDER BY $sidx $sord LIMIT " . $start . "," . $limit;
//exit;
/* var_dump($sql);
exit; */
//print_r($sql);
