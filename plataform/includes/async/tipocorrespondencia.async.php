...
$key = "IDTipoCorrespondencia";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script ="tipocorrespondencia";
...
while($row = $dbo->fetchArray($result)) {
	...
	if( $origen <> "mobile" )
		$responce->rows[$i]['cell'] = array(
										...
										"Categoria" => $dbo->getFields( "CategoriaCorrespondencia" , "Nombre" , "IDCategoriaCorrespondencia = '".$row["IDCategoriaCorrespondencia"]."'" ),
										"Nombre" => $row["Nombre"],
