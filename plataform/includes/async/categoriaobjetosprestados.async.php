...
$table = "CategoriaObjetosPrestados";
$key = "IDCategoriaObjetosPrestados";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "categoriaobjetosprestados";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "NombreCategoriaObjeto" => $row["NombreCategoriaObjeto"],
            "DisponiblesEnStock" => $row["DisponiblesEnStock"],
