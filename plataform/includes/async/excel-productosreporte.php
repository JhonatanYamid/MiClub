...
if ($Num > 0) {
	...
	while ($Datos1 = $dbo->fetchArray($result_reporte_general)) {
		$html .= "<tr>";
		$html .= "<td colspan='2'>" . remplaza_tildes(utf8_encode($Datos1["producto"])) . "</td>";
		$html .= "<td colspan='3'>" . remplaza_tildes(utf8_encode($Datos1["cantidad"])) . "</td>"; 
