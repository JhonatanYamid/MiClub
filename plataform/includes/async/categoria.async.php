...
$join = ",ClubCategoria";
$key = "IDCategoria";
$where = " WHERE Categoria.IDCategoria=ClubCategoria.IDCategoria AND ClubCategoria.IDClub = '" . SIMUser::get("club") . "' ";
$script = "categoria";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM Categoria WHERE IDCategoria = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
$sql = "SELECT * FROM " . $table . $join . $where . " ORDER BY $sidx $sord " . $str_limit;
