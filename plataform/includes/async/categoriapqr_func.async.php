...
$table = "CategoriaPqrFuncionario";
//$table1 = "TipoPqr";
$key = "IDCategoriaPqrFuncionario";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "'";
$script ="categoriapqr_func";
...
//sql para traer el nombre del tipo de pqr
//SELECT c.Nombre, t.Nombre as Tipo, c.Publicar FROM CategoriaPqrFuncionario c, TipoPqr t WHERE c.IDTipoPqr=t.IDTipoPqr

//sql anterior
//$sql = "SELECT  * FROM " . $table  $where . "ORDER BY $sidx $sord LIMIT " . $start . ",".$limit;

$sql = "SELECT c.IDCategoriaPqrFuncionario, c.Nombre, t.Nombre as Tipo, c.Publicar FROM CategoriaPqrFuncionario c, TipoPqrFuncionario t WHERE c.IDTipoPqr=t.IDTipoPqr  and  c.IDClub = '" . SIMUser::get("club") . "' ORDER BY $sidx $sord LIMIT " . $start . ",".$limit;
