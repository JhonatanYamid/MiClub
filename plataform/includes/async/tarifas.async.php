	...
	case "search":
		...
		foreach( $array_buqueda->rules as $key_busqueda => $search_object )
		{
			switch ($search_object->field) {
				...
				default:
					$where .=  $array_buqueda->groupOp . "  Tarifa." . $search_object->field . " LIKE '%" . $search_object->data . "%' ";
				break;
			}
...
while($row = $dbo->fetchArray($result)) 
{
	...
	$attr = "rev=\"reload_grid\"";
		$responce->rows[$i]['cell'] = array(
										...
										"TipoHabitacion" => $dbo->getFields( "TipoHabitacion" , "Nombre" , "IDTipoHabitacion = '".$row["IDTipoHabitacion"]."'" ),
