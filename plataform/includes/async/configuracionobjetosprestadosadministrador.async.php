...
$table = "ConfiguracionObjetosPrestadosAdministrador";
$key = "IDConfiguracionObjetosPrestadosAdministrador";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionobjetosprestadosadministrador";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionObjetosPrestadosAdministrador WHERE IDConfiguracionObjetosPrestadosAdministrador = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "LabelTitulo" => $row["LabelTitulo"],
            "LabelBotonIngresarPrestamo" => $row["LabelBotonIngresarPrestamo"],
            "LabelBotonRegistrarDevolucion" => $row["LabelBotonRegistrarDevolucion"],
            "LabelTituloBuscador" => $row["LabelTituloBuscador"],
            "LabelBuscador" => $row["LabelBuscador"],
            "Activo" => $activo,
