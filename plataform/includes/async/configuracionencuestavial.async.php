...
$table = "ConfiguracionEncuestaVial";
$key = "IDConfiguracionEncuestaVial";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionencuestavial";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionEncuestaVial WHERE IDConfiguracionEncuestaVial = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
if (!$sidx) $sidx = "IDConfiguracionEncuestaVial";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Nombre" => $row["Nombre"],
            "LabelConfirmacionEnvio" => $row["LabelConfirmacionEnvio"],
            "LabelBotonRecargar" => $row["LabelBotonRecargar"],
