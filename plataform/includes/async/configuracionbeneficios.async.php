...
$table = "ConfiguracionBeneficios";
$key = "IDConfiguracionBeneficios";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionbeneficios";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "LabelBotonFavoritos" => $row["LabelBotonFavoritos"],
            "LabelHeaderFavoritos" => $row["LabelHeaderFavoritos"],
            "Activo" => $row["Activo"],
