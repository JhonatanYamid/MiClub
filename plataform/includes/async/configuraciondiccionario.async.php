...
$table = "ConfiguracionDiccionario";
$key = "IDConfiguracionDiccionario";
$where = " WHERE 1 ";
$script ="configuraciondiccionario";
...
switch( $oper )
{
	case "del":
		...
		$sql_delete = "DELETE FROM ConfiguracionDiccionario WHERE IDConfiguracionDiccionario = '" . $_POST["id"] . "' LIMIT 1";
		//echo "<br>";
