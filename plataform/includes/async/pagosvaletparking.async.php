...
$table = "TiposDePagoValetParking";
$key = "IDTiposDePagoValetParking";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "pagosvaletparking";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "Nombre" => $row["Nombre"],
            "MostrarNumeroFactura" => $row["MostrarNumeroFactura"],
            "ObligatorioNumeroFactura" => $row["ObligatorioNumeroFactura"],
