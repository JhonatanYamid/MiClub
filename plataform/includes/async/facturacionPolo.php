...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM PagosPendientesPoloClub WHERE IDPagosPendientesPoloClub = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
echo $sql = "SELECT " . $table . ".* FROM " . $table . $where . " ORDER BY GROUP BY Fecha $sidx $sord " . $str_limit;
