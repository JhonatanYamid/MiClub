...
$table = "ElementoServiciosCaddies";
$key = "IDElementoServiciosCaddies";
//$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "elementoservicioscaddies";
    ...
    case "search":
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
                ...
                case 'Descripcion':
                    $where .= " WHERE ( Descripción LIKE '%" . $search_object->data . "%' )";
                ...
                case 'Activo':
                    ...
                    $where .= " WHERE ( Activo LIKE '%" . $Activo . "%' )";
