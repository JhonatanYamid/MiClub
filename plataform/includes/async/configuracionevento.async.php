...
$key = "IDConfiguracionEvento";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionevento";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionEvento WHERE IDConfiguracionEvento = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
...
while ($row = $dbo->fetchArray($result)) {
    ...
    if ($origen <> "mobile")
        $responce->rows[$i]['cell'] = array(
            ...
            "VersionEvento" => $evento,
            "PermiteMostrarCalendarioColores" => $row["PermiteMostrarCalendarioColores"],
            "PermiteBuscadorNombre" => $row["PermiteBuscadorNombre"],
            "TipoFechaHeader" => $row["TipoFechaHeader"],
