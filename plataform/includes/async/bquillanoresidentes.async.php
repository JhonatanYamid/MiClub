...
$table = "BquillaNoResidentes";
$key = "IDBquillaNoResidentes";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "bquillanoresidentes";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM BquillaNoResidentes WHERE IDNoResidentesApp = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
        $qry_delete = $dbo->query($sql_delete);

        $_GET["page"] = 1;
        $_GET['rows'] = 100;
        $_GET['sidx'] = "NombreVisitante";
        $_GET['sord'] = "ASC";
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
              ...
              break;
                ...
                case 'qryString':
                    $where .= " AND ( NombreVisitante LIKE '%" . $search_object->data . "%' )";
    ...
    case "searchurl":
        ...
        if (!empty($qryString)) {
            ...
            $where .= " AND ( NombreVisitante LIKE '%" . $qryString . "%'  )  ";
        } //end if
        break;
}
