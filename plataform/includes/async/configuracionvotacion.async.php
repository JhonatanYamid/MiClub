...
$table = "ConfiguracionVotacion";
$key = "IDConfiguracionVotacion";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "configuracionvotacion";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM ConfiguracionVotacion WHERE IDConfiguracionVotacion = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
