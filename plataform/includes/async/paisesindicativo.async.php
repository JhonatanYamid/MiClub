...
$table = "PaisIndicativo";
$key = "IDPaisIndicativo";
//$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "paisesindicativo";
    ...
    case "search":
        ...
        foreach ($array_buqueda->rules as $key_busqueda => $search_object) {
            switch ($search_object->field) {
                ...
                case 'Nombre':
                    $where .= " AND (PaisIndicativo.Nombre LIKE '%" . $search_object->data . "%' )";
                    break;
                case 'Indicativo':
                    $where .= " AND (PaisIndicativo.Indicativo LIKE '%" . $search_object->data . "%' )";
                    break;

                case 'Activo':
                    $where .= " AND (PaisIndicativo.Activo LIKE '%" . $search_object->data . "%' )";
                    break;
