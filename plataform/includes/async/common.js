...
jQuery(document).ready(function () {
  ...
  $("#searchCheckin").click(function () {
    ...
    location.href = script + "&inicio=" + FechaInicio + "&fin=" + FechaFin;
  });
});
...
function preparaform() {
  ...
  $("input[class='btnActivarTalonera']").change(function () {
    ...
    jQuery.ajax({
      type: "POST",
      data: { IDTalonera: IDTalonera, Valor: valor },
      dataType: "json",
  ...
  $("#btnFacturarSocios")
    ...
    .click(function () {
      ...
      if (confirm("¿Enviar Facturas a los Socios?") == true) {
        $.post("includes/async/sendFacturacionSocios.async.php", {
          IDClub: IDClub,
