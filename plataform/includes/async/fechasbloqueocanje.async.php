...
$table = "FechasBloqueoCanje";
$key = "IDFechasBloqueoCanje";
$where = " WHERE " . $table . ".IDClub = '" . SIMUser::get("club") . "' ";
$script = "fechasbloqueocanje";
...
switch ($oper) {
    ...
    case "del":
        ...
        $sql_delete = "DELETE FROM FechasBloqueoCanje WHERE IDFechasBloqueoCanje = '" . $_POST["id"] . "' LIMIT 1";
        //echo "<br>";
