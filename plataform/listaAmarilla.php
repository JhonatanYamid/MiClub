<?
	...
	include( "procedures/listaAmarilla.php" );
	include( "cmp/seo.php" );
?>
	</head>
					...
					<div class="page-content">
						...
						?>
							<div class="ace-settings-container" id="ace-settings-container">
								...
								<br><br>
                                <button class="btn btn-info fancybox" href="cargalistaamarilla.php" data-fancybox-type="iframe">
								<i class="ace-icon fa fa-cloud-upload align-top bigger-125"></i>
									Carga Masiva de lista amarilla						
								</button>
							</div>
						<?
						}//end if
