...
include("procedures/consumoalimentoscasino.php");
include("cmp/seo.php");
				...
				<div class="page-content">
					...
					?>
						<div class="ace-settings-container" id="ace-settings-container">
							...
							<br><br>
							<button class="btn btn-info fancybox" href="cargamasivaconsumoalimentoscasino.php" data-fancybox-type="iframe">
								<i class="ace-icon fa fa-cloud-upload align-top bigger-125"></i>
								<?= SIMUtil::get_traduccion('', '', 'CargaMasivaEmpleadosAlimentoCasino', LANGSESSION); ?>
							</button>
