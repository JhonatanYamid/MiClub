<?php
	...
	$sql_reporte = "Select * From ActualizacionMallorca
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "	Select *
							From ActualizacionMallorcaBeneficiarios
							Where IDActualizacionMallorca = '".$Datos["IDActualizacionMallorca"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasMallorca
							Where IDActualizacionMallorca = '".$Datos["IDActualizacionMallorca"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosMallorca
							Where IDActualizacionMallorca = '".$Datos["IDActualizacionMallorca"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosMallorca
							Where IDActualizacionMallorca = '".$Datos["IDActualizacionMallorca"]."'  Order By FechaTrCr ASC" ;
