<?php
	...
	$sql_reporte = "Select * From ActualizacionSalguero
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "	Select *
							From ActualizacionSalgueroBeneficiarios
							Where IDActualizacionSalguero = '".$Datos["IDActualizacionSalguero"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasSalguero
							Where IDActualizacionSalguero = '".$Datos["IDActualizacionSalguero"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosSalguero
							Where IDActualizacionSalguero = '".$Datos["IDActualizacionSalguero"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosSalguero
							Where IDActualizacionSalguero = '".$Datos["IDActualizacionSalguero"]."'  Order By FechaTrCr ASC" ;
