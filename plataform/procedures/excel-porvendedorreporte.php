...
if ($Num > 0) {
	...
	$html .= "<tr>";
	$html .= "<th colspan='22'>  $reporte_general  </th>";
        $html .= "</tr>";
	$html .= "<th colspan='22'>Sede:  " . $sede . " </th>";
	$html .= "<tr>";
	$html .= "<th colspan='22'>  " . $inicio . " - " . $fin . " </th>";
	$html .= "</tr>";
	$html .= "<tr>";
	$html .= "<th colspan='22'>Se encontraron " . $Num . " registro(s) </th>";
	$html .= "</tr>";
	$html .= "<tr>";
