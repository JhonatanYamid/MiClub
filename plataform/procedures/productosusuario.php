	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				foreach ($_POST["CategoriaProducto"] as $id_categoria) :
					$sql_inserta_cat_producto = $dbo->query("Insert into ProductoCategoria (IDCategoriaProducto,IDProducto ) Values ('" . $id_categoria . "', '" . $id . "')");
				endforeach;
		...
		case "update":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				$borrar_categoria_producto = $dbo->query("Delete From ProductoCategoria Where IDProducto = '" . $_GET["id"] . "'");
				foreach ($_POST["CategoriaProducto"] as $id_categoria) :
					$sql_inserta_cat_producto = $dbo->query("Insert into ProductoCategoria (IDCategoriaProducto,IDProducto ) Values ('" . $id_categoria . "', '" . SIMNet::reqInt("id") . "')");
				endforeach;
