 <?
	...
	SIMReg::setFromStructure(array(
		"title" => "AreasPqrFuncionario",
		"table" => "AreaFuncionario",
		"key" => "IDArea",
		"mod" => "Area"
	));


	$script = "areafuncionario";
	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				$frm["Nombre"] = utf8_encode($frm["Nombre"]);
				$frm["Responsable"] = utf8_encode($frm["Responsable"]);
		...
		case "update":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				/* $frm["Nombre"]=utf8_decode($frm["Nombre"]);
          $frm["Responsable"]=utf8_decode($frm["Responsable"]); */
