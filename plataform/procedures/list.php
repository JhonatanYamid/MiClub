		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Tipo de Socio', 'Accion', 'Nombre', 'Apellido', 'Usuario App', 'Estado vacunación'],
					colModel:[					
						{name:'TipoSocio',index:'Nombre', align:"left"},
						{name:'Accion',index:'Descripcion', align:"left"},
						{name:'Nombre',index:'Publicar', align:"left"},
						{name:'Apellido',index:'Apellido', align:"left"},
						{name:'Email',index:'UsuarioApp', align:"left"},
						{name:'EstadoVacunacion',index:'EstadoVacunacion', align:"left"}
					...
					onSelectRow: function(id){
				 		location.href="<?php echo $script?>.php?action=edit&IdSocio="+id;
						 return false;
			   },
