 <?
	...
	SIMReg::setFromStructure(array(
		"title" => "resoluciondefacturacion",
		"titleB" => "resolucionesdefacturacion",
		"table" => "ResolucionFactura",
		"key" => "IDResolucionFactura",
		"mod" => "ResolucionFactura"
	));
	...
	switch ($action) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				if($frm['ConsecutivoFacturas'] == '')
					$frm['ConsecutivoFacturas'] = 0;
				
				if($frm['ConsecutivoRecibos'] == '')
					$frm['ConsecutivoRecibos'] = 0;	
