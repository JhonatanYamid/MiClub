			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				if ($frm["FechaInicio"] == '' && $frm["FechaFin"] == '' && $frm["HoraEnvio"] == '') {
                  ...
                  */
					...
					//echo "ejecutado";
					endswitch;
					SIMHTML::jsAlert(SIMUtil::get_traduccion('', '', 'Notificaciónenviadaa', LANGSESSION) . " " . $notificaciones . " " .  SIMUtil::get_traduccion('', '', 'Socios', LANGSESSION));
					SIMHTML::jsRedirect($script . ".php");
				} else {

					SIMHTML::jsAlert(SIMUtil::get_traduccion('', '', 'Notificaciónprogramadaparafecha', LANGSESSION) . ":" . $frm["FechaEnvio"] . " " . SIMUtil::get_traduccion('', '', 'Hora', LANGSESSION)  . $frm["HoraEnvio"]);
					SIMHTML::jsRedirect($script . ".php");
				}
			}
