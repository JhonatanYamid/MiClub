...
function get_data_accion($nombrearchivo, $file, $IGNORE_FIRTS_ROW, $FIELD_TEMINATED = '', $field = '', $IDClub, $IDRuta)
{
	...
	if ($fp = fopen($file, "r")) {
		...
		if (count($array_id_socio) > 0) :
			...
			$sql_grupo = "Update Ruta Set IDSocio = '" . $id_socios . "' Where IDRuta = '" . $IDRuta . "'";
			$dbo->query($sql_grupo);
		endif;
