...
while ($row_soc = $dbo->fetchArray($r_med)) {
	...
	$sql_reserva = "SELECT COUNT(IDServicio) as TotalReservas,IDReservaGeneral,IDServicio 
				  ...
				  WHERE IDSocio =  " . $row_soc["IDSocio"] . " and Fecha >= '2021-01-01' and Fecha <= '2021-03-20' 
				  GROUP BY IDServicio";
	...
	$sql_inv = "SELECT COUNT(IDServicio) as TotalReservas,RG.IDReservaGeneral,IDServicio 
				  ...
				  WHERE RG.IDReservaGeneral=RGI.IDReservaGeneral and  RGI.IDSocio =  " . $row_soc["IDSocio"] . " and Fecha >= '2021-01-01' and Fecha <= '2021-03-20' 
				  GROUP BY IDServicio";
