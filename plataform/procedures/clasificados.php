		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				if (isset($_FILES)) {
					...
					$files =  SIMFile::upload($_FILES["Foto7"], CLASIFICADOS_DIR, "IMAGE");
					if (empty($files) && !empty($_FILES["Foto7"]["name"]))
						SIMNotify::capture("Ha ocurrido un error durante la carga de la imagen. Verifique que la imagen no contenga errores y que el tipo de archivo sea permitido.", "error");
					$frm["Foto7"] = $files[0]["innername"];

					$files =  SIMFile::upload($_FILES["Foto8"], CLASIFICADOS_DIR, "IMAGE");
					if (empty($files) && !empty($_FILES["Foto8"]["name"]))
						SIMNotify::capture("Ha ocurrido un error durante la carga de la imagen. Verifique que la imagen no contenga errores y que el tipo de archivo sea permitido.", "error");
					$frm["Foto8"] = $files[0]["innername"];

					$files =  SIMFile::upload($_FILES["Foto9"], CLASIFICADOS_DIR, "IMAGE");
					if (empty($files) && !empty($_FILES["Foto9"]["name"]))
						SIMNotify::capture("Ha ocurrido un error durante la carga de la imagen. Verifique que la imagen no contenga errores y que el tipo de archivo sea permitido.", "error");
					$frm["Foto9"] = $files[0]["innername"];

					$files =  SIMFile::upload($_FILES["Foto10"], CLASIFICADOS_DIR, "IMAGE");
					if (empty($files) && !empty($_FILES["Foto10"]["name"]))
						SIMNotify::capture("Ha ocurrido un error durante la carga de la imagen. Verifique que la imagen no contenga errores y que el tipo de archivo sea permitido.", "error");
					$frm["Foto10"] = $files[0]["innername"];

					$files =  SIMFile::upload($_FILES["Foto11"], CLASIFICADOS_DIR, "IMAGE");
					if (empty($files) && !empty($_FILES["Foto11"]["name"]))
						SIMNotify::capture("Ha ocurrido un error durante la carga de la imagen. Verifique que la imagen no contenga errores y que el tipo de archivo sea permitido.", "error");
					$frm["Foto11"] = $files[0]["innername"];
				} //end if
