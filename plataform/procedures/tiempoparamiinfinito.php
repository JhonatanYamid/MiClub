...
switch (SIMNet::req("action")) {
    ...
    case "InsertarPregunta":
        ...
        SIMHTML::jsRedirect($script . ".php?action=edit&tabencuesta=formulario&id=" . $frm[IDAuxiliosInfinito] . "&IDModulo=" . $IDModulo);
        exit;
        break;
    ...
    case "EliminaPregunta":
        ...
        SIMHTML::jsRedirect($script . ".php?action=edit&tabencuesta=formulario&id=" . $_GET["IDAuxilios"] . "&IDModulo=" . $IDModulo);
        exit;
        break;
