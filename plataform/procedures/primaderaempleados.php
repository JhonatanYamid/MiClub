...
SIMReg::setFromStructure(array(
    "title" => "LukerEmpleados",
    "table" => "PrimaderaEmpleados",
    "key" => "IDPrimaderaEmpleados",
    "mod" => "primaderaempleados"
));


$script = "primaderaempleados";
$script1 = "primaderabeneficiario";
...
switch (SIMNet::req("action")) {
    ...
    case "insert":
        ...
        if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
            ...
            if (isset($_POST['Estudio'])) {
                ...
                SIMHTML::jsRedirect($script . ".php?IDSocio=" . $frm["IDSocio"]);
            } else {
                SIMHTML::jsRedirect($script1 . ".php?IDSocio=" . $frm["IDSocio"]);
            }
    ...
    case "edit":
        $id = $frm["IDPrimaderaBeneficiario"];
