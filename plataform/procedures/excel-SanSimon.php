<?php
	...
	$sql_reporte = "Select * From ActualizacionSanSimon
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "Select *
							From ActualizacionSanSimonBeneficiarios
							Where IDActualizacionSanSimon = '".$Datos["IDActualizacionSanSimon"]."'  Order By FechaTrCr ASC" ;
			...
			if($filas > 0)
			{
				...
				$html .= "<th>Agrupacion Beneficiario</th>";
			...
			while( $DatosBenef = $dbo->fetchArray( $result_benef ) )
			{
				...
				$html .= "<td>" . $DatosBenef["AgrupacionBeneficiario"] ."</td>";
