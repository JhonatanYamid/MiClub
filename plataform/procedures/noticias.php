 <?
	...
	switch (SIMNet::req("action")) {
		...
		*/
		...
		$consultaMax = "SELECT MAX(IDNoticia) as Maximo FROM " . $table;
		$ejecutaMax = $dbo->query($consultaMax);
		$max = $dbo->fetchArray($ejecutaMax);
		$IDNoticia = $max['Maximo'];
                 
/*
		 
                $sqlCopia="INSERT INTO " . $table ."(`IDNoticia`, `IDClub`, `IDSeccion`, `DirigidoA`, `SeleccionGrupo`, `TipoSocio`, `URL`, `Titular`, `SubTitular`, `Introduccion`, `Cuerpo`, `Plantilla`, `Publicar`, `Servicio`, `Home`, `Destacada`, `Orden`, `FechaInicio`, `FechaFin`, `NoticiaFile`, `FotoPortada`, `Adjunto1File`, `Adjunto2File`, `Adjunto3File`, `Adjunto4File`, `Foto1`, `Foto2`, `Foto3`, `FotoDestacada`, `SWF`, `Visitas`, `Tag`, `SEO_Title`, `SEO_Description`, `SEO_KeyWords`, `FechaTrCr`, `UsuarioTrCr`, `UsuarioTrEd`, `FechaTrEd`, `FechaNotificacion`, `Video`) SELECT " . $IDNoticia ."+1, `IDClub`, `IDSeccion`, `DirigidoA`, `SeleccionGrupo`, `TipoSocio`, `URL`, `Titular`, `SubTitular`, `Introduccion`, `Cuerpo`, `Plantilla`, `Publicar`, `Servicio`, `Home`, `Destacada`, `Orden`, `FechaInicio`, `FechaFin`, `NoticiaFile`, `FotoPortada`, `Adjunto1File`, `Adjunto2File`, `Adjunto3File`, `Adjunto4File`, `Foto1`, `Foto2`, `Foto3`, `FotoDestacada`, `SWF`, `Visitas`, `Tag`, `SEO_Title`, `SEO_Description`, `SEO_KeyWords`, `FechaTrCr`, `UsuarioTrCr`, `UsuarioTrEd`, `FechaTrEd`, `FechaNotificacion`, `Video` FROM " . $table ." WHERE IDNoticia=".SIMNet::reqInt("id")."";
                
                $ejecutaCopia = $dbo->query($sqlCopia);*/
                
                
		SIMHTML::jsAlert('Noticia Copiada Exitosamente');
