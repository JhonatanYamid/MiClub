<?php
	...
	$sql_reporte = "Select * From ActualizacionMascotasEntrelomas
	...
	if( $NumSocios > 0 )
	{
		...
		$html .= "<table width='100%' border='1'>";
			...
			while( $Datos = $dbo->fetchArray( $result_reporte ) )
			{
				...
				$html .="<td>".$dbo->getFields("Socio", "Nombre" , " NumeroDocumento = '".$Datos["DocumentoDueño"]."' AND IDClub = 75")." ".$dbo->getFields("Socio", "Apellido" , " NumeroDocumento = '".$Datos["DocumentoDueño"]."' AND IDClub = 75")."</td>";
