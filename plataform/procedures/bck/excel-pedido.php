<?php
	...
	$sql_socios="SELECT IDSocio,NumeroDocumento,Accion,Nombre,Apellido FROM Socio WHERE IDClub = '".$_POST["IDClub"]."'";
  ...
  while($row_socios=$dbo->fetchArray($r_socios)){
	...
	$sql_reporte = "SELECT D.*,P.Nombre as NombreProducto, P.Proveedor as Proveedor, DD.Cantidad, DD.ValorUnitario, DD.Comentario as ComentarioProducto,D.FormaPago,D.IDTipoPago
									From Domicilio".$_POST["Version"]. " D, DomicilioDetalle".$_POST["Version"]." DD, Producto P
									Where D.IDDomicilio=DD.IDDomicilio AND DD.IDProducto=P.IDProducto AND D.IDClub = '".$_POST["IDClub"]."'  " .$condicion_fecha."
