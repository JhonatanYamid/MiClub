<?php
	...
	$sql_reporte = "Select * From ActualizacionPuertas
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "	Select *
							From ActualizacionPuertasBeneficiarios
							Where IDActualizacionPuertas = '".$Datos["IDActualizacionPuertas"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasPuertas
							Where IDActualizacionPuertas = '".$Datos["IDActualizacionPuertas"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosPuertas
							Where IDActualizacionPuertas = '".$Datos["IDActualizacionPuertas"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosPuertas
							Where IDActualizacionPuertas = '".$Datos["IDActualizacionPuertas"]."'  Order By FechaTrCr ASC" ;
