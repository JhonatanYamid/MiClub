 <?
	...
	$script = "configuraciondomicilios3";
	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				$delete_tipo_pago = $dbo->query("Delete From DomicilioTipoPago3 Where IDConfiguracionDomicilio = '" . SIMNet::reqInt("id") . "'");
				foreach ($frm["IDTipoPago"] as $Pago_seleccionado) :
					$sql_servicio_forma_pago = $dbo->query("Insert into DomicilioTipoPago3 (IDConfiguracionDomicilio, IDTipoPago) Values ('" . SIMNet::reqInt("id") . "', '" . $Pago_seleccionado . "')");
				endforeach;
