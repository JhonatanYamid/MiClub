 <?
	...
	SIMReg::setFromStructure(array(
		...
		"table" => "ConfiguracionDomicilios",
		"key" => "IDConfiguracionDomicilios",
		"mod" => "ConfiguracionDomicilios"
	));


	$script = "configuraciondomiciliosusuario";
	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				foreach ($frm["IDTipoPago"] as $Pago_seleccionado) :
					$sql_servicio_forma_pago = $dbo->query("Insert into DomicilioTipoPago (IDConfiguracionDomicilio, IDTipoPago) Values ('" . $id . "', '" . $Pago_seleccionado . "')");
				endforeach;
		...
		case "update":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				$delete_tipo_pago = $dbo->query("Delete From DomicilioTipoPago Where IDConfiguracionDomicilio = '" . SIMNet::reqInt("id") . "'");
				foreach ($frm["IDTipoPago"] as $Pago_seleccionado) :
					$sql_servicio_forma_pago = $dbo->query("Insert into DomicilioTipoPago (IDConfiguracionDomicilio, IDTipoPago) Values ('" . SIMNet::reqInt("id") . "', '" . $Pago_seleccionado . "')");
				endforeach;
