<?php
	...
	$sql_reporte = "Select * From ActualizacionTowers
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "	Select *
							From ActualizacionTowersBeneficiarios
							Where IDActualizacionTowers = '".$Datos["IDActualizacionTowers"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasTowers
							Where IDActualizacionTowers = '".$Datos["IDActualizacionTowers"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosTowers
							Where IDActualizacionTowers = '".$Datos["IDActualizacionTowers"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosTowers
							Where IDActualizacionTowers = '".$Datos["IDActualizacionTowers"]."'  Order By FechaTrCr ASC" ;
