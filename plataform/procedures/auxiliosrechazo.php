...
SIMReg::setFromStructure(array(
    "title" => "AuxiliosRechazo",
    "table" => "AuxiliosRechazo",
    "key" => "IDAuxiliosRechazo",
    "mod" => "Auxilios"
));


$script = "auxiliosrechazo";
...
{
    $SqlAuxiliosRechazo = "SELECT * FROM AuxiliosRechazo WHERE AuxiliosRechazo.IDAuxiliosRechazo = $IDAuxiliosRechazo";
