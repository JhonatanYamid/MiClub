 <?
	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				if (!empty($comprobar_correo[IDSocio])) :
					SSIMHTML::jsAlert(SIMUtil::get_traduccion('', '', 'Error:Yaexisteelemailoeldocumentoenesteclub,porfavorverifique', LANGSESSION));
		...
		case "search":
			$view = "views/reportesocios/list.php";
			break;
	...
	if (empty($view))
		$view = "views/reportesocios/form.php";
