 <?
	...
	SIMReg::setFromStructure(array(
		"title" => "CategoriaDirectorio",
		"table" => "CategoriaDirectorioSocio",
		"key" => "IDCategoriaDirectorioSocio",
		"mod" => "DirectorioSocio"
	));


	$script = "categoriadirectoriosocio";
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				if (isset($_FILES)) {
					...
					$files =  SIMFile::upload($_FILES["Icono"], DIRECTORIO_DIR, "IMAGE");
