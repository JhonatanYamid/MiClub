	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				//Envio push
				if ((int)$frm["IDSocio"] > 0) :
					$Mensaje = "Se ha generado el siguiente código par que lo pueda utilizar en su proxima reserva: " . $frm["Codigo"];
					SIMUtil::enviar_notificacion_push_general($frm["IDClub"], $frm["IDSocio"], $Mensaje);
				endif;
