    ...
    case "insert":
        ...
        if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
            ...
            if (!empty($comprobar_correo[IDSocio])) :
                ...
                SIMHTML::jsRedirect("registrosocionuba.php?mensaje=' $mensaje '&IDClub=' $IDClub '");
                exit;
            endif;
            //insertamos los datos
            $id = $dbo->insert($frm, $table, $key);
            $mensaje = "Registro Guardado Correctamente, se envio al correo electronico registrado el usuario y la constraseña para el ingreso en la app";
