 <?
	...
	//Verificar permisos
	SIMUtil::verificar_permiso("Evento", SIMUser::get("IDPerfil"));
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				while ($row_soc = $dbo->fetchArray($result_soc)) :
					$insert_secc = "Insert into SocioSeccionEvento (IDSocio, IDSeccionEvento) Values ('" . $row_soc["IDSocio"] . "','" . $id . "')";
