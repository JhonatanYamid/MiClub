...
if ($Registros > 0) {
    ...
    while ($Datos = $dbo->fetchArray($result_reporte)) {
        ...
        $html .= "<tr>";
        /*Datos Socio*/
        $html .= "<td>" . remplaza_tildes(utf8_decode($NombreSocio)) . "</td>";
        $html .= "<td>" . remplaza_tildes(utf8_decode($Datos["SocioConsume"])) . "</td>";

        /*Datos Reserva*/
        $html .= "<td>" . $Datos['IDReservaGeneral'] . "</td>";
        $html .= "<td>" . remplaza_tildes(utf8_decode($NombreServicio)) . "</td>";
        $html .= "<td>" . utf8_decode($reserva['Fecha']) . "</td>";
        $html .= "<td>" . utf8_decode($reserva['Hora']) . "</td>";
        $html .= "<td>" . utf8_decode($reserva['Cumplida']) . "</td>";

        /*Datos Talonera*/
        $html .= "<td>" . $Datos['IDSocioTalonera'] . "</td>";
        $html .= "<td>" . remplaza_tildes(utf8_decode($talonera)) . "</td>";
