	...
	switch (SIMNet::req("action")) {
		...
		case "insert":
			...
			if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
				...
				$files =  SIMFile::upload($_FILES["Icono"], CLUB_DIR, "IMAGE");
		...
		case "delete":
			$id =  $_GET['id']; 
                        $sql="DELETE * FROM `ParticipantesEvento` WHERE IDParticipante=$id";
                        $result = $dbo->query( $sql );
			SIMHTML::jsRedirect("respuesta_participantes.php");
