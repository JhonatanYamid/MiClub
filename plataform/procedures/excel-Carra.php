<?php
	...
	$sql_reporte = "Select * From ActualizacionCarra
	...
	if( $NumSocios > 0 )
	{
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$sql_benef = "	Select *
							From ActualizacionCarraBeneficiarios
							Where IDActualizacionCarra = '".$Datos["IDActualizacionCarra"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasCarra
							Where IDActualizacionCarra = '".$Datos["IDActualizacionCarra"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosCarra
							Where IDActualizacionCarra = '".$Datos["IDActualizacionCarra"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosCarra
							Where IDActualizacionCarra = '".$Datos["IDActualizacionCarra"]."'  Order By FechaTrCr ASC" ;
