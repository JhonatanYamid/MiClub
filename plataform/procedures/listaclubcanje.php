...
switch (SIMNet::req("action")) {
    ...
    case "update":
        ...
        if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
            ...
            $borrar_clubcanje = $dbo->query("Delete From ListaDetalleClubCanje  Where IDClub = '" . $frm["IDClub"] . "'");
            foreach ($_POST["ClubCanje"] as $key_canje => $id_club) :

                $sql_inserta_clubcanje = "Insert into ListaDetalleClubCanje  (IDClub, IDListaClubes) Values ('" . $frm["IDClub"] . "','" . $id_club . "')";

                /*  echo $sql_inserta_clubcanje;
                exit; */
