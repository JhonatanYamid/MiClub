<?php
	...
	$sql_seccion_cla="SELECT Nombre,IDSeccionClasificados FROM SeccionClasificados Where IDClub = '".$_POST["IDClub"]."'";
	...
	$nombre = "Clasificado_" . date( "Y_m_d" );
    ...
    $html .= "<th>Numero</th>";
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$html .= "<td>" . (string)$datos_socio["Accion"] ."</td>";
