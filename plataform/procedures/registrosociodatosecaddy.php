    ...
    case "insert":
        ...
        if (!SIMNotify::capture(SIMUtil::valida($_POST, $array_valida), "error")) {
            ...
            if (!empty($comprobar_correo[IDSocio])) :
                ...
                SIMHTML::jsRedirect("registrosocioecaddy.php?mensaje=' $mensaje '&IDClub=' $IDClub '");
                exit;
            endif;
            ...
            $mensaje = "Registro guardado correctamente por favor revise el Correo electrónico donde se enviarán todos los datos para el ingreso";
