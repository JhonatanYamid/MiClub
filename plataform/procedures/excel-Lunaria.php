<?php
	...
	$sql_reporte = "Select * From ActualizacionLunaria
	...
	if( $NumSocios > 0 )
	{
		...
		$html .= "<table width='100%' border='1'>";
			...
			$html .= "<tr>";
				...
				$html .= "<th>Telefono</th>";
				$html .= "<th>Celular</th>";
				$html .= "<th>Numero de contacto alterno</th>";
				$html .= "<th>Email</th>";
		...
		while( $Datos = $dbo->fetchArray( $result_reporte ) )
		{
			...
			$html .= "<tr>";
				...
				$html .= "<td>" . $Datos["TipoIdentificacion"] ."</td>";
				...
				$html .= "<td>" . $Datos["NumeroContactoAlterno"] ."</td>";
			...
			$sql_benef = "	Select *
							From ActualizacionLunariaBeneficiarios
							Where IDActualizacionLunaria = '".$Datos["IDActualizacionLunaria"]."'  Order By FechaTrCr ASC" ;
			...
			while( $DatosBenef = $dbo->fetchArray( $result_benef ) )
			{
				$html .= "<tr>";
					...
					$html .= "<td>" . $DatosBenef["TipoIdentificacionBeneficiario"] ."</td>";
			...
			$sql_mascotas = "	Select *
							From ActualizacionMascotasLunaria
							Where IDActualizacionLunaria = '".$Datos["IDActualizacionLunaria"]."'  Order By FechaTrCr ASC" ;
			...
			$sql_vehiculos = "	Select *
							From ActualizacionVehiculosLunaria
							Where IDActualizacionLunaria = '".$Datos["IDActualizacionLunaria"]."'  Order By FechaTrCr ASC" ;
			...
			while( $Datosvehiculos = $dbo->fetchArray( $result_vehiculos ) )
			{
				$html .= "<tr>";
					...
					$html .= "<td>".$Datosvehiculos["TipoVehiculo"]."</td>";
			...
			$sql_contactos = "	Select *
							From ActulizacionContactosLunaria
							Where IDActualizacionLunaria = '".$Datos["IDActualizacionLunaria"]."'  Order By FechaTrCr ASC" ;
