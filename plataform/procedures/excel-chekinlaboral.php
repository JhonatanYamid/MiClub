...
if ($NumSocios > 0) {
    ...
    while ($Datos = $dbo->fetchArray($result_reporte)) {
        ...
        if (!empty($Datos["PersonaQueAprobo"])) {
            ...
            $personaqueaprobo = $persona[1] . " " . $persona[2] . " " . $persona[3];
        } else {
            $personaqueaprobo = "";
        }
        ...
        if ($Datos["IDSocio"] > 0) {
            ...
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("SitioTrabajo", "Nombre", "IDSitioTrabajo = '" . $Datos["IDSitioTrabajo"] . "'")))) . "</td>";
        ...
        if ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes" && $Datos["IDUsuario"] > 0) {
            if (!empty($Datos["Entrada"]) && $Datos["IDUsuario"] > 0 && ($horaEntrada <  $fechaEntradaEstablecidaUsuario)) {
                ...
                $html .= "<td>" . number_format($totalHorasEntradaUsuario, 2) . "</td>";
            } else 
            if (!empty($Datos["Entrada"]) && $Datos["IDUsuario"] > 0 && ($horaEntrada  >=  $fechaEntradaEstablecidaUsuario)) {
        ...
        if ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes" && $Datos["IDSocio"] > 0) {
            if (!empty($Datos["Entrada"]) && $Datos["IDSocio"] > 0 && ($horaEntrada <  $fechaEntradaEstablecidaSocio)) {
                ...
                $html .= "<td>" . number_format($totalHorasEntradaSocio, 2) . "</td>";
            } else 
        if (!empty($Datos["Entrada"]) && $Datos["IDSocio"] > 0 && ($horaEntrada >=  $fechaEntradaEstablecidaSocio)) {
                $html .= "<td>" . remplaza_tildes(('0.0')) . "</td>";
            } else
        ...
        if ($Datos["IDUsuario"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes")) {
            if (!empty($Datos["Salida"]) && $Datos["IDUsuario"] > 0 && ($horaSalida >   $fechaSalidaEstablecidaUsuario)) {
                ...
                //si las extras son mayores de 15 minutos
                if ((float)$totalHorasSalidaUsuario > 0.25) {
                    $totalHorasSalidaUsuario = $totalHorasSalidaUsuario;
                } else {
                    $totalHorasSalidaUsuario = 0;
                }
                ...
                $html .= "<td>" . number_format($totalHorasSalidaUsuario, 2) . "</td>";
            } else 
                    if (!empty($Datos["Salida"]) && $Datos["IDUsuario"] > 0 && ($horaSalida <=   $fechaSalidaEstablecidaUsuario)) {
                $html .= "<td>" . remplaza_tildes(('0.0')) . "</td>";
            } else 
        ...
        if ($Datos["IDSocio"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes")) {
            if (!empty($Datos["Salida"]) && $Datos["IDSocio"] > 0 && ($horaSalida >   $fechaSalidaEstablecidaSocio)) {
                ...
                //si las extras son mayores de 15 minutos
                if ((float)$totalHorasSalidaSocio > 0.25) {
                    $totalHorasSalidaSocio = $totalHorasSalidaSocio;
                } else {
                    $totalHorasSalidaSocio = 0;
                }


                // $totalHorasSalidaSocio = str_replace(".", ",", $totalHorasSalidaSocio);
                //$html .= "<td>" . remplaza_tildes($ExtraSocioSalida->format('%h,%I')) . "</td>";
                $html .= "<td>" . number_format($totalHorasSalidaSocio, 2) . "</td>";
            } else 
                     if (!empty($Datos["Salida"]) && $Datos["IDSocio"] > 0 && ($horaSalida <=   $fechaSalidaEstablecidaSocio)) {
                $html .= "<td>" . remplaza_tildes(('0.0')) . "</td>";
            } else
        ...
        if ($Datos["IDSocio"] > 0) {
            ...
            if ($Datos["IDSocio"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes" && empty($DiaFestivo["Fecha"])) && !empty($Datos["HoraInicioLaboralSocio"]) && !empty($Datos["HoraFinalLaboralSocio"]) && !empty($Datos["FechaMovimientoEntrada"]) && !empty($Datos["FechaMovimientoSalida"])) {
                ...
                //si las extras son mayores de 15 minutos
                if ((float)$TotalExtrasDiurnas > 0.25) {
                    $TotalExtrasDiurnas = $TotalExtrasDiurnas;
                } else {
                    $TotalExtrasDiurnas = 0.00;
                }
                //total extras diurnas
                $html .= "<td>" .  number_format($TotalExtrasDiurnas, 2) . "</td>";

                //total extras nocturnas
                $html .= "<td>" . number_format($TotalExtrasNocturnas, 2) . "</td>";
            ...
            if ($Datos["IDSocio"] > 0 && ($Dia == "Sabado" && empty($DiaFestivo["Fecha"])) && !empty($Datos["HoraInicioLaboralSocio"]) && !empty($Datos["HoraFinalLaboralSocio"]) && !empty($Datos["FechaMovimientoEntrada"]) && !empty($Datos["FechaMovimientoSalida"])) {
                ...
                $html .= "<td>" . number_format($TotalExtrasDiurnasSabado, 2) . "</td>";

                //nocturnas sabado
                //$html .= "<td>" . $TotalExtras[3] . "</td>";
                $html .= "<td>" . number_format($TotalExtrasNocturnasSabado, 2) . "</td>";
            ...
            if ($Datos["IDSocio"] > 0 && ($Dia == "Domingo" || !empty($DiaFestivo["Fecha"])) && !empty($Datos["HoraInicioLaboralSocio"]) && !empty($Datos["HoraFinalLaboralSocio"]) && !empty($Datos["FechaMovimientoEntrada"]) && !empty($Datos["FechaMovimientoSalida"])) {
                ...
                $html .= "<td>" . number_format($TotalExtrasDiurnasDomingo, 2) . "</td>";

                //nocturnas domingo
                // $html .= "<td>" . $TotalExtras[5] . "</td>";
                $html .= "<td>" . number_format($TotalExtrasNocturnasDomingo, 2) . "</td>";
    ...
    /*MARCACION DESPUES DEL TURNO */
    $html .= "<tr>";
    $html .= "<td colspan=34>" . " " . "</td>";
    $html .= "</tr>";
    $html .= "<tr>";
    $html .= "<th colspan=34>" . "MARCACION DESPUES DEL TURNO" . "</th>";
    $html .= "</tr>";

    $sql_reporte2 = "Select CL.*, U.HoraInicioLaboral, U.HoraFinalLaboral,
        S.HoraInicioLaboral as HoraInicioLaboralSocio ,S.HoraFinalLaboral as HoraFinalLaboralSocio
 From CheckinLaboralHorasExtras  CL
 LEFT JOIN Socio S ON CL.IDSocio=S.IDSocio LEFT JOIN Usuario U on CL.IDUsuario= U.IDUsuario                                                 
					Where CL.IDClub = '" . $_POST["IDClub"] . "' " . $condicion_fecha . $condicionJefe . $condicion_socio_usuario . $condicion_estado .
        " Order By CL.IDCheckinLaboral DESC";


    $result_reporte2 = $dbo->query($sql_reporte2);
    while ($Datos2 = $dbo->fetchArray($result_reporte2)) {

        //persona que aprobo
        if (!empty($Datos2["PersonaQueAprobo"])) {
            $persona = explode(" ", $Datos2["PersonaQueAprobo"]);
            $personaqueaprobo = $persona[1] . " " . $persona[2] . " " . $persona[3];
        } else {
            $personaqueaprobo = "";
        }
        ...
        //persona que modifico
        if (!empty($Datos2["UsuarioTrEd"])) {

            $personaquemodifico = $Datos2["UsuarioTrEd"];
        } else {
            $personaquemodifico = "";
        }

        //tomo la fecha del movimiento donde el socio o usuario registran entrada 
        $separarFechaEntrada = (explode(" ", $Datos2["FechaMovimientoEntrada"]));
        $horaEntrada = new DateTime($separarFechaEntrada[1]);

        //tomo la fecha del movimiento donde el socio o usuario registran salida
        $separarFechaSalida = (explode(" ", $Datos2["FechaMovimientoSalida"]));
        $horaSalida = new DateTime($separarFechaSalida[1]);

        //usuario
        if ($Datos2["IDUsuario"] > 0) {
            //saco horas extras de los usuarios-- hora de entrada
            $fechaEntradaEstablecidaUsuario = new DateTime($Datos2["HoraEntradaEstablecida"]);
            $ExtraUsuarioEntrada = $horaEntrada->diff($fechaEntradaEstablecidaUsuario);


            //saco horas extras de los usuarios-- hora de salida
            $fechaSalidaEstablecidaUsuario = new DateTime($Datos2["HoraSalidaEstablecida"]);
            $ExtraUsuarioSalida = $horaSalida->diff($fechaSalidaEstablecidaUsuario);
        }
        ...
        if ($Datos2["IDSocio"] > 0) {
            //saco horas extras de los socios-- hora de entrada
            $fechaEntradaEstablecidaSocio = new DateTime($Datos2["HoraEntradaEstablecida"]);
            $ExtraSocioEntrada = $horaEntrada->diff($fechaEntradaEstablecidaSocio);

            //saco horas extras de los socios-- hora de salida
            $fechaSalidaEstablecidaSocio = new DateTime($Datos2["HoraSalidaEstablecida"]);
            $ExtraSocioSalida = $horaSalida->diff($fechaSalidaEstablecidaSocio);
        }
        //dia de la semana
        $Dia = saber_dia($separarFechaEntrada[0]);
        ...
        // nombre,Numero documento,hora Inicio laboral, hora fin laboral socio-usario
        if ($Datos2["IDSocio"] > 0) {
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "Nombre", "IDSocio = '" . $Datos2["IDSocio"] . "'") . " " . $dbo->getFields("Socio", "Apellido", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "NumeroDocumento", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "Cargo", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "Bpf", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "Bt", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Socio", "Empresa", "IDSocio = '" . $Datos2["IDSocio"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("SitioTrabajo", "Nombre", "IDSitioTrabajo = '" . $Datos2["IDSitioTrabajo"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes($Datos2["HoraEntradaEstablecida"]) . "</td>";
            $html .= "<td>" . remplaza_tildes($Datos2["HoraSalidaEstablecida"]) . "</td>";
        } else if ($Datos["IDUsuario"] > 0) {
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "Nombre", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "NumeroDocumento", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "Cargo", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "Bpf", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "Bt", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("Usuario", "Empresa", "IDUsuario = '" . $Datos2["IDUsuario"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes(utf8_encode(strtoupper($dbo->getFields("SitioTrabajo", "Nombre", "IDSitioTrabajo = '" . $Datos2["IDSitioTrabajo"] . "'")))) . "</td>";
            $html .= "<td>" . remplaza_tildes($Datos2["HoraEntradaEstablecida"]) . "</td>";
            $html .= "<td>" . remplaza_tildes($Datos2["HoraSalidaEstablecida"]) . "</td>";
        }
        ...
        $html .= "<td>" . remplaza_tildes($Datos2["Entrada"]) . "</td>";
        $html .= "<td>" . saber_dia($separarFechaEntrada[0]) . "</td>";
        $html .= "<td>" . remplaza_tildes(($separarFechaEntrada[0])) . "</td>";
        $html .= "<td>" . remplaza_tildes(($separarFechaEntrada[1])) . "</td>";
        $html .= "<td>" . "0" . "</td>";
        ...
        if ($Datos2["IDSocio"] > 0) {
            ...
            //extras totales diurnas socio
            if ($Datos2["IDSocio"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes" && empty($DiaFestivo["Fecha"])) && !empty($Datos2["HoraInicioLaboralSocio"]) && !empty($Datos2["HoraFinalLaboralSocio"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"])) {

                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnas = $TotalExtras[0];
                $TotalExtrasNocturnas = $TotalExtras[1];
                //total extras diurnas
                $html .= "<td>" .  number_format($TotalExtrasDiurnas, 2) . "</td>";
                ...
                //total extras nocturnas
                $html .= "<td>" . number_format($TotalExtrasNocturnas, 2) . "</td>";
            } else  if ($Datos2["IDSocio"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes" && empty($DiaFestivo["Fecha"])) && empty($Datos2["HoraInicioLaboralSocio"]) || empty($Datos2["HoraFinalLaboralSocio"]) || empty($Datos2["FechaMovimientoEntrada"]) || empty($Datos2["FechaMovimientoSalida"])) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "   " . "</td>";
            } else if ($Datos2["IDSocio"] > 0 && ($Dia == "Sabado" || $Dia == "Domingo" || !empty($DiaFestivo["Fecha"]))) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "   " . "</td>";
            }

            //total extras sabado socio
            if ($Datos2["IDSocio"] > 0 && ($Dia == "Sabado" && empty($DiaFestivo["Fecha"])) && !empty($Datos2["HoraInicioLaboralSocio"]) && !empty($Datos2["HoraFinalLaboralSocio"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"])) {
                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnasSabado = $TotalExtras[2];
                $TotalExtrasNocturnasSabado = $TotalExtras[3];
                //diurnas sabado
                ...
                $html .= "<td>" . number_format($TotalExtrasNocturnasSabado, 2) . "</td>";
            } else if ($Datos2["IDSocio"] > 0 && ($Dia == "Sabado" && empty($DiaFestivo["Fecha"])) && empty($Datos2["HoraInicioLaboralSocio"]) || empty($Datos2["HoraFinalLaboralSocio"]) || empty($Datos2["FechaMovimientoEntrada"]) || empty($Datos2["FechaMovimientoSalida"])) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "   " . "</td>";
            } else  if ($Datos2["IDSocio"] > 0 && ($Dia != "Sabado") || !empty($DiaFestivo["Fecha"])) {
                $html .= "<td>" . "   " . "</td>";
                $html .= "<td>" . "  " . "</td>";
            }

            //total extras domingo socio
            if ($Datos2["IDSocio"] > 0 && ($Dia == "Domingo" || !empty($DiaFestivo["Fecha"])) && !empty($Datos2["HoraInicioLaboralSocio"]) && !empty($Datos2["HoraFinalLaboralSocio"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"])) {
                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnasDomingo = $TotalExtras[4];
                $TotalExtrasNocturnasDomingo = $TotalExtras[5];
                ...
                $html .= "<td>" . number_format($TotalExtrasNocturnasDomingo, 2) . "</td>";
            } else if ($Datos2["IDSocio"] > 0 && ($Dia == "Domingo") && empty($Datos2["HoraInicioLaboralSocio"]) || empty($Datos2["HoraFinalLaboralSocio"]) || empty($Datos2["FechaMovimientoEntrada"])) {
                $html .= "<td>" . "   " . "</td>";
                $html .= "<td>" . "   " . "</td>";
            } else if ($Datos2["IDSocio"] > 0 && ($Dia != "Domingo" || empty($DiaFestivo["Fecha"]))) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "   " . "</td>";
            }
        }
        ...
        if ($Datos2["IDUsuario"] > 0) {
            //extras totales diurnas usuario pendiente
            if ($Datos2["IDUsuario"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes") && !empty($Datos2["HoraInicioLaboral"]) && !empty($Datos2["HoraFinalLaboral"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"]) &&  (int)$IDFestivoCol <= 0) {
                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnas = $TotalExtras[0];
                $TotalExtrasNocturnas = $TotalExtras[1];
                ...
                //total extras nocturnas
                $html .= "<td>" . number_format($TotalExtrasNocturnas, 2) . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia == "Lunes" || $Dia == "Martes" || $Dia == "Miercoles" || $Dia == "Jueves" || $Dia == "Viernes") && empty($Datos2["HoraInicioLaboral"]) || empty($Datos2["HoraFinalLaboral"]) || empty($Datos2["FechaMovimientoEntrada"]) || empty($Datos2["FechaMovimientoSalida"])) {
                $html .= "<td>" . " " . "</td>";
                $html .= "<td>" . "  espacio 18 " . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia == "Sabado" || $Dia == "Domingo")) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "  " . "</td>";
            }
            ...
            //total extras sabado usuario
            if ($Datos2["IDUsuario"] > 0 && ($Dia == "Sabado") && !empty($Datos2["HoraInicioLaboral"]) && !empty($Datos2["HoraFinalLaboral"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"]) &&  (int)$IDFestivoCol <= 0) {
                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnasSabado = $TotalExtras[2];
                $TotalExtrasNocturnasSabado = $TotalExtras[3];
                ...
                //nocturnas sabado usuario
                $html .= "<td>" .   number_format($TotalExtrasNocturnasSabado, 2) . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia == "Sabado") && empty($Datos2["HoraInicioLaboral"]) || empty($Datos2["HoraFinalLaboral"]) || empty($Datos2["FechaMovimientoEntrada"]) || empty($Datos2["FechaMovimientoSalida"])) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "  " . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia != "Sabado")) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . " " . "</td>";
            }

            //total extras domingo usuario
            if ($Datos2["IDUsuario"] > 0 && ($Dia == "Domingo")  && !empty($Datos2["HoraInicioLaboral"]) && !empty($Datos2["HoraFinalLaboral"]) && !empty($Datos2["FechaMovimientoEntrada"]) && !empty($Datos2["FechaMovimientoSalida"]) ||  (int)$IDFestivoCol > 0) {
                $TotalExtras = SIMUtil::tiempo_laboral_despues_de_turno($Datos2["FechaMovimientoEntrada"], $Datos2["FechaMovimientoSalida"]);
                $TotalExtrasDiurnasDomingo = $TotalExtras[4];
                $TotalExtrasNocturnasDomingo = $TotalExtras[5];
                //diurnas domingo
                ...
                //nocturnas domingo usuario
                $html .= "<td>" . number_format($TotalExtrasNocturnasDomingo, 2) . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia == "Domingo")  && empty($Datos2["HoraInicioLaboral"]) || empty($Datos2["HoraFinalLaboral"]) || empty($Datos2["FechaMovimientoEntrada"]) || empty($Datos2["FechaMovimientoSalida"])) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . " " . "</td>";
            } else if ($Datos2["IDUsuario"] > 0 && ($Dia != "Domingo")) {
                $html .= "<td>" . "  " . "</td>";
                $html .= "<td>" . "  " . "</td>";
            }
        }
        ...
        if ($Datos2['Salida'] != "") {
            // $html .= "<td>" . remplaza_tildes($Datos["LatitudSalida"]) . "</td>";
            //$html .= "<td>" . remplaza_tildes($Datos["LongitudSalida"]) . "</td>";
            $html .= "<td>" . remplaza_tildes($Datos2["Salida"]) . "</td>";
            $html .= "<td>" . saber_dia($separarFechaSalida[0]) . "</td>";
            $html .= "<td>" . remplaza_tildes(($separarFechaSalida[0])) . "</td>";
            $html .= "<td>" . remplaza_tildes(($separarFechaSalida[1])) . "</td>";
        } else {
        ...
        if (!empty($Datos2["Estado"])) {
            $html .= "<td>" . remplaza_tildes(SIMResources::$estado_checkin_laboral[$Datos2["Estado"]]) . "</td>";
        } else {
            $html .= "<td>" . " "  . "</td>";
        }

        if (!empty($Datos2["ComentarioRevision"])) {
            $html .= "<td>" . remplaza_tildes($Datos2["ComentarioRevision"]) . "</td>";
        } else {
            $html .= "<td>" . " "  . "</td>";
        }


        if (!empty($Datos2["ObservacionEntrada"])) {
            $html .= "<td>" . remplaza_tildes($Datos2["ObservacionEntrada"]) . "</td>";
        } else {
            $html .= "<td>" . " "  . "</td>";
        }

        if (!empty($Datos2["ObservacionSalida"])) {
            $html .= "<td>" . remplaza_tildes($Datos2["ObservacionSalida"]) . "</td>";
        } else {
            $html .= "<td>" . " "  . "</td>";
        }

        if (!empty($Datos2["FechaCambioEstado"])) {
            $html .= "<td>" . remplaza_tildes($Datos2["FechaCambioEstado"]) . "</td>";
        } else {
            $html .= "<td>" . " "  . "</td>";
        }
        $html .= "<td>" . remplaza_tildes($Datos2["UsuarioTrCr"]) . "</td>";
        $html .= "<td>" .  $personaqueaprobo . "</td>";
        $html .= "<td>" .  $personaquemodifico . "</td>";
        $html .= "<td>" .  $Datos2["FechaTrEd"] . "</td>";
    }
