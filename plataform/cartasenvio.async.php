...
while($row = $dbo->fetchArray($result)) {
	...
	$botones='<a class="red generar_pdf"  id='.$row[$key].' lang = '.$script.' href="views/cartasenvio/pdf.php" alt="PDF"><i class="ace-icon fa fa-file-pdf-o bigger-130" /></a>';
	$botones.=' <a class="red enviar_mail"  id='.$row[$key].' lang = '.$script.' href="#" alt="Enviar Mail"><i class="ace-icon fa fa-envelope-o bigger-130"  /></a>';
