...
include("procedures/administrarPropiedadesBicicleta.php");
include("cmp/seo.php");
?>
</head>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                        ...
                                                                        <button type="button" class="btn btn-purple btn-sm btnEnviar" rel="frmfrmBuscar">
                                                                            ...
                                                                            Buscar Parametro talega
                                                                        </button>
                                                                    </span>
                                                                    <span class="input-group-btn">

                                                                        <button type="button" class="btn btn-primary btn-sm btnRedirect" rel="administrarPropiedadesTalega.php?action=search">
                                                                            Ver Todos
                                                                        </button>
                                                                    </span>
                                                                </div>
