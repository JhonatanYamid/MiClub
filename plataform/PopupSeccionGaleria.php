<?php
	...
	function CreaArbolSecciones($ValorSecciones)
	{
		...
		?>
		<li>
			<span class="folder"><a href="JavaScript:close();" onclick="window.opener.document.frm.NombreSeccion.value = '<?php echo $ValorSecciones['Nombre'];?>';window.opener.document.frm.IDSeccionGaleria.value = '<?php echo $ValorSecciones['IDSeccionGaleria'];?>';"><?php echo $ValorSecciones['Nombre'];?></a></span>
		<?php
		if( $ArrayHijos != Null )
		{
			?>
