...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		<h4 class="widget-title lighter smaller">
		 <i class="ace-icon fa fa-users orange"></i>LISTADO DE LOGS
		</h4>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['Detalles', '<?= SIMUtil::get_traduccion('', '', 'NOMBRE', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'MODULO', LANGSESSION); ?>', 'Consulta sql', 'Direccion ip', '<?= SIMUtil::get_traduccion('', '', 'FECHA', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Ver',
					index: '',
					align: "center"
			...
			rowNum: 20,
			rowList: [20, 40, 100, 300, 500, 1000, 30000],
			sortname: 'Nombre',
			viewrecords: true,
			sortorder: "ASC",
