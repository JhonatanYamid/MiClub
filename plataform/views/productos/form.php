                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    $sql_categoria_producto = $dbo->query("select * from ProductoCategoria where IDProducto = '" . $frm["IDProducto"] . "'");
                                    ...
                                    $query_categoria = $dbo->query("Select * from CategoriaProducto Where IDClub = '" . SIMUser::get("club") . "' Order by Nombre");
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-sm-12">
                                    ...
                                    $query_carac = "SELECT CP.*,PP.Nombre as Categoria
																		...
																		And CP.IDClub = '" . SIMUser::get("club")  . "' and CP.Version = 1
