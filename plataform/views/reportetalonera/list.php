            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-talonera.php">
                            <table>
                                <tr>
                                    <td><input type="text" id="FechaInicio" name="FechaInicio" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td><input type="text" id="FechaFin" name="FechaFin" placeholder=" Fecha Final" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td>
                        ...
                        <br>
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-consumoTalonera.php">
                            <table>
                                <tr>
                                    <td><input type="text" id="FechaInicio" name="FechaInicio" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td><input type="text" id="FechaFin" name="FechaFin" placeholder=" Fecha Final" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td>
                                        ...
                                        <input class="btn btn-info" type="submit" name="expbnr" id="expbnr" value="Exportar Consumo">
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Socio', 'Servicio', 'Nombre Talonera', 'Dirigida', 'Valor Pagado', 'Cantidad Total', 'Cantidad Pendiente', 'Fecha Compra',
                'Fecha Vencimiento', 'Tipo monedero', 'Saldo monedero', 'Activo'
            ],
            colModel: [{
                    name: 'Editar',
                    index: 'Editar',
