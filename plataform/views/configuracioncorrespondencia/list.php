...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoBuscador', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'HabilitaRegistraTodos', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
				...
				{
					name: 'HabilitaRegistraTodos',
					index: 'HabilitaRegistraTodos',
					align: "left"
				},
				{
					name: 'Eliminar',
