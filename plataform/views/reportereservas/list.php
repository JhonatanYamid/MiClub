			...
			<div class="widget-main padding-4">
				<div class="row">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="get" name="frm" id="frm" action="downloadreserva.php" enctype="multipart/form-data">
						...
						<a href="procedures/excel-reserva.php?IDClub=<?php echo SIMUser::get("club"); ?>"><img src="assets/img/xls.gif" >Exportar Todas</a>					
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'includes/async/reportereservas.async.php<?=$url_search ?>',
					datatype: "json",
