...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'LabelConfirmacionEnvio', 'LabelServicioComprar', 'LabelTipoPaquete',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'LabelServicioComprar',
                    index: 'LabelServicioComprar',
                    align: "left"
                },
                {
                    name: 'LabelTipoPaquete',
                    index: 'LabelTipoPaquete',
                    align: "left"
                },
                {
                    name: 'Eliminar',
