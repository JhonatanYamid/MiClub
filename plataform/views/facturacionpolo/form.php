					...
					<!--	<div class="form-group first ">
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								...
								<input type="text" id="FechaCreacion" name="FechaCreacion" title="<?= SIMUtil::get_traduccion('', '', 'FechaCreacion', LANGSESSION); ?>" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaCreacion', LANGSESSION); ?>" class="col-xs-12 calendar" value="<?= $hoy;?>" />
								</div>
		    ...
		    <div class="container">
	          ...
	          <div class="table-container">
			      <table  id="Qimbey" class="table is-hoverable is-bordered is-fullwidth mt-2">
			      	<thead>	
			      	<tr> 
			        <th><?php echo strtoupper($reporte." - ".$nombre) ?> </th>
			      	</tr>
			      	<tr> 
			      	<th>FECHA INICAL: <?php echo $inicio;?> </th>
 				<th>FECHA FINAL: <?php echo $fin;?> </th>
			      	</tr>	      		
				      	<tr>
				      		<th>#</th>
 				      		<th>Veces utilizados</th>
				      		<th>Medio de pago</th>
				      		<th>Cantidad total pagada</th>
...
<?php 
elseif($_GET["action"]=="afiliadosactivos"): 
?>
