<form class="form-horizontal formvalida" role="form" method="post" id="EditPregunta<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <?php
    $action = "InsertarPreguntaVial";
    if ($_GET["IDPreguntaVial"]) {
        $EditPregunta = $dbo->fetchAll("PreguntaVial", " IDPreguntaVial = '" . $_GET["IDPreguntaVial"] . "' ", "array");
        $action = "ModificaPreguntaVial";
    ?>
        <input type="hidden" name="IDPreguntaVial" id="IDPreguntaVial" value="<?php echo $EditPregunta['IDPreguntaVial'] ?>" />
    <?php
    }
    ...
    <div class="col-xs-12 col-sm-12">
        ...
        <table id="simple-table" class="table table-bordered table-hover">
            <tr>
                ...
                <!--<td>Ir a pregunta</td>-->
                <td><?= SIMUtil::get_traduccion('', '', 'Peso', LANGSESSION); ?></td>
    ...
    <div class="clearfix form-actions">
        <div class="col-xs-12 text-center">
            ...
            <!-- <input type="hidden" name="IDPreguntaVial" id="IDPreguntaVial" value="<?php echo $frm[$key] ?>" /> -->
            <input type="hidden" name="IDEncuestaVial" id="IDEncuestaVial" value="<?php echo $_GET['id'] ?>" />
...
<table id="simple-table" class="table table-striped table-bordered table-hover">
    ...
    <tbody id="listacontactosanunciante">
        ...
        $r_documento = &$dbo->all("PreguntaVial", "IDEncuestaVial = '" . $frm[$key]  . "'");
        ...
        ?>
            ...
            <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                <td align="center" width="64">
                    <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPreguntaVial=" . $r->IDPreguntaVial ?>&tabencuesta=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
                </td>
                ...
                <td align="center" width="64">
                    <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPreguntaVial&id=<?php echo $frm[$key]; ?>&IDPreguntaVial=<? echo $r->IDPreguntaVial ?>&tabpregunta=formulario"></a>
                </td>
            </tr>
        <?php
        }
