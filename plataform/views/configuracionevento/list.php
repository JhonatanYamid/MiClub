...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Evento', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'PermiteMostrarCalendarioColores', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'PermiteBuscadorPorNombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TipoFechaEncabezado', LANGSESSION); ?>',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'PermiteMostrarCalendarioColores',
                    index: 'PermiteMostrarCalendarioColores',
                    align: "left"
                },
                {
                    name: 'PermiteBuscadorNombre',
                    index: 'PermiteBuscadorNombre',
                    align: "left"
                },
                {
                    name: 'TipoFechaHeader',
                    index: 'TipoFechaHeader',
                    align: "left"
                },
