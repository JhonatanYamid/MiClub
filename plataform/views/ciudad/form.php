                        ...
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8"><input type="text" id="Nombre" name="Nombre" placeholder="" class="form-control" title="<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>" value="<?php echo $frm["Nombre"] ?>" required></div>


                                </div>

                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="Indicativo"><?= SIMUtil::get_traduccion('', '', 'Indicativo', LANGSESSION); ?></label>
                                    <div class="col-sm-8"><input type="number" id="Indicativo" name="Indicativo" placeholder="" class="form-control" title="<?= SIMUtil::get_traduccion('', '', 'Indicativo', LANGSESSION); ?>" value="<?php echo $frm["Indicativo"] ?>" required></div>
                            ...
                            <div class="form-group first ">
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="Publicar"><?= SIMUtil::get_traduccion('', '', 'publicar', LANGSESSION); ?></label>
                                    <div class="col-sm-8">
