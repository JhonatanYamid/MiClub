                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Texto boton documento adicional</label>
  <div class="col-sm-8">
                                    <input type="text" id="LabelDocumentoNuevo" name="LabelDocumentoNuevo" placeholder="<?= SIMUtil::get_traduccion('', '', 'LabelDocumentoNuevo', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Textobotondocumentoadicional', LANGSESSION); ?>" value="<?php echo $frm["LabelDocumentoNuevo"]; ?>">
                                </div>
                       ...
                       <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Permitir adjuntar documento adicional </label>

                                <div class="col-sm-8">
                                    <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["PermiteDocumentoNuevo"], "PermiteDocumentoNuevo", "title=\"PermiteDocumentoNuevo\"") ?>
                                </div>
                            </div>  
                                    
                       <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Obligatorio adjuntar documento adicional para mi</label>

                                <div class="col-sm-8">
                                    <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["ObligatorioDocumentoNuevoParaMi"], "ObligatorioDocumentoNuevoParaMi", "title=\"ObligatorioDocumentoNuevoParaMi\"") ?>
                                </div>
                            </div>  
                             <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Obligatorio adjuntar documento adicional para tercero </label>

                                <div class="col-sm-8">
                                    <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["ObligatorioDocumentoNuevoParaTercero"], "ObligatorioDocumentoNuevoParaTercero", "title=\"ObligatorioDocumentoNuevoParaTercero\"") ?>
                                </div>
                            </div>  
                                  <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Ver documento adjunto adicional </label>

                                <div class="col-sm-8">
                                    <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["LabelVerDocumentoAdjunto"], "LabelVerDocumentoAdjunto", "title=\"LabelVerDocumentoAdjunto\"") ?>
                                </div>
                            </div>  
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-xs-12 text-center">
                                ...
                                <input type="hidden" name="Version" id="ID" value="2" />
