                                ...
                                <?php if (SIMNet::req("action") == "edit") : ?>
                                    ...
                                    <div id="invitaciones" class="tab-pane fade <?php if ($_GET[tabencuesta] == "registros") echo "in active"; ?>" role="tabpanel">
                                        ...
                                        <div style="width:100%;overflow:auto;">
                                            <?php
                                            if (count($array_NoEncuestaArbol) > 0) {
                                            ?>
    ...
    jQuery(function($) {
        ...
        $("#btExporta").click(function() {
            ...
            if (TipoEncabezado == "Indice") {
                window.location.href = "./procedures/excel-EncuestaArbol.php?id=<?php echo $_GET["id"]; ?>&" + '&FechaInicio=' + Inicio + '&FechaFin=' + Fin;
            } else {
                window.location.href = "./procedures/excel-encuesta-respuesta-arbol.php?id=<?php echo $_GET["id"]; ?>&" + '&FechaInicio=' + Inicio + '&FechaFin=' + Fin;
            }
        ...
        <?php
        if (count($array_NoEncuestaArbol) > 0) {
        ?> $('a[href="#invitaciones"]').on('click', function(e) {
                jQuery(grid_selector).jqGrid({
                    url: 'includes/async/get_EncuestaArbol.async.php?id=<?php echo $_GET["id"]; ?>',
                    datatype: "json",
                    <?php
                    echo "colNames: ['Eliminar','Usuario','Fecha','Puntos','" . str_replace(",", "','", implode(",", $array_preguntas)) . "'],"; ?>
                    colModel: [{
                            name: 'Eliminar',
                            index: '',
                            width: '70',
                        ...
                        <?php $numcols = 1;
                        foreach ($array_NoEncuestaArbol as $colData) {
