...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoTitulo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoBotonIngresarPrestamo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoBotonRegistrarDevolucion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoTituloBuscador', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoBuscador', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'LabelBotonIngresarPrestamo',
                    index: 'LabelBotonIngresarPrestamo',
                    align: "left"
                },
                {
                    name: 'LabelBotonRegistrarDevolucion',
                    index: 'LabelBotonRegistrarDevolucion',
                    align: "left"
                },
                {
                    name: 'LabelTituloBuscador',
                    index: 'LabelTituloBuscador',
                    align: "left"
                },
                {
                    name: 'LabelBuscador',
