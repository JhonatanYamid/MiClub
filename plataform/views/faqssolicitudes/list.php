				...
				<div class="col-xs-12">
					...
					<div id="jqGrid_container">
						<form name="frmexportadom" id="frmexportadom" method="post" enctype="multipart/form-data" action="procedures/excel-pedido.php">
							<table>
								<tr>
									<td><input type="text" id="FechaInicio" name="FechaInicio" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="Fecha Inicio" value="<?php echo $frm["FechaInicio"] ?>" autocomplete="off"></td>
									<td><input type="text" id="FechaFin" name="FechaFin" placeholder="Fecha Fin" class="col-xs-12 calendar" title="fecha fin" value="<?php echo $frm["FechaFin"] ?>" autocomplete="off"></td>
									<td>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Pregunta', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
