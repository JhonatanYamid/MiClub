...
<form class="form-horizontal formvalida" role="form" method="post" name="frm" id="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
            ...
            <div class="col-sm-8">
                ...
                if ($frm["Adjunto3File"]) {
                    ...
                    if (strstr(strtolower($frm["Adjunto3File"]), "http://"))
                        $ruta_adjunto3file = $frm["Adjunto3File"];
                    else
                        $ruta_adjunto3file = IMGEVENTO_ROOT . $frm["Adjunto3File"];
                ?>
                    <a target="_blank" href="<?php echo $ruta_adjunto3file; ?>"><?php echo $frm["Adjunto3File"] ?></a>
            ...
            <div class="col-sm-8">
                ...
                if ($frm["Adjunto4File"]) {
                    ...
                    if (strstr(strtolower($frm["Adjunto4File"]), "http://"))
                        $ruta_adjunto4file = $frm["Adjunto4File"];
                    else
                        $ruta_adjunto4file = IMGEVENTO_ROOT . $frm["Adjunto4File"];
                ?>
                    <a target="_blank" href="<?php echo $ruta_adjunto3file; ?>"><?php echo $frm["Adjunto4File"] ?></a>
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <?php
                $sql_tipo_pago_servicio = "Select * From EventoTipoPago Where IDEvento = '" . SIMNet::reqInt("id") . "'";
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="text" id="FechaLimiteInscripcion" name="FechaLimiteInscripcion" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaLimiteInscripcion', LANGSESSION); ?>" class="col-xs-12 calendar" title="Fecha Limite Inscripcion" value="<?php echo $frm["FechaLimiteInscripcion"] ?>">
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'permitirbotonwhatsapp', LANGSESSION); ?> ? </label>

            <div class="col-sm-8">
                <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["PermiteBotonWhatsapp"], "PermiteBotonWhatsapp", "title=\"permitirbotonwhatsapp\"") ?>
            </div>
        </div>

        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Etiquetabotonwhatsapp', LANGSESSION); ?> :</label>
            <div class="col-sm-8">
                <input id="LabelBotonWhatsapp" type=text size=25 name="LabelBotonWhatsapp" class="input" title="Etiqueta boton whatsapp" value="<?= $frm["LabelBotonWhatsapp"] ?>">
            </div>
        </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'numerowhatsapp', LANGSESSION); ?> : </label>
            <div class="col-sm-8">
                <input id="Whatsapp" type=number size=25 name="Whatsapp" class="input" title="Numero de whatsapp" value="<?= $frm["Whatsapp"] ?>">
            </div>
        </div>
    </div>
