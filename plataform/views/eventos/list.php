			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="jqGrid_container">
						<form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-eventos.php">
							<table>
								<tr>
									<td><input type="text" id="FechaEvento" name="FechaEvento" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="Fecha Evento" value="<?php echo date("Y-m-d") ?>"></td>
									<td><input type="text" id="FechaFinEvento" name="FechaFinEvento" placeholder=" Fecha Final" class="col-xs-12 calendar" title="FechaFinEvento" value="<?php echo date("Y-m-d") ?>"></td>
									<td>
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: [
				...
				'<?= SIMUtil::get_traduccion('', '', 'Seccion', LANGSESSION); ?>', 
				'<?= SIMUtil::get_traduccion('', '', 'Titular', LANGSESSION); ?>', 
				'#<?= SIMUtil::get_traduccion('', '', 'Permitidos', LANGSESSION); ?>', 
			...
			colModel: [
				{name: 'Editar',index: '',align: "center",search: "false"},
				{name: 'Seccion',index: 'Seccion',align: "left"},
				{name: 'Titular',index: 'Titular',align: "left"},
				{name: 'MaximoParticipantes',index: 'MaximoParticipantes',align: "left"},
				{name: 'TotalRegistrado',index: 'TotalRegistrado',align: "left"},
				{name: 'Publicar',index: 'Publicar',align: "left"},
				{name: 'Eliminar',index: '',align: "center",search: "false"},
			],
			rowNum: 100,
			rowList: [20, 40, 100],
			sortname: 'IDEvento',
