...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'NombrePropietario', 'Casa', 'PersonasQueHabitan', 'Vehiculos', 'Mascotas', 'LlamarEnCasoDeEmergencia',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'PersonasQueHabitan',
                    index: 'PersonasQueHabitan',
                    align: "left"
                },
                {
                    name: 'Vehiculos',
                ...
                {
                    name: 'LlamarEnCasoDeEmergencia',
                    index: 'LlamarEnCasoDeEmergencia',
                    align: "left"
                },
                {
                    name: 'Eliminar',
