    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input type="text" id="NumeroDocumentoUsuario" name="NumeroDocumentoUsuario" placeholder="<?= SIMUtil::get_traduccion('', '', 'NúmerodeDerecho', LANGSESSION); ?>" class="col-xs-12 mandatory autocomplete-ajax-funcionario" title="número de documento" <?php if ($_GET["action"] != "add") echo "readonly"; ?> value="<?php echo $r_socio["Nombre"] ?>">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" <?php if ($_GET['action'] == 'edit') echo "disabled" ?>>
                    <option value=""></option>
                    <?php
                    $sql_restaurante_club = "Select IDRestauranteDomicilio,Nombre From RestauranteDomicilio2 Where IDClub = '" . SIMUser::get("club") . "' AND Publicar='S'";
