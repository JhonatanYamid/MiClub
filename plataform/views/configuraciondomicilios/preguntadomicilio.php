      <div id="DomicilioPregunta">
                        ...
                        <tr>
                          ...
                          <td>
                            <select name="Tipo" id="Tipo" class="form-control" required>
                              ...
                              <option value="outerselect" <?php if ($EditDomicilioPregunta["Tipo"] == "outerselect") echo "selected"; ?>>Varias opciones (unica opcion en otra pantalla)</option>
                            </select>
                          </td>
                        </tr>
                        <tr>
        ...
        <table id="simple-table" class="table table-striped table-bordered table-hover">
          ...
          <tbody id="listacontactosanunciante">
            ...
            $r_documento = &$dbo->all("DomicilioPregunta", "IDConfiguracionDomicilio = '" . $frm[$key]  . "' and Version = 1 ");
