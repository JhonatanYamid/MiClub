...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Aplicaparaelrestaurante', LANGSESSION); ?>:
            </label>
            <div class="col-sm-8">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Tiempominimoparahacerpedido', LANGSESSION); ?>
            </label>

            <div class="col-sm-8">
                <input type="number" id="TiempoMinimoPedido" name="TiempoMinimoPedido" placeholder="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoPedido', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Tiempominimoparahacerpedido', LANGSESSION); ?>" value="<?php echo $frm["TiempoMinimoPedido"]; ?>"><?= SIMUtil::get_traduccion('', '', 'minutos', LANGSESSION); ?>
                <br><?= SIMUtil::get_traduccion('', '', '(EjemploSies60minutosysielpedidoserealizaalas2pmlopodrarecibirminimoalas3pm)', LANGSESSION); ?>
            </div>
        </div>

        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'IntervaloEntregaPedido', LANGSESSION); ?>:
            </label>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Tiempominimoparacancelacionpedido', LANGSESSION); ?>

            </label>

            <div class="col-sm-8">
                <input type="number" id="TiempoMinimoCancelacion" name="TiempoMinimoCancelacion" placeholder=" <?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'TiempoMinimoCancelacion', LANGSESSION); ?>" value="<?php echo $frm["TiempoMinimoCancelacion"]; ?>"><?= SIMUtil::get_traduccion('', '', 'minutos', LANGSESSION); ?>
            </div>
        </div>

        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TiempoConfirmacionPedido', LANGSESSION); ?>
            </label>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                <?= SIMUtil::get_traduccion('', '', 'PorcentajePropina(sobreeltotaldelpedido)', LANGSESSION); ?>
            </label>

            <div class="col-sm-8">
                <input type="number" id="PorcentajePropina" name="PorcentajePropina" placeholder="<?= SIMUtil::get_traduccion('', '', 'PorcentajePropina', LANGSESSION); ?>" class="col-xs-12 " title="<?= SIMUtil::get_traduccion('', '', 'PorcentajePropina', LANGSESSION); ?>" value="<?php echo $frm["PorcentajePropina"]; ?>">
            </div>
        </div>

        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TextoPropina', LANGSESSION); ?> </label>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Pago', LANGSESSION); ?>: </label>
            <div class="col-sm-8">
                <?php
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'PedirFechaenDomicilios', LANGSESSION); ?>:
            </label>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'PermitirPedidoelmismodia', LANGSESSION); ?>?:
            </label>
            <div class="col-sm-8">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'IpImpresora', LANGSESSION); ?> </label>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Mostrarbuscadordeproductos', LANGSESSION); ?>?
            </label>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Cantidad de pedidos en un tiempo establecido </label>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Cantidad máxima de productos en un tiempo establecido </label>

            <div class="col-sm-8">
                <input type="text" id="CantidadMaximaProductoPorTiempo" name="CantidadMaximaProductoPorTiempo" placeholder="" class="col-xs-12 " title="" value="<?php echo $frm["CantidadMaximaProductoPorTiempo"]; ?>">
            </div>
        </div>
    </div>
