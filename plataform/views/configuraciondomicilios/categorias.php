      <div id="PropiedadProducto">
                    ...
                    <td valign="top">
                      ...
                      <table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
                        ...
                        <tr>
                          ...
                          <td width="74%">
                            <input id="MaximoPermitido" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'Maximodeopcionespermitidasparaseleccionarcuandoesmultiple', LANGSESSION); ?>" name="MaximoPermitido" class="input" value="<?php echo $EditPropiedadProducto["MaximoPermitido"] ?>" />
                          </td>
                        </tr>
                        <tr>
        ...
        <table id="simple-table" class="table table-striped table-bordered table-hover">
          ...
          <tbody id="listacontactosanunciante">
            ...
            $r_documento = &$dbo->all("PropiedadProducto", "IDConfiguracionDomicilio = '" . $frm[$key]  . "' and Version = 1 ");
            ...
            ?>
              ...
              <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                <td align="center" width="64">
                  <a href="<?php echo "?mod=" . SIMReg::get("mod") . "&action=edit&id=" . $_GET[id] . "&IDPropiedadProducto=" . $r->IDPropiedadProducto ?>&tabsocio=caracteristica&tab=categoriap" class="ace-icon glyphicon glyphicon-pencil"></a>
                </td>
                <td><?php echo $r->Nombre; ?></td>
                <td><?php echo $r->Tipo; ?></td>
                <td><?php echo $r->Publicar; ?></td>
                <td align="center" width="64">
                  <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPropiedadProducto&id=<?php echo $_GET[id]; ?>&IDPropiedadProducto=<? echo $r->IDPropiedadProducto ?>&tabsocio=caracteristica&tab=categoriap"></a>
                </td>
              </tr>
            <?php
            }
