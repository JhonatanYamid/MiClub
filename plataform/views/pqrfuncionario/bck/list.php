			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
                        ...
                        <a href="procedures/excel-pqr.php?IDClub=<?php echo SIMUser::get("club"); ?>"><img src="assets/img/xls.gif" >Exportar</a>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Numero', 'Fecha', 'Tipo','Area','Tipo Socio','Socio','Asunto','Descripcion','Estado', 'Eliminar' ],
					colModel:[						
						...
						{name:'Asunto',index:'Asunto', align:"left"},
