                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8"> <?php echo $frm["Numero"]; ?> </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="IDServiciosPqr" id="IDServiciosPqr">
                                            <option value=""></option> <?php
											$sql_area_club = string;
											$sql_area_club = "Select * From ServiciosPqr Where IDClub = '".SIMUser::get("club")."' and Activo = 1 AND ParaSocio = 0 order by Nombre";
											$qry_area_club = $dbo->query($sql_area_club);
											while ($r_area = $dbo->fetchArray($qry_area_club)): ?> <option value="<?php echo $r_area["c"]; ?>" <?php if($r_area["IDServiciosPqr"]==$frm["IDServiciosPqr"]) echo "selected";  ?>><?php echo $r_area["Nombre"]; ?></option> <?php
												endwhile;    ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group first"> <?= SIMUtil::get_traduccion('', '', 'AgregarRespuesta', LANGSESSION); ?> <div class="col-sm-12"> <?php
									...
									if (isset($detalles)) : ?> <?php foreach ($detalles as $detalle) : ?> <div class="timeline-items">
                                        <div class="timeline-item clearfix">
                                            <div class="timeline-info"> <?php if ($detalle->IDUsuario > 0) { ?> <img alt="<?php echo $datos_club[Nombre]; ?>" src="<?php echo CLUB_ROOT . $datos_club[FotoLogoApp] ?>" /> <?php
														} elseif ($detalle->IDUsuarioCreacion > 0) { ?> <img alt="<?php echo $datos_club[Nombre]; ?>" src="assets/avatars/avatar2.png" /> <?php } ?> <span class="label label-info label-sm"><?php echo substr($detalle->FechaTrCr, 10); ?></span>
                                            </div>
                                            <div class="widget-box transparent">
                                                <div class="widget-header widget-header-small">
                                                    ...
                                                    <span class="widget-toolbar no-border">
                                                        <i class="ace-icon fa fa-clock-o bigger-110"></i> <?php echo $detalle->Fecha; ?> </span>
                                                ...
                                                <div class="widget-body">
                                                    <div class="widget-main"> <?php echo $detalle->Respuesta; ?> <div class="space-6"></div>
