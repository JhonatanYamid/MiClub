			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
							...
							<?php $datos_socio = $dbo->fetchAll("Socio","IDSocio = $row[IDSocio]"); ?>
                            ...
                            <div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										<input type="text" id="FechaTransaccion" name="FechaTransaccion" placeholder="FechaTransaccion" class="col-xs-12 mandatory" title="FechaTransaccion" value="<?php echo $frm[fecha_peticion]; ?>" >
                                        </div>
								</div>
                            ...
                            <div  class="form-group first ">
    	                         <div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										<input type="text" id="ValorTransaccion" name="ValorTransaccion" placeholder="ValorTransaccion" class="col-xs-12 mandatory" title="ValorTransaccion" value="<?php echo $frm[valor]; ?>" >
                                        </div>
								</div>
								...
								<div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" id="NumeroTransaccion" name="NumeroTransaccion" placeholder="NumeroTransaccion" class="col-xs-12 mandatory" title="NumeroTransaccion" value="<?php echo $frm[referencia]; ?>" >
										</div>
								</div>
							...
							<div  class="col-xs-12 col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" id="authorizationCode" name="authorizationCode" placeholder="authorizationCode" class="col-xs-12 mandatory" title="authorizationCode" value="<?php echo $frm[num_recibo]; ?>" >
									</div>
							</div>
							<div  class="col-xs-12 col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" id="errorMessage" name="errorMessage" placeholder="errorMessage" class="col-xs-12 mandatory" title="errorMessage" value="<?php echo $frm[estado_transaccion]; ?>" >
									</div>
							</div>
