...
<script type="text/javascript">
    ...
    jQuery(grid_selector).jqGrid({
        ...
        url: 'includes/async/administrarPropiedadesBicicleta.async.php<?= $url_search ?>',
        datatype: "json",
        ...
        width: 855,
        multiselect: true,
        editurl: "includes/async/administrarPropiedadesBicicleta.async.php",
