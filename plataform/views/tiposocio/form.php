                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data" novalidate>
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8"><input type="text" id="Descripcion" name="Descripcion" placeholder="<?= SIMUtil::get_traduccion('', '', 'Descripcion', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Descripcion', LANGSESSION); ?>" value="<?php echo $frm["Descripcion"]; ?>"></div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <?php if (SIMUser::get('club') == 8) : ?>
                                <!-- <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="Nombre"> <?= SIMUtil::get_traduccion('', '', 'Pagar', LANGSESSION); ?> </label>
                                    <div class="col-sm-8"><input type="text" id="Pagar" name="Pagar" placeholder="<?= SIMUtil::get_traduccion('', '', 'Pagar', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Pagar', LANGSESSION); ?>" value="<?php echo $frm["Pagar"]; ?>"></div>
                                </div> -->
                            <?php endif; ?>
                            <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-xs-12 text-center">
                                    ...
                                    <input type="hidden" name="IDTipoSocio" id="IDTipoSocio" value="<?php echo $frm["IDTipoSocio"]; ?>" />
