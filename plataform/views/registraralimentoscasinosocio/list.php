...
if ($_GET["IDTipoBusqueda"] == 1 && $Nombre <> "") {
	...
	echo "<h1>" .  SIMUtil::get_traduccion('', '', 'Nombredelempleadoes', LANGSESSION) . ":" . $Nombre . "</h1>" .
		"<h3>" . SIMUtil::get_traduccion('', '', 'Tienederechoadesayuno', LANGSESSION) . ":" . $Desayuno . "</h3>" .
		"<h3>" . SIMUtil::get_traduccion('', '', 'Tienederechoaalmuerzo', LANGSESSION) . ":" . $Almuerzo . "</h3>" .
		"<h3>" . "Tiene derecho a comida" . ":" . $Comida . "</h3>" .
		"<h3>" .  SIMUtil::get_traduccion('', '', 'Tienederechoacena', LANGSESSION) . ":" . $Cena . "</h3>";
?>
	<style>
		.principal {
			width: 1200px;
...
display: inline-block;
	...
	<section class="principal">
				...
				<div class="form-group first ">
					<div class="clearfix form-actions">
						<div class="col-xs-12 text-center">
							...
							<input type="hidden" name="Desayuno" id="Desayuno" value="<?php echo $Desayuno ?>" />
							<input type="hidden" name="FechaRegistro" id="FechaRegistro" value="<?php echo $FehaActual = date('Y-m-d');
																								?>" />
							<input type="hidden" name="IDClub" id="IDClub" value="<?php if (empty($frm["IDClub"])) echo SIMUser::get("club");
																					else echo $frm["IDClub"];  ?>" />
							<button class="btn btn-info btnEnviar" type="button" rel="frm<?php echo $script; ?>" <?php if ($Desayuno == "N") {
																														echo "disabled";
																													} ?>>
								<i class="ace-icon fa fa-check bigger-110"></i>
								<?= SIMUtil::get_traduccion('', '', 'RegistrarDesayuno', LANGSESSION); ?>
			...
			<form class="form-horizontal formvalida" role="form" method="post" id="frm1<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
				...
				<div class="form-group first ">
					<div class="clearfix form-actions">
						<div class="col-xs-12 text-center">
							<input type="hidden" name="ID" id="ID" value="<?php echo $frm[$key] ?>" />
							<input type="hidden" name="action" id="action" value="almuerzo" />
							<input type="hidden" name="Nombre" id="Nombre" value="<?php echo $Nombre ?>" />
							<input type="hidden" name="Cedula" id="Cedula" value="<?php echo $Cedula ?>" />
							<input type="hidden" name="Almuerzo" id="Almuerzo" value="<?php echo $Almuerzo ?>" />
							<input type="hidden" name="FechaRegistro" id="FechaRegistro" value="<?php echo $FehaActual = date('Y-m-d');
																								?>" />
							<input type="hidden" name="IDClub" id="IDClub" value="<?php if (empty($frm["IDClub"])) echo SIMUser::get("club");
																					else echo $frm["IDClub"];  ?>" />
							<button class="btn btn-info btnEnviar" type="button" rel="frm1<?php echo $script; ?>" <?php if ($Almuerzo == "N") {
																														echo "disabled";
																													} ?>>
								<i class="ace-icon fa fa-check bigger-110"></i>
								<?= SIMUtil::get_traduccion('', '', 'RegistrarAlmuerzo', LANGSESSION); ?>
								<!-- <?php echo $titulo_accion; ?> <?php echo SIMReg::get("title") ?> -->
							</button>
		...
		<section class="formulario3">
			<form class="form-horizontal formvalida" role="form" method="post" id="frm2<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
				...
				<div class="form-group first ">
					<div class="clearfix form-actions">
						<div class="col-xs-12 text-center">
							<input type="hidden" name="ID" id="ID" value="<?php echo $frm[$key] ?>" />
							<input type="hidden" name="action" id="action" value="cena" />
							<input type="hidden" name="Nombre" id="Nombre" value="<?php echo $Nombre ?>" />
							<input type="hidden" name="Cedula" id="Cedula" value="<?php echo $Cedula ?>" />
							...
							<button class="btn btn-info btnEnviar " type="button" rel="frm2<?php echo $script; ?>" <?php if ($Cena == "N") {
																														echo "disabled";
																													} ?>>
								<i class="ace-icon fa fa-check bigger-110"></i>
								<?= SIMUtil::get_traduccion('', '', 'RegistrarCena', LANGSESSION); ?>
								<!-- <?php echo $titulo_accion; ?> <?php echo SIMReg::get("title") ?> -->
							</button>
			...
			<form class="form-horizontal formvalida" role="form" method="post" id="frm2<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
				...
				<div class="form-group first ">
					<div class="clearfix form-actions">
						<div class="col-xs-12 text-center">
							<input type="hidden" name="ID" id="ID" value="<?php echo $frm[$key] ?>" />
							<input type="hidden" name="action" id="action" value="comida" />
							<input type="hidden" name="Nombre" id="Nombre" value="<?php echo $Nombre ?>" />
							<input type="hidden" name="Cedula" id="Cedula" value="<?php echo $Cedula ?>" />
							<input type="hidden" name="Comida" id="Comida" value="<?php echo $Comida ?>" />
							<input type="hidden" name="FechaRegistro" id="FechaRegistro" value="<?php echo $FehaActual = date('Y-m-d');
																								?>" />
							<input type="hidden" name="IDClub" id="IDClub" value="<?php if (empty($frm["IDClub"])) echo SIMUser::get("club");
																					else echo $frm["IDClub"];  ?>" />
							<button class="btn btn-info btnEnviar " type="button" rel="frm2<?php echo $script; ?>" <?php if ($Comida == "N") {
																														echo "disabled";
																													} ?>>
								<i class="ace-icon fa fa-check bigger-110"></i>
								Registrar Comida
...
if ($_GET["IDTipoBusqueda"] == 1 && $Nombre == "") {
	...
	echo "<script> alert('Empleado no existe')</script>";
}
?>
...
elseif ($_GET["IDTipoBusqueda"] == 2) : ?>
	...
	<?php
		...
		?>
		<span style='color: #F00; font-size:16px'>
			<?= SIMUtil::get_traduccion('', '', 'Elcampodebusquedanodebeestarvacio', LANGSESSION); ?>.
		</span>
	<?php
