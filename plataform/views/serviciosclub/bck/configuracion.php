<form class="form-horizontal formvalida" role="form" method="post" name="frmservicio" id="frmservicio" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Reservas con permisos</label>
        ...
        <div class="col-xs-12 col-sm-6">
         ...
         <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite hacer reservas </label>
    ...
    </div> <?php if (SIMUser::get("IDPerfil") == 1 || SIMUser::get("IDPerfil") == 0) : ?> <div class="form-group first">
            <div class="col-xs-12 col-sm-6">
