                              ...
                              <tr>
                                  <td valign="top"> <?php
                                    ...
                                    if( $_GET[IDServicioTipoReserva] )
                                    {
                                            ...
                                            ?> <input type="hidden" name="IDServicioTipoReserva" id="IDServicioTipoReserva" value="<?php echo $EditServicioTipoReserva[IDServicioTipoReserva]?>" /> <?php
                                    }
                                    ?> <table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform"> <?php
                                            $qry_padre = $dbo->all( "ServicioTipoReserva", " IDServicio = '".$frm[ $key ]."' and IDPadre = 0" );
                                            while ( $r_pade = $dbo->object( $qry_padre ) ): ?> <option value="<?php echo $r_pade->IDServicioTipoReserva?>" <?php if($r_pade->IDServicioTipoReserva==$EditServicioTipoReserva[IDPadre]) echo "selected"; ?>> <?php echo $r_pade->Nombre?></option> <?php
                                            endwhile;
                                          ?> <tr>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <select name="NumeroTurnos" id="NumeroTurnos" class="form-control" required>
                                                      <option value=""></option> <?php for($i=1;$i<=60;$i++): ?> <option value="<?php echo $i; ?>" <?php if($i==$EditServicioTipoReserva["NumeroTurnos"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                                                  </select>
                                              </td>
                                          </tr>
                                          <tr>
                                              ...
                                              <td><select name="MinimoParticipantes" id="MinimoParticipantes" class="form-control" required>
                                                      <option value=""></option> <?php for($i=0;$i<=5;$i++): ?> <option value="<?php echo $i; ?>" <?php if($i==$EditServicioTipoReserva["MinimoParticipantes"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                                                  </select></td>
                                          </tr>
                                          <tr>
                                              <td>Cantidad máxima de invitados</td>
                                              <td><select name="MaximoParticipantes" id="MaximoParticipantes" class="form-control" required>
                                                      <option value=""></option> <?php for($i=0;$i<=5;$i++): ?> <option value="<?php echo $i; ?>" <?php if($i==$EditServicioTipoReserva["MaximoParticipantes"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                                                  </select></td>
                                          </tr> <?php if ($permite_auxiliares=="S"){ ?> <tr>
                                              ...
                                              <td><select name="MaximoBoleador" id="MaximoBoleador" class="form-control" required>
                                                      <option value=""></option> <?php for($i=0;$i<=5;$i++): ?> <option value="<?php echo $i; ?>" <?php if($i==$EditServicioTipoReserva["MaximoBoleador"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                                                  </select></td>
                                          </tr>
                                          <tr>
                                              ...
                                              <td><select name="MinimoBoleador" id="MinimoBoleador" class="form-control" required>
                                                      <option value=""></option> <?php for($i=0;$i<=5;$i++): ?> <option value="<?php echo $i; ?>" <?php if($i==$EditServicioTipoReserva["MinimoBoleador"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                                                  </select></td>
                                          </tr> <?php } ?> <tr>
                                          ...
                                          <tr>
                                              <td width="26%">Valor $(opcional) </td>
                                              <td width="74%"><input id="Valor" type="number" size="25" title="Valor" name="Valor" class="input" value="<?php echo $EditServicioTipoReserva["Valor"] ?>" /></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                              <td>Solo para el Admin</td>
                                              <td>
                                                  <? echo SIMHTML::formradiogroup( SIMResources::$sinoNum , $EditServicioTipoReserva["SoloAdmin"] , 'SoloAdmin' , "class='input'" ) ?>
                                              </td>
                                          </tr>
                                          <tr>
                                              <td>Icono (opcional)</td>
                                              <td>
                                                  <?

                                                    if (!empty($EditServicioTipoReserva[Icono])) {
                                                        echo "<img src='" . SERVICIO_ROOT . "$EditServicioTipoReserva[Icono]' width=55 >";
                                                    ?>
                                                      <a href="<? echo $script . ".php?mod=" . SIMReg::get("mod")
                                                                    . "&action=delfototiporeserva&icono=$EditServicioTipoReserva[Icono]&campo=Icono&ids="
                                                                    . $EditServicioTipoReserva[$key] . "&IDServicioTipoReserva=" . $EditServicioTipoReserva[IDServicioTipoReserva]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>

                                                  <?
                                                    } // END if
                                                    ?>
                                                  <input name="Icono" id=file class="col-xs-12" title="Icono" type="file" size="25" style="font-size: 10px">
