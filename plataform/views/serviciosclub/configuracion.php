<form class="form-horizontal formvalida" role="form" method="post" name="frmservicio" id="frmservicio" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> El Servicio es para un sorteo</label>
            <div class="col-sm-8">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php
                    ...
                    <option value="">[Seleccione la categoria del servicio]</option> <?php
                                                                                        while ($Datos = $dbo->fetchArray($QRYCategorias)) { ?> <option value="<?php echo $Datos["IDCategoriasServicios"];  ?>"><?php echo $Datos["Nombre"];  ?></option> <?php } ?>
                </select>
                <br>
                <a id="agregar_categoriaservicio" href="#">Agregar</a> | <a id="borrar_categoriaservicio" href="#">Borrar</a>
                <br>
                <select name="CategoriasServicio[]" id="CategoriasServicioGrupo" class="col-xs-8" multiple> <?php
                                                                                                            ...
                                                                                                            ?> <option value="<?php echo $InfoCategoria[IDCategoriasServicios] ?>"><?php echo $InfoCategoria[Nombre]; ?></option> <?php
                                                                                                                                                                                                                                endwhile; ?> </select>
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id=MinutosReserva type=text size=25 name=MinutosReserva class="input mandatory " title="Minutos Reserva" value="<?= $frm["MinutosReserva"] ?>"> minutos
            </div>
        </div>
    </div>
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <span class="col-sm-8"><?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["Georeferenciacion"], "Georeferenciacion", "title=\"Georeferenciacion\"") ?> <span class="columnafija">
                        <div id="div_geo" <?php if ($frm["Georeferenciacion"] == "N" || empty($frm["Georeferenciacion"])) echo "style='display:none'";  ?>> Latitud <input id=Latitud type=text size=25 name="Latitud" class="input" title="Latitud" value="<?= $frm["Latitud"] ?>"> Longitud <input id=Longitud type=text size=25 name="Longitud" class="input" title="Longitud" value="<?= $frm["Longitud"]; ?>"> Rango <input id=Rango type=text size=25 name=Rango class="input" title="Rango" value="<?= $frm["Rango"] ?>">(mts) Mensaje Fuera Rango <input id="MensajeFueraRango" type=text size="25" name="MensajeFueraRango" class="input" title="Mensaje Fuera Rango" value="<?= $frm[MensajeFueraRango] ?>">
                        </div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Ocultar Boton Editar Invitados </label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["OcultarBotonEditarInvitados"], 'OcultarBotonEditarInvitados', "class='input'") ?>
            </div>
        </div>
    </div>
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id=MaximoInvitadosSalon type=text size=25 name=MaximoInvitadosSalon class="input mandatory " title="Maximo Invitados Salon" value="<?= $frm["MaximoInvitadosSalon"] ?>"> invitados
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <select name="TurnoMantenimiento" id="TurnoMantenimiento" class="form-control" required>
                    <option value=""></option> <?php for ($i = 0; $i <= 3; $i++) : ?> <option value="<?php echo $i; ?>" <?php if ($i == $frm["TurnoMantenimiento"]) echo "selected"; ?>><?php echo $i; ?></option> <?php endfor; ?>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Validar cantidad de reservas activas en general (semana y fin de semana)</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["ValidarReservasActivasGeneral"], 'ValidarReservasActivasGeneral', "class='input'") ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Numero de reservas activas por socio en general (semana y fin de semana)</label>
            <div class="col-sm-8">
                <input id="NumeroReservasActivasGeneral" type="Number" size="10" name="NumeroReservasActivasGeneral" class="input" title="NumeroReservasActivasGeneral" value="<?= $frm["NumeroReservasActivasGeneral"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formPopUp("ServicioInicial", "Nombre", "Nombre", "IDServicioInicial", $frm["IDServicioInicial"], "[Seleccione el Servicio Inicial]", "popup form-control", "title = \"Servicio Inicial\"") ?> </div>
        </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Configuracion cuando se activa tipo de reserva
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Permite Turno Vista Con Botones </label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteTurnoVistaBotones"], 'PermiteTurnoVistaBotones', "class='input'") ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Como mostrar la vista cuando se pide Tipo Turno? </label>
            <div class="col-sm-8">
                <select name="TipoVistaTurno" id="TipoVistaTurno" class="form-control" required>
                    <option value=""></option>
                    <option value="Normal" <?php if ("Normal" == $frm["TipoVistaTurno"]) echo "selected"; ?>>Normal (vista en lista con solo texto)</option>
                    <option value="Grilla" <?php if ("Grilla" == $frm["TipoVistaTurno"]) echo "selected"; ?>>Grilla (vista en grilla con tarjetas mostrando texto e icono)</option>
                    <option value="Boton" <?php if ("Boton" == $frm["TipoVistaTurno"]) echo "selected"; ?>>Boton vista en lista pero con estilo de botones con texto</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Confirmar Reserva
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteReconfirmar"], 'PermiteReconfirmar', "class='input'")  ?> </div>
        </div>
    </div>
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Eliminacion reserva
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["EliminarParaTodosOParaMi"], 'EliminarParaTodosOParaMi', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input id=BloquearMinutosGrupo type=text size=25 name=BloquearMinutosGrupo class="input " title="Bloquear minutos Grupo" value="<?= $frm["BloquearMinutosGrupo"] ?>"> minutos
            </div>
        </div>
    </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Permisos Reserva
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Activar permisos de reserva </label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["permisoReserva"], 'permisoReserva', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["ValidarTiempoTipoSocio"], 'ValidarTiempoTipoSocio', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Validar antes? (si es N se validara despues) </label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["ValidarAntes"], 'ValidarAntes', "class='input'")  ?> </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php
                ...
                <br>
                <select name="TipoSocioValida[]" id="TipoSocioValidarGrupo" class="col-xs-8" multiple> <?php
                                                                                                        $item = 1;
                                                                                                        ...
                                                                                                        ?> <option value="<?php echo "tipos-" . $TipoSocio; ?>"><?php echo $TipoSocio; ?></option> <?php
                                                                                                                                                                                                endforeach; ?> </select>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["BloquearReservasHorario"], 'BloquearReservasHorario', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Lista de Espera
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Colores
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Color de la hora preselecionada: </label>
            <div class="col-sm-8">
                <input name="ColorHoraPreseleccionada" type="color" value="<?php if (empty($frm["ColorHoraPreseleccionada"])) {
                                                                                echo "#FFFFFF";
                                                                            } else {
                                                                                echo $frm["ColorHoraPreseleccionada
                                                                "];
                                                                            }    ?>" />
            </div>
        </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Pagos
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermitePrecioElementos"], 'PermitePrecioElementos', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["PermiteSistemaAbono"], 'PermiteSistemaAbono', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite pagar la reserva despues</label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["PermitePagarMasTarde"], 'PermitePagarMasTarde', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto boton para pagar despues</label>
            <div class="col-sm-8">
                <input id=LabelPagarMasTarde type=text size=50 name=LabelPagarMasTarde class="input" title="Mensaje Pago Reserva" value="<?= $frm["LabelPagarMasTarde"] ?>">
            </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite pagar con bonos</label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["PermiteBonos"], 'PermiteBonos', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto boton para pagar con bonos</label>
            <div class="col-sm-8">
                <input id=LabelBotonBonos type=text size=50 name=LabelBotonBonos class="input" title="LabelBotonBonos" value="<?= $frm["LabelBotonBonos"] ?>">
            </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mensaje introductorio pagos con bonos</label>
            <div class="col-sm-8">
                <textarea rows="2" cols="50" id="LabelMensajeBonos" title="Mensaje push reserva" name="LabelMensajeBonos" class="input"><?php echo $frm["LabelMensajeBonos"] ?></textarea>
            </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite tickets de descuentos</label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["PermiteTicketsDescuento"], 'PermiteTicketsDescuento', "class='input'")  ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto boton tickets de descuento</label>
            <div class="col-sm-8">
                <input id=LabelTicketsDescuento type=text size=50 name=LabelTicketsDescuento class="input" title="LabelTicketsDescuento" value="<?= $frm["LabelTicketsDescuento"] ?>">
            </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mensaje introductorio tickets de descuentos</label>
            <div class="col-sm-8">
                <textarea rows="2" cols="50" id="TextoIntroTicketsDescuento" title="Mensaje push reserva" name="TextoIntroTicketsDescuento" class="input"><?php echo $frm["TextoIntroTicketsDescuento"] ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Notificacion mail y push
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Enviar push recordando que tiene la reserva 1 hora antes ?</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["NotificarReserva1hora"], 'NotificarReserva1hora', "class='input'") ?>
            </div>
        </div>
    </div>
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["NotificarSocioRecordacionReserva"], 'NotificarSocioRecordacionReserva', "class='input'") ?> Dias: <input id=DiasNotificacion type=Number size=3 name=DiasNotificacion class="input" title="Dias antes" value="<?= $frm["DiasNotificacion"] ?>">
            </div>
        </div>
    </div>
    <div class="form-group first">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <!--<textarea rows="2" cols="50" id="TextoCorreoSocio" title="Texto Correo Socio" name="TextoCorreoSocio" class="input"><?php echo $frm["TextoCorreoSocio"] ?></textarea>--> <?php
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteInterfazAuxiliaresInvitadosBotones"], 'PermiteInterfazAuxiliaresInvitadosBotones', "class='input'") ?>
            </div>
        </div>
    </div>
    <div class="form-group first">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Buscador
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permitir hora preseleccionada al seleccionar una fecha ?</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteFechaHoraPreseleccion"], 'PermiteFechaHoraPreseleccion', "class='input'") ?>
            </div>
        </div>
    </div>
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Encuesta Servicio
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
                ...
                <div class="col-sm-8">
                    <select name="IDEncuesta" id="IDEncuesta">
                        <option value=""></option> <?php
                                                    ...
                                                    while ($r_encuesta = $dbo->fetchArray($qry_encuesta)) : ?> <option value="<?php echo $r_encuesta["IDEncuesta"]; ?>" <?php if ($r_encuesta["IDEncuesta"] == $frm["IDEncuesta"]) echo "selected";  ?>><?php echo $r_encuesta["Nombre"]; ?></option> <?php
                                                                                                                                                                                                                                                                                                    endwhile;    ?>
                    </select>
                </div>
            </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Configuración invitados externos
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["CamposDinamicosInvitadoExternoHabilitado"], 'CamposDinamicosInvitadoExternoHabilitado', "class='input'") ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label documento invitado externo (digite cedula, digite dni, etc) ?</label>
            <div class="col-sm-8">
                <input id=LabelDocumentoInvitadoExterno type=text size=25 name=LabelDocumentoInvitadoExterno class="input" title="Label Documento Invitado Externo" value="<?= $frm["LabelDocumentoInvitadoExterno"] ?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite Invitado Externo Buscador </label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteInvitadoExternoBuscador"], 'PermiteInvitadoExternoBuscador', "class='input'") ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Texto Invitado Externo Buscador</label>
            <div class="col-sm-8">
                <input id=NumeroReservasPermitidaAccion type=text name=InvitadoExternoBuscadorHeaderLabel class="input" title="InvitadoExternoBuscadorHeaderLabel" value="<?= $frm["InvitadoExternoBuscadorHeaderLabel"] ?>">
            </div>
        </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Otros
        </h3>
    </div>
    ...
    <div class="form-group first">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Numero de reservas maximos permitidas por un mismo socio en un mismo dia (si en la disponibilidad esta permitido reservar despues de cumplir el turno se puede limitar a cuantas maxima en el dia ):</label>
            <div class="col-sm-8">
                <input id=NumeroReservasPermitidaSocioDia type=text size=25 name=NumeroReservasPermitidaSocioDia class="input" title="Numero Reservas Permitida Socio dia" value="<?= $frm["NumeroReservasPermitidaSocioDia"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar imagen descriptiva (plano) ?</label>
            <div class="col-sm-8">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input id=EdadMinima type=number size=5 name=EdadMinima class="input" title="Edad Minima" value="<?= $frm["EdadMinima"] ?>"> y <input id=EdadMaxima type=number size=5 name=EdadMaxima class="input" title="Edad Maxima" value="<?= $frm["EdadMaxima"] ?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input id=HoraInicio type="time" size=5 name=HoraInicio class="input" title="" value="<?= $frm["HoraInicio"] ?>"> y <input id=HoraFin type=time size=5 name=HoraFin class="input" title="" value="<?= $frm["HoraFin"] ?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Se pueden agregar observaciones personalizadas al confirmar la reserva?</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermiteObservacionesPersonalizadas"], 'PermiteObservacionesPersonalizadas', "class='input'") ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Minimo de horas en reservas por calendario?</label>
            <div class="col-sm-8">
                <input id=MinimoHorasSeguidas type=number size=25 name=MinimoHorasSeguidas class="input" title="MinimoHorasSeguidas" value="<?= $frm["MinimoHorasSeguidas"] ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Ocultar la hora de la reserva en "mis reservas" y resumen reserva?</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["OcultarHora"], 'OcultarHora', "class='input'") ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Pedir hora final? (al empezar la reserva e solicitará hora incio y fin)</label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["RequiereHoraFinal"], 'RequiereHoraFinal', "class='input'") ?>
            </div>
        </div>
    </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Adicionales en servicio por socio o invitado (pedir caddies, carritos)
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Caddies
        </h3>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="MostrarReserva" class="" value="NombreSocio" <?php if ($frm["MostrarReserva"] == "NombreSocio") echo "checked" ?>> Nombre de Socio <input type="radio" name="MostrarReserva" class="" value="Pesonalizado" <?php if ($frm["MostrarReserva"] == "Pesonalizado") echo "checked" ?>>Pesonalizado <input type="LabelPersonalizado" name="LabelPersonalizado" class="form-control" placeholder="Titulo a mostrar" value="<?php echo $frm["LabelPersonalizado"]; ?>">
            </div>
        </div>
    </div>
    <div class="form-group first ">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Reservas asociadas
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-12">
                ...
                <tbody id="listacontactosanunciante">
                    <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                        <td width="1000px"> <?php
                                            ...
                                            endforeach;
                                            ?> <select style="max-width:100% !important" multiple class="chosen-select" name="ServicioAsociado[]" id="ServicioAsociado" data-placeholder="Seleccione..."> <?php
