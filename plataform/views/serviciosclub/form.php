...
if (empty($permite_auxiliares) || $permite_auxiliares == "N") {
                            ...
                            <div id="accordion" class="accordion-style1 panel-group">
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <?php 
                                        $PermitePrecioElementos = $dbo->getFields("Servicio", "PermitePrecioElementos", "IDServicio = '" . $_GET["ids"] . "'");
                                        if ($PermitePrecioElementos == 1): ?>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#valoreselementos">
                                                        <i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                        &nbsp;Precios por Elementos
                                                    </a>
                                                </h4>
                                            </div>

                                            <div class="panel-collapse collapse <?php if ($_GET["tab"] == "valorelemento") echo "in"; ?>" id="valoreselementos">
                                                <div class="panel-body">
                                                    <?php include("valorreservaelemento.php"); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                ...
                                if ($permiteReserva == 'S') {
                                if($permite=='S'):
                                $nombre_accion="Con Permisos de Reservar";
                                else:
                                $nombre_accion="Sin Permisos de Reservar";
                                endif;
                                ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                              ...
                              /*
                                //NO PERMITE RESERVAR
                                 ...
                                 $permiteReserva = $dbo->getFields("Servicio", "permisoReserva", "IDServicio = '" . $_GET["ids"] . "'");
                                if ($permiteReserva == 'S') {
                                ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#sinpermisos">
                                                    <i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                    &nbsp; Sin Permisos de Reservar
                                                </a>
                                            </h4>
                                        </div>
                                        <div class="panel-collapse collapse <?php if ($_GET["tab"] == "sinpermisos") echo "in"; ?>" id="sinpermisos">
                                            <div class="panel-body">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#nopermiteIndividual">
                                                                <i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                                &nbsp;Carga Individual
                                                            </a>
                                                        </h4>
                                                    </div>
                                                    <div class="panel-collapse collapse <?php if ($_GET["tab1"] == "nopermiteIndividual") echo "in"; ?>" id="nopermiteIndividual">
                                                        <div class="panel-body">
                                                            <?php include("cargaIndividual_noreservar.php"); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#nopermiteReserva">
                                                                <i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                                &nbsp;Carga Lote
                                                            </a>
                                                        </h4>
                                                    </div>
                                                    <div class="panel-collapse collapse <?php if ($_GET["tab"] == "nopermiteReservar") echo "in"; ?>" id="nopermiteReserva">
                                                        <div class="panel-body">
                                                            <?php include("permiteReservar_noreservar.php"); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#lista2">
                                                                <i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                                &nbsp;Lista
                                                            </a>
                                                        </h4>
                                                    </div>
                                                    <div class="panel-collapse collapse <?php if ($_GET["tab1"] == "lista2") echo "in"; ?>" id="lista2">
                                                        <div class="panel-body">
                                                            <?php
                                                            include("listaPermite_noreservar.php");
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                */
                                ...
                                <?php
                                $permite_sistema_abono = $dbo->getFields("Servicio", "PermiteObservacionesPersonalizadas", "IDServicio = '" . $_GET["ids"] . "'");
                                if ($permite_sistema_abono == "1") {
                                ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle collapsed " data-toggle="collapse" data-parent="#accordion" href="#collapseobservaciones">
                                                    <i class="ace-icon fa fa-angle-down bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                        ...
                                        <div class="panel-collapse collapse <?php if ($_GET["tab"] == "ObservacionesParaReservas") echo "in"; ?>" id="collapseobservaciones">
                                            <div class="panel-body">
                                                <?php include("observacionespersonalizadas.php"); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php
                                // PASARELAS DE PAGOS PERSONALIZADAS, SOLO PARA SUPER ADMIN
                                $CamposDinamicosInvitadoExternoHabilitado = $dbo->getFields("Servicio", "CamposDinamicosInvitadoExternoHabilitado", "IDServicio = '" . $_GET["ids"] . "'");
                                if ($CamposDinamicosInvitadoExternoHabilitado == 'S'):?>                                    
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle collapsed " data-toggle="collapse" data-parent="#accordion" href="#preguntasinvitados">
                                                        <i class="ace-icon fa fa-angle-down bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                        &nbsp;Campos dinamicos invitados externos 
                                                    </a>
                                                </h4>
                                            </div>

                                            <div class="panel-collapse collapse <?php if ($_GET["tab"] == "preguntasinvitados") echo "in"; ?>" id="preguntasinvitados">
                                                <div class="panel-body">
                                                    <?php include("preguntasinvitadosexternos.php"); ?>
                                                </div>
                                            </div>
                                        </div>                                    
                                <?php endif;?>
                                ...
                                <?php
                                // PASARELAS DE PAGOS PERSONALIZADAS, SOLO PARA SUPER ADMIN
                                $PermitePasarelaPersonalizada = $dbo->getFields("Servicio", "PermitePasarelaPersonalizada", "IDServicio = '" . $_GET["ids"] . "'");
                                if ((SIMUser::get("IDPerfil") == 0 || SIMUser::get("IDPerfil") == 1) && $PermitePasarelaPersonalizada == 1):
                                    $CredibancoNuevaVersion = $dbo->getFields("ServicioTipoPago","IDServicioTipoPago","IDServicio = $_GET[ids] AND IDTipoPago = 12");
                                    if($CredibancoNuevaVersion > 0):?>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle collapsed " data-toggle="collapse" data-parent="#accordion" href="#credibandonuevaversion">
                                                        <i class="ace-icon fa fa-angle-down bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                        &nbsp;Configuracion Pago Credibanco Nueva Version 
                                                    </a>
                                                </h4>
                                            </div>

                                            <div class="panel-collapse collapse <?php if ($_GET["tab"] == "credibandonuevaversion") echo "in"; ?>" id="credibandonuevaversion">
                                                <div class="panel-body">
                                                    <?php include("pagocredibanconuevaversion.php"); ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif;?>
                                ...
                                <?php
                                if ($IDClub == 8 || $IDClub == 196) {
                                ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle collapsed " data-toggle="collapse" data-parent="#accordion" href="#collapseconfiguracionrepetirreserva">
                                                    <i class="ace-icon fa fa-angle-down bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>
                                                    &nbsp;Configuracion repetir reserva(Unicamente para el modulo de reservas por calendario)
                                                </a>
                                            </h4>
                                        </div>

                                        <div class="panel-collapse collapse <?php if ($_GET["tab"] == "configuracionrepetirreserva") echo "in"; ?>" id="collapseconfiguracionrepetirreserva">
                                            <div class="panel-body">
                                                <?php include("configuracionrepetirreserva.php"); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>   
