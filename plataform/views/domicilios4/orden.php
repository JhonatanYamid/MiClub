...
$sql_usuario_restaurante = $dbo->query("select * from UsuarioRestaurante4 where IDUsuario = '" . SIMUser::get("IDUsuario") . "'");
...
<form class="form-horizontal formvalida" role="form" method="post" id="frmOrden" name="frmOrden" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input type="hidden" name="IDSocio" value="" id="IDSocio" title="<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" class="form-control mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Restaurante', LANGSESSION); ?>">
                    ...
                    <?php
                    $sql_grupos = "Select * From RestauranteDomicilio4 Where IDClub = '" . SIMUser::get("club") . "' $condicionRestaurante";
    ...
    <?php
    $sql = "SELECT IDCategoriaProducto, Nombre FROM CategoriaProducto4 WHERE IDClub = '" . SIMUser::get("club") . "' $condicionRestaurante ORDER BY Orden ASC";
    $query = $dbo->query($sql);
    ...
    ?>
        ...
        <div class="form-group first ">
            ...
            $sqlProductos = "SELECT P.IDProducto, P.Nombre FROM Producto4 P, CategoriaProducto4 CP, ProductoCategoria4 PC WHERE CP.IDCategoriaProducto = " . $row['IDCategoriaProducto'] . " AND PC.IDCategoriaProducto = CP.IDCategoriaProducto AND PC.IDProducto = P.IDProducto";
