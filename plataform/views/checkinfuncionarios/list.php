 ...
 <script type="text/javascript">
     jQuery(function($) {
         ...
         jQuery(grid_selector).jqGrid({
             ...
             datatype: "json",
             colNames: ['<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'NumeroDocumento ', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Area ', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Cargo ', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Detalle ', LANGSESSION); ?>'],
             colModel: [{
                     name: 'Nombre',
                     index: 'Nombre',
                     align: "left"
             ...
             rowattr: function(rowId, val, rawObject, cm, rdata) {
                 return {
                     "data-user": val.TipoUsuario
                 };
             },
             onSelectRow: function(id) {
                 var User = $("#" + id).attr('data-user')
                 location.href = "<?php echo $script ?>.php?action=detalle&id=" + id + '&type=' + User;
                 return false;
             },
         });
