...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoCrearDisponibilidad', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoHaciaClub', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoCalificacion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Latitud', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Longitud', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'LabelCrearDisponibilidad',
                    index: 'LabelCrearDisponibilidad',
                    align: "left"
                },
                {
                    name: 'LabelHaciaClub',
                    index: 'LabelHaciaClub',
                    align: "left"
                },
                {
                    name: 'TextoCalificacion',
                    index: 'TextoCalificacion',
                    align: "left"
                },
                {
                    name: 'Latitud',
