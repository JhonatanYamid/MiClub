				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal formvalida" role="form" method="post" id="frm" name="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						<div class="form-group first ">
							...
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Desde', LANGSESSION); ?> </label>
								<div class="col-sm-8">
									<input type="text" id="Desde" name="Desde" placeholder="<?= SIMUtil::get_traduccion('', '', 'Desde', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Desde', LANGSESSION); ?>" value="<?php echo $frm["Desde"]; ?>">años
								</div>
							</div>

							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Hasta', LANGSESSION); ?> </label>
								<div class="col-sm-8">
									<input type="text" id="Hasta" name="Hasta" placeholder="<?= SIMUtil::get_traduccion('', '', 'Hasta', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Hasta', LANGSESSION); ?>" value="<?php echo $frm["Hasta"]; ?>">años
								</div>
							</div>
