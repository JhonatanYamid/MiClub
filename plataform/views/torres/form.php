            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Correo Notificación reserva </label>
                                <div class="col-sm-8">
                                    <input type="text" id="CorreoNotificacionTorre" name="CorreoNotificacionTorre" placeholder="Correo Notificacion " class="col-xs-12" title="CorreoNotificacionTorre" value="<?php echo $frm["CorreoNotificacionTorre"]; ?>">
                                </div>
                            </div>                            
                        </div>
