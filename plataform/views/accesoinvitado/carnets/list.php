	...
	if($total_resultados>=1): 
		...
		<div class="widget-box transparent" id="recent-box">
			<div class="widget-header">
				...
				<b>Fecha Inicio Aut:</b> <?php echo strtotime($datos_invitacion["FechaInicio"]); ?>
															...
															<td colspan="2">
																...
																<label>
																	...
																	<span class="lbl">
																		...
																		<a class="fancybox_vehiculo" href="accesoinvitado.php<?echo $paramsCarnet?>" data-fancybox-type="iframe">
																			<i class="ace-icon fa fa-print bigger-120"></i>
																			<span class="bigger-110">Imprimir Carnet</span>
																		</a>
																	</span>
