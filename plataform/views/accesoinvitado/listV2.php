                        ...
                        <div id="jqGrid_container">
                            <table id="simple-table" class="table table-striped table-bordered table-hover" style="width:30%">
                                <tr>
                                    ...
                                    <!-- Listar invitados del Socio para el Club villa -->
                                    <?php //if (SIMUser::get('club') == 220) { 
                                    ?>
                                    <?php if (SIMUser::get('club') == 8) {

                                        if (isset($result_SocioInvitados)) :
                                            $contadorInvitadoSocio = 0;
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" style="width:30%">
                                                        <tr>
                                                            <td valign="top" width="100">
                                                                ...
                                                                $identificador = $datos_invitados_socio["IDSocio"]
                                                                ?>
                                                                <a class="fancybox" href="../admin/tomarfoto/webcamjquery/foto.php?action=foto&IDRegistro=<?php echo $identificador; ?>&Modulo=<?php echo $modulo; ?>" data-fancybox-type="iframe">
                                                                    <i class="ace-icon fa fa-camera bigger-120"></i>
                                                                    <span class="bigger-110">Tomar Foto</span>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                if ($datos_invitados_socio['IDInvitado']) {
                                                                    if ($datos_invitados_socio["IDEstadoInvitado"] == "2" || $datos_invitados_socio["IDEstadoInvitado"] == "3") {
                                                                        $bloqueado = "S";
                                                                ...
                                                                if ($bloqueado <> 'S' && empty($alerta_edad_beneficiario)) { ?>
                                                                    <label>
                                                                        <input name="Ingreso" id="Ingreso_<?php echo $contadorInvitadoSocio ?>" class="ace input-lg ace-checkbox-2 ingreso_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $id_registro; ?>" <?php echo $campo_entrada; ?> />
                                                                        <span class="lbl"><b>INGRESO</b></span>
                                                                    </label>
                                                                    <label>
                                                                        <input name="Salida" id="Salida_<?php echo $contadorInvitadoSocio ?>" class="ace input-lg ace-checkbox-2 salida_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $id_registro; ?>" <?php echo $campo_salida; ?> />
                                                                        <span class="lbl"><b>SALIDA</b></span>
                                                                    </label>
                                                                <?php
                                                                } else { ?>
