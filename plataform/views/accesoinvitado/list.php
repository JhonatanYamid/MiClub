						...
						<div id="jqGrid_container">
							<table id="simple-table" class="table table-striped table-bordered table-hover" style="width:15% !important">
								<tr>
											...
											<tr>
												<td valign="top" width="100">
													...
													<?php if ($VentanaObjetos == 'S') { ?>
														...
														// Comentado para que salga el boton de agregar objetos
														// if ($row_log_acceso_ultimo['Tipo'] == 'Usuario') {
														...
														$IDUsuario = $datos_invitado['IDUsuario'];
														?>
														...
														<a class="fancybox_vehiculo" href="accesoobjetos.php?IDUsuario=<?php echo $datos_invitado['IDUsuario'] ?>&TipoInvitado=<?php echo trim($datos_invitacion["TipoInvitacion"]) ?>&IDSocio=<?php echo $datos_socio['IDSocio'] ?>&IDInvitado=<?php echo $datos_invitado['IDInvitado'] ?>" data-fancybox-type="iframe" style="<?php echo $agregar ?>">
												...
												<td valign="top">
													<table class="table table-striped table-bordered table-hover">
														...
														<?php
														if ($modulo == 'Socio' && (SIMUser::get('club') == 220 || SIMUser::get('club') == 8)) {

															if ($datos_socio['TieneVacuna'] == 'S') {
														?>
																<tr>

																	<td>
																		Fecha vacuna: <b><br><?= $datos_socio['FechaVacuna'] ?></b>
																	</td>
																</tr>
															<?php
															} else { ?>
																<tr>
																	...
																	<td>
																		...
																		<input type="date" name="FechaVacuna" id="FechaVacuna" class="ace input-lg tipoentrada calendary">
																	</td>
																</tr>
														<?php }
														}
														...
														<!--
															...
															-->
														<?php
														if (SIMUser::get("club") != 44 && SIMUser::get('club') != 220 && SIMUser::get('club') != 8) {
														?>
															<tr>
																<td>
									...
									?>
												<td valign="top">
													<table class="table table-striped table-bordered table-hover" style="width:15% !important">
														<tr>
															<td valign="top" width="100">
																<?
																if ($modulo == "Socio") :
													...
													-->
														...
														<tr>
															<td colspan="2">
																...
																<?php if (SIMUser::get("club") == 8 || SIMUser::get("club") == 16) { ?>
																	<label>
																		<input name="MecanismoEntradaIngreso_<?php echo $contadorFamiliar ?>" id="Occidental_<?php echo $contadorFamiliar ?>" type="radio" class="ace input-lg tipoentrada" value="Occidental" />
																		<span class="lbl">Occidental</span>
																	</label>
																<?php } ?>
																<?php if (SIMUser::get("club") == 8 || SIMUser::get("club") == 52) { ?>
									...
									<!-- Listar invitados Especiales -->
									<?php if (SIMUser::get('club') == 8 || SIMUser::get('club') == 220 || SIMUser::get('club') == 15) {

										if (isset($result_SocioInvitados)) :
											$contadorInvitadoSocio = $contadorFamiliar + 1;
											$modulo = "SocioInvitadoEspecial";
											while ($datos_invitados_socio = $dbo->fetchArray($result_SocioInvitados)) :
									...
									?>
												<td valign="top">
													<table class="table table-striped table-bordered table-hover" style="width:15% !important">
														<tr>
															<td valign="top" width="100">
																...
																$identificador = $datos_invitados_socio["IDSocioInvitadoEspecial"]
																?>
																<a class="fancybox" href="../admin/tomarfoto/webcamjquery/foto.php?action=foto&IDRegistro=<?php echo $identificador; ?>&Modulo=<?php echo $modulo; ?>" data-fancybox-type="iframe">
																	<i class="ace-icon fa fa-camera bigger-120"></i>
																	<span class="bigger-110">Tomar Foto</span>
															...
															<td valign="top">
																<table class="table table-striped table-bordered table-hover">
																	...
																	<tr>
																		<td>&nbsp;
																			<?php echo $datos_invitados_socio["Nombre"] . " " . $datos_invitados_socio["Apellido"]  ?>
																		</td>
																	</tr>

																	<?php if ($datos_invitados_socio['FechaNacimiento'] != '') { ?>
																		<tr>
																			<td style="color: #f00000;">&nbsp;
																				<strong>
																					Edad: <?= SIMUtil::Calcular_Edad($fecha_nacimiento) ?>
																		...
																		<tr>
																			<td>&nbsp;
																				Fecha Nacimiento: <?php echo $datos_invitados_socio['FechaNacimiento'] ?>
																			</td>
																		</tr>
																	<?php } ?>
																	<tr>
																		<td>&nbsp;
																			Numero Documento: <?php echo $datos_invitados_socio['NumeroDocumento'] ?>
																		</td>
																	</tr>
																</table>
															</td>
														...
														<tr>
															<td colspan="2">
																&nbsp;
																<label>
																	<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocio ?>" id="Peatonal_<?php echo $contadorInvitadoSocio ?>" type="radio" class="ace input-lg Peatonal" value="Peatonal" <?php echo (((SIMUser::get("club") == 44  || SIMUser::get("club") == 10) && $mecanismo == "Peatonal" && $SalidaLog = "S") ? " checked" : "") ?> />
																	<span class="lbl">Peatonal</span>
																</label>
																<?php if (SIMUser::get("club") == 8 || SIMUser::get("club") == 52) { ?>
																	<label>
																		<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocio ?>" type="radio" id="Acompañante_Vehiculo" class="ace input-lg tipoentrada Acompañante_Vehiculo" value="Acompañante Vehiculo" />
																		<span class="lbl">Acompañante vehiculo</span>
																	</label>
																<?php
																} ?>
																...
																?>
																<label>
																	<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocio ?>" id="Vehiculo_<?php echo $contadorInvitadoSocio ?>" type="radio" class="ace input-lg tipoentrada Vehiculo" value="Vehiculo" />
																	<span class="lbl">Vehiculo</span>
																</label>
																<input type="text" placeholder="Ingrese placa" id="PlacaVehiculo_<?php echo $contadorInvitadoSocio ?>" name="PlacaVehiculo" class="PlacaVehiculo">
																<?php //} 
																?>
																<?php
																if (count($array_placa) > 0) :
																	foreach ($array_placa as $placa_vehiculo) : ?>
																		<label>
																			<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocio ?>" type="radio" class="ace input-lg" value="Vehiculo <?php echo $placa_vehiculo; ?>" />
																			<span class="lbl"><?php echo $placa_vehiculo; ?></span>
																		</label>
																<?php
																	endforeach;
															...
															<td colspan="2">
																...
																if ($modulo == "Socio" || $modulo == "SocioInvitado") { ?>
																	<table class="table table-striped table-bordered table-hover">
																		...
																		<?php
																		$resp_como_invitado = SIMWebServiceReservas::get_reservas_invitado(SIMUser::get("club"), $datos_invitados_socio['NumeroDocumento'], $datos_socio['IDSocio'], 0, "", $IDUsuario);
																		foreach ($resp["response"] as $key => $value) {
																			$FechaReserva = $value["Fecha"];
																			$HoraReserva = $value["Hora"];
																			$Servicio = $value["NombreServicio"];
																...
																<?php
																if ($datos_invitados_socio['IDInvitado']) {
																	if ($datos_invitados_socio["Mostrar"] == "N") {
																		$bloqueado = "S";
																		$mensaje_bloqueo = $datos_invitados_socio["RazonBloqueo"];
																	} else {
																		$hora_actual = date("Y-m-d H:i:s");
																		//Verifico si tiene algun bloqueo temporal
																		$sql_observacion_bloqueo = "Select * From ObservacionInvitado Where IDInvitado = '" . $datos_invitados_socio["IDInvitado"] . "' and FechaInicioBloqueo <= CURDATE() AND FechaFinBloqueo >= CURDATE() Order by IDObservacionInvitado Desc";
																		$result_observacion_bloqueo = $dbo->query($sql_observacion_bloqueo);
																		while ($row_log_acceso = $dbo->fetchArray($result_observacion_bloqueo)) :
																			if ($row_log_acceso["HoraInicioBloqueo"] == "00:00:00" && $row_log_acceso["HoraFinBloqueo"] == "00:00:00") :
																				$bloqueado = "S";
																...
																if ($bloqueado <> 'S' && empty($alerta_edad_beneficiario)) { ?>
																	<label>
																		<input name="Ingreso" id="Ingreso_<?php echo $contadorInvitadoSocio ?>" class="ace input-lg ace-checkbox-2 ingreso_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $datos_invitados_socio['IDSocioInvitadoEspecial']; ?>" <?php echo $campo_entrada; ?> />
																		<span class="lbl"><b>INGRESO</b></span>
																	</label>
																	<label>
																		<input name="Salida" id="Salida_<?php echo $contadorInvitadoSocio ?>" class="ace input-lg ace-checkbox-2 salida_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $datos_invitados_socio['IDSocioInvitadoEspecial']; ?>" <?php echo $campo_salida; ?> />
																		<span class="lbl"><b>SALIDA</b></span>
																	</label>
																<?php
																} else { ?>
														...
														if ($modulo == "SocioAutorizacion" || $modulo == "SocioInvitadoEspecial" || $modulo == "SocioInvitado") {  ?>
															<tr>
																<td colspan="2">
																	...
																	<?php
																	//Consulto el historial de alertas
																	$sql_observacion = "Select * From ObservacionInvitado Where IDInvitado = '" . $datos_invitados_socio["IDInvitado"] . "' Order by IDObservacionInvitado Desc";
																	$result_observacion = $dbo->query($sql_observacion);
																	while ($row_observacion = $dbo->fetchArray($result_observacion)) :
																		if (SIMUser::get("club") == 9) {
																			include("anotacion.php");
														...
														<tr>
															<td colspan="2">
																...
																<?php
																//Consulto el historial de entradas y salidas del dia
																$sql_log_acceso = "Select * From LogAccesoDiario Where IDInvitacion = '" . $datos_invitados_socio['IDSocioInvitadoEspecial'] . "' and ( DATE_FORMAT(FechaIngreso,'%Y-%m-%d') = '" . date("Y-m-d") . "' or DATE_FORMAT(FechaSalida,'%Y-%m-%d') = '" . date("Y-m-d") . "') Order by IDLogAcceso Desc";
																$result_log_acceso = $dbo->query($sql_log_acceso);
													...
													<?php
													$modulo = "SocioInvitadoEspecial";
													$id_registro = $datos_invitados_socio["IDSocioInvitadoEspecial"];
													?>
												</td>
												<?php
												if ($contador_grupo == "3") :
									...
									<?php if (SIMUser::get('club') == 8 || SIMUser::get('club') == 220 || SIMUser::get('club') == 15) {
										...
										if (isset($result_SocioInvitadosV1)) :
											$contadorInvitadoSocioV1 = $contadorInvitadoSocio + 1;
											$modulo = "SocioInvitado";
											while ($datos_invitadosV1_socio = $dbo->fetchArray($result_SocioInvitadosV1)) :
									...
									?>
												<td valign="top">
													<table class="table table-striped table-bordered table-hover" style="width:15% !important">
														<tr>
															<td valign="top" width="100">
																...
																$ruta_foto = IMGINVITADO_ROOT;
																$nombre_foto = "FotoFile";
																$identificador = $datos_invitadosV1_socio["IDSocio"]
																?>
																<a class="fancybox" href="../admin/tomarfoto/webcamjquery/foto.php?action=foto&IDRegistro=<?php echo $identificador; ?>&Modulo=<?php echo $modulo; ?>" data-fancybox-type="iframe">
																	<i class="ace-icon fa fa-camera bigger-120"></i>
																	<span class="bigger-110">Tomar Foto</span>
															...
															<td valign="top">
																<table class="table table-striped table-bordered table-hover">
																	...
																	<tr>
																		<td>&nbsp;
																			<?php echo $datos_invitadosV1_socio["Nombre"] . " " . $datos_invitadosV1_socio["Apellido"]  ?>
																		</td>
																	</tr>

																	<?php if ($datos_invitadosV1_socio['FechaNacimiento'] != '') { ?>
																		<tr>
																			<td style="color: #f00000;">&nbsp;
																				<strong>
																					Edad: <?= SIMUtil::Calcular_Edad($fecha_nacimiento) ?>
																		...
																		<tr>
																			<td>&nbsp;
																				Fecha Nacimiento: <?php echo $datos_invitadosV1_socio['FechaNacimiento'] ?>
																			</td>
																		</tr>
																	<?php } ?>
																	<tr>
																		<td>&nbsp;
																			Numero Documento: <?php echo $datos_invitadosV1_socio['NumeroDocumento'] ?>
																		</td>
																	</tr>
																</table>
															</td>
														...
														<tr>
															<td colspan="2">
																&nbsp;
																<label>
																	<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocioV1 ?>" id="Peatonal_<?php echo $contadorInvitadoSocioV1 ?>" type="radio" class="ace input-lg Peatonal" value="Peatonal" <?php echo (((SIMUser::get("club") == 44  || SIMUser::get("club") == 10) && $mecanismo == "Peatonal" && $SalidaLog = "S") ? " checked" : "") ?> />
																	<span class="lbl">Peatonal</span>
																</label>
																<?php if (SIMUser::get("club") == 8 || SIMUser::get("club") == 52) { ?>
																	<label>
																		<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocioV1 ?>" type="radio" id="Acompañante_Vehiculo" class="ace input-lg tipoentrada Acompañante_Vehiculo" value="Acompañante Vehiculo" />
																		<span class="lbl">Acompañante vehiculo</span>
																	</label>
																<?php
																} ?>
																<label>
																	<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocioV1 ?>" id="Vehiculo_<?php echo $contadorInvitadoSocioV1 ?>" type="radio" class="ace input-lg tipoentrada Vehiculo" value="Vehiculo" />
																	<span class="lbl">Vehiculo</span>
																</label>
																<input type="text" placeholder="Ingrese placa" id="PlacaVehiculo_<?php echo $contadorInvitadoSocioV1 ?>" name="PlacaVehiculo" class="PlacaVehiculo">
																<?php
																if (count($array_placa) > 0) :
																	foreach ($array_placa as $placa_vehiculo) : ?>
																		<label>
																			<input name="MecanismoEntradaIngreso_<?php echo $contadorInvitadoSocioV1 ?>" type="radio" class="ace input-lg" value="Vehiculo <?php echo $placa_vehiculo; ?>" />
																			<span class="lbl"><?php echo $placa_vehiculo; ?></span>
																		</label>
																<?php
																	endforeach;
																...
																<span class="lbl">
																	<?php
																	if ($modulo == "SocioAutorizacion" || $modulo == "SocioInvitadoEspecial") :
																		$link_otro_vehiculo = "invitadosgeneral.php?action=edit&id=" . $datos_invitadosV1_socio["IDInvitado"] . "&editarinfo=n&tabinvitado=vehiculos";
																	else :
																		$link_otro_vehiculo = "socios.php?action=edit&id=" . $datos_invitadosV1_socio["IDSocio"] . "&editarinfo=n&tabsocio=vehiculos";
																	endif;
																	?>
																	<?php if (SIMUser::get("club") != 10) : ?>
																		<a class="fancybox_vehiculo" href="<?php echo $link_otro_vehiculo ?>" data-fancybox-type="iframe">
															...
															<td colspan="2">
																...
																if ($modulo == "Socio" || $modulo == "SocioInvitado") { ?>
																	<table class="table table-striped table-bordered table-hover">
																		...
																		<?php
																		$resp_como_invitado = SIMWebServiceReservas::get_reservas_invitado(SIMUser::get("club"), $datos_invitadosV1_socio['NumeroDocumento'], $datos_socio['IDSocio'], 0, "", $IDUsuario);
																		foreach ($resp["response"] as $key => $value) {
																			$FechaReserva = $value["Fecha"];
																			$HoraReserva = $value["Hora"];
																			$Servicio = $value["NombreServicio"];
																...
																<?php
																if ($datos_invitadosV1_socio['IDInvitado']) {
																	if ($datos_invitadosV1_socio["Mostrar"] == "N") {
																		$bloqueado = "S";
																		$mensaje_bloqueo = "Invitado ya ingres&oacute;";
																	} else {
																		$hora_actual = date("Y-m-d H:i:s");
																		//Verifico si tiene algun bloqueo temporal
																		$sql_observacion_bloqueo = "Select * From ObservacionInvitado Where IDInvitado = '" . $datos_invitadosV1_socio["IDInvitado"] . "' and FechaInicioBloqueo <= CURDATE() AND FechaFinBloqueo >= CURDATE() Order by IDObservacionInvitado Desc";
																		$result_observacion_bloqueo = $dbo->query($sql_observacion_bloqueo);
																		while ($row_log_acceso = $dbo->fetchArray($result_observacion_bloqueo)) :
																			if ($row_log_acceso["HoraInicioBloqueo"] == "00:00:00" && $row_log_acceso["HoraFinBloqueo"] == "00:00:00") :
																				$bloqueado = "S";
																...
																//Verifico Cual fue el ultimo movimeinto registrado en el dia para saber si se activa la entrada o la salida
																$sql_log_acceso_ultimo = "Select * From LogAcceso Where IDInvitacion = '" . $datos_invitadosV1_socio['IDSocioInvitado'] . "' Order by IDLogAcceso Desc Limit 1";
																$result_log_acceso_ultimo = $dbo->query($sql_log_acceso_ultimo);
																$row_log_acceso_ultimo = $dbo->fetchArray($result_log_acceso_ultimo);
																$total_log = $dbo->rows($result_log_acceso_ultimo);
																if ($row_log_acceso_ultimo["Entrada"] == "S") :
																...
																if ($bloqueado <> 'S' && empty($alerta_edad_beneficiario)) { ?>
																	<label>
																		<input name="Ingreso" id="Ingreso_<?php echo $contadorInvitadoSocioV1 ?>" class="ace input-lg ace-checkbox-2 ingreso_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $datos_invitadosV1_socio['IDSocioInvitado']; ?>" <?php echo $campo_entrada; ?> />
																		<span class="lbl"><b>INGRESO</b></span>
																	</label>
																	<label>
																		<input name="Salida" id="Salida_<?php echo $contadorInvitadoSocioV1 ?>" class="ace input-lg ace-checkbox-2 salida_accesov2" type="checkbox" tipoacceso="familia" alt="<?php echo $modulo; ?>" title="<?php echo $datos_invitadosV1_socio['IDSocioInvitado']; ?>" <?php echo $campo_salida; ?> />
																		<span class="lbl"><b>SALIDA</b></span>
																	</label>
																<?php
																} else { ?>
														...
														if ($modulo == "SocioAutorizacion" || $modulo == "SocioInvitadoEspecial" || $modulo == "SocioInvitado") {  ?>
															<tr>
																<td colspan="2">
																	...
																	<?php
																	//Consulto el historial de alertas
																	$sql_observacion = "Select * From ObservacionInvitado Where IDInvitado = '" . $datos_invitadosV1_socio["IDInvitado"] . "' Order by IDObservacionInvitado Desc";
																	$result_observacion = $dbo->query($sql_observacion);
																	while ($row_observacion = $dbo->fetchArray($result_observacion)) :
																		if (SIMUser::get("club") == 9) {
																			include("anotacion.php");
														...
														<tr>
															<td colspan="2">
																...
																<?php
																//Consulto el historial de entradas y salidas del dia
																$sql_log_acceso = "Select * From LogAccesoDiario Where IDInvitacion = '" . $datos_invitadosV1_socio['IDSocioInvitado'] . "' and ( DATE_FORMAT(FechaIngreso,'%Y-%m-%d') = '" . date("Y-m-d") . "' or DATE_FORMAT(FechaSalida,'%Y-%m-%d') = '" . date("Y-m-d") . "') Order by IDLogAcceso Desc";
																$result_log_acceso = $dbo->query($sql_log_acceso);
													...
													<?php
													$modulo = "SocioInvitado";
													$id_registro = $datos_invitadosV1_socio["IDSocioInvitado"];
													?>
												</td>
												<?php
												if ($contador_grupo == "3") :
...
elseif ($predios != false && SIMUser::get("club") != 44) :
	?>
	<span style='color: #F00; font-size:16px'>
		Socio con predio:
	</span>
