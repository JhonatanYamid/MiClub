                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Edad minima para poder reservar </label>
                                    <div class="col-sm-8">
                                        <input type="number" id="PorcentajeAbono" name="EdadReservaHotel" placeholder="Edad minima" min="0" class="col-xs-12 mandatory" title="PorcentajeAbono" value="<?php echo $frm["EdadReservaHotel"]; ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Notificar reservas a los socios </label>
                                    <div class="col-sm-8">
                                        <? echo SIMHTML::formradiogroup(SIMResources::$sino, $frm["NotificarSocio"], 'NotificarSocio', "class='input'") ?>
                            ...
                            <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" id="CamposInvitado" name="CamposInvitado" placeholder="Cedula,Nombre" class="col-xs-12 " title="CamposInvitado" value="<?php if (empty($frm["CamposInvitado"])) {
                                                                                                                                                                                        echo "Cedula,Nombre";
                                                                                                                                                                                    } else {
                                                                                                                                                                                        echo $frm["CamposInvitado"];
                                                                                                                                                                                    }; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Numero de reservas permitidas por socio para las mismas fechas </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="NumeroReservasPermitidasMismaFecha" name="NumeroReservasPermitidasMismaFecha" placeholder="" class="col-xs-12 " title="Texto Legal" value="<?php echo $frm["NumeroReservasPermitidasMismaFecha"]; ?>">
                                    </div>
                                </div>

                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Minutos de la reserva </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group first ">
                               ...
                               <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Vista De Calendario </label>
                                    <div class="col-sm-8">
                                        <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteVistaFechaCalendario"], 'PermiteVistaFechaCalendario', "class='input'") ?>
                                    </div>
                                </div>
                                   <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar Disponibilidad En Calendario</label>
                                    <div class="col-sm-8">
                                        <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteMostrarFechasDisponiblesCalendario"], 'PermiteMostrarFechasDisponiblesCalendario', "class='input'") ?>
                                    </div>
                                </div><div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Color De Fechas Disponibles </label>
                                    <div class="col-sm-8">
                                        <input name="ColorFechasDisponiblesCalendario" type="color" value="<?php if (empty($frm["ColorFechasDisponiblesCalendario"])) {
                                                                                                echo "#1FFF00";
                                                                                            } else {
                                                                                                echo $frm["ColorFechasDisponiblesCalendario"];
                                                                                            }    ?>" />
                                    </div>
                                </div>
                            </div>
