...
<table id="simple-table" class="table table-striped table-bordered table-hover">
        ...
        <tbody id="listacontactosanunciante">
                ...
                $sql = "SELECT IDPregunta,TipoCampo,EtiquetaCampo,Obligatorio,Publicar,Orden FROM Pregunta WHERE IDEncuesta='" . $frm[$key] . "' Order by Orden";
                ...
                ?>
                        ...
                        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                <td align="center" width="64">
                                        <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDPregunta=" . $r->IDPregunta . "&IDModulo=" . $_GET["IDModulo"] ?>&tabencuesta=formulario" class="ace-icon glyphicon glyphicon-pencil"></a>
                                </td>
                                ...
                                <td align="center" width="64">
                                        <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaPregunta&id=<?php echo $frm[$key]; ?>&IDPregunta=<? echo $r->IDPregunta ?>&IDModulo=<? echo $_GET["IDModulo"]; ?>&tabpregunta=formulario"></a>
                                </td>
                        </tr>
                <?php
                }
