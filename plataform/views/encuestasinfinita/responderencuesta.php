...
<!-- 
<br><a href="procedures/excel-responderencuesta.php?IDEncuesta=<?php // echo  $frm[$key]; 
                                                                ?>"><img src="assets/img/xls.gif">Exportar</a>
    ...
    <tbody id="listacontactosanunciante">
        ...
        ?>
            <tr class="<?php //echo SIMUtil::repetition() ? 'row0' : 'row1' 
                        ?>">
                <td><?php //echo $dbo->getFields("Encuesta", "Nombre", "IDEncuesta = '" . $r->IDEncuesta . "'"); 
                    ?></td>
                ...
                ?>
                        <td>&nbsp;<?php // echo $array_otros_datos[$r->IDEncuestaRespuesta][$id_campo]; 
                                    ?></td>
                <?php // endforeach;
                //endif; 
                ?>

                <td align="center"><a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php // echo SIMReg::get("mod") 
                                                                                                                    ?>&action=EliminaRegistro&id=<?php echo $r->IDEncuesta; ?>&IDEncuestaRespuesta=<? echo $r->IDEncuestaRespuesta ?>&tabencuesta=responderencuesta"></a></td>
