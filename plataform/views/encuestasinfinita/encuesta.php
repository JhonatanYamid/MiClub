...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				<input id="CorreoRegistro" type="text" size="25" title="<?= SIMUtil::get_traduccion('', '', 'EnviarCorreoa?(Cuandoalguienhagaunregistro)', LANGSESSION); ?>" name="CorreoRegistro" class="input mandatory" value="<?php echo $frm["CorreoRegistro"] ?>" />
			</div>
		</div>
