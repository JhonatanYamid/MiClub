...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 'Texto Boton Crear Registro', 'Texto Titulo Categorias', 'Texto Boton Confirmar Registro',
            ...
            colModel: [{
                ...
                {
                    name: 'LabelBotonCrearRegistro',
                    index: 'LabelBotonCrearRegistro',
                    align: "left"
                },
                {
                    name: 'LabelTituloCategorias',
                    index: 'LabelTituloCategorias',
                    align: "left"
                },
                {
                    name: 'LabelBotonConfirmarRegistro',
                    index: 'LabelBotonConfirmarRegistro',
                    align: "left"
                },
