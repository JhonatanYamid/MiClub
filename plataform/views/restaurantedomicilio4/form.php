...
<div class="col-xs-12 col-sm-6">
								...
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Cajero Lake House </label>
								
								
								<div class="col-sm-8">
									<input type="text" id="CajeroLakeHouse" name="CajeroLakeHouse" placeholder="<?= SIMUtil::get_traduccion('', '', 'CajeroLakeHouse', LANGSESSION); ?>" class="col-xs-12 " title="<?= SIMUtil::get_traduccion('', '', 'CajeroLakeHouse', LANGSESSION); ?>" value="<?php echo $frm["CajeroLakeHouse"]; ?>">
								</div>
								<br><br><br>
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Codigo de ambiente Lake House  </label>

							
								<div class="col-sm-8">
									<input type="text" id="CodigoExternoAmbienteZeus" name="CodigoExternoAmbienteZeus" placeholder="Codigo de ambiente" class="col-xs-12 " title="Codigo de ambiente" value="<?php echo $frm["CodigoExternoAmbienteZeus"]; ?>">
								</div>
							</div>
						...
						<div class="form-group first ">
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Restaurantepara', LANGSESSION); ?>: </label>
							...
							<div class="col-xs-12 col-sm-6">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Mostrarrestaurantetodoslosdias', LANGSESSION); ?> </label>

								<div class="col-sm-8">
									<? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["MostrarRestauranteTodosLosDias"], 'MostrarRestauranteTodosLosDias', "class='input mandatory'") ?>
								</div>
							</div>
