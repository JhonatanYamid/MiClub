		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Registrar Ingreso','Estado','Socio', 'Numero de derecho','Documento Invitado', 'Nombre Invitado', 'Fecha de Ingreso', 'Obs','Alerta' ],
					colModel:[
						{name:'Ingreso',index:'Ingreso', align:"center"},
						{name:'Estado',index:'Estado', align:"center"},
						{name:'Socio',index:'Socio', align:"left"},
						{name:'Accion',index:'Socio', align:"left"},
