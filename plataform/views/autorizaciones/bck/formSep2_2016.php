					...
					<form class="form-horizontal formvalida" role="form" method="post" name="frm" id="frm" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
							...
							<div  class="form-group first ">
								...
								<div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">                                        
                                        <input id="NumeroDocumento" type="text" size="25" title="Numero Documento" name="NumeroDocumento" class="input mandatory autocomplete-ajax_invitado" value="<?php echo $frm["NumeroDocumento"] ?>" />                                                                               
							...
							<div  class="form-group first">
								...
								<div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										  <input type="text" id="FechaIngreso" name="FechaIngreso" placeholder="Fecha Ingreso" class="col-xs-12 <?php if($newmode!="updateingreso") echo "calendariohoy"; ?> " title="Fecha Ingreso" value="<?php  if($frm["FechaIngreso"]=="0000-00-00" || $frm["FechaIngreso"]=="" ) echo date("Y-m-d"); else echo $frm["FechaIngreso"]; ?>" <?php if($newmode=="updateingreso") echo "readonly"; ?>>
										</div>
								</div>
                            ...
                            <?php if($newmode=="updateobservacion"): ?>
                            <div  class="form-group first">
