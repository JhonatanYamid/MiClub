			...
			<?php  if($frm["orderStatus"]=="2"){
			  ...
			  $estado= "Sin éxito";
								...
								<div  class="col-xs-12 col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" id="errorMessage" name="errorMessage" placeholder="errorMessage" class="col-xs-12 mandatory" title="errorMessage" value="<?php echo $estado; ?>" >
									</div>
							</div>
