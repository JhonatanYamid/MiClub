			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
                        ...
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-redeban.php?IDClub=<?php echo SIMUser::get("club") . $otos_parametros; ?>">
							<table>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Ver','Documento','Nombre','Apellido','Accion','Email','Factura','NumeroTransacc','Fecha','ValorPago','Medio','Estado' ],
					colModel:[
						{name:'Ver',index:'', align:"center"},
						{name:'NumeroDocumento',index:'NumeroDocumento', align:"left"},
						{name:'NombreSocio',index:'NombreSocio', align:"left"},
						{name:'ApellidoSocio',index:'ApellidoSocio', align:"left"},
						{name:'NumeroAccion',index:'NumeroAccion', align:"left"},
						{name:'Email',index:'Email', align:"left"},
						{name:'NumeroFactura',index:'NumeroFactura', align:"left"},
						{name:'purchaseOperationNumber',index:'purchaseOperationNumber', align:"left"},
						{name:'FechaTransaccion',index:'FechaTransaccion', align:"left"},
						{name:'ValorPago',index:'ValorPago', align:"left"},
						{name:'MedioPago',index:'MedioPago', align:"left"},
						{name:'EstadoTransaccion',index:'EstadoTransaccion', align:"left"},

					],
					rowNum:100,
					rowList:[20,40,100],
					sortname: 'IDPagoCredibanco',
					viewrecords: true,
					sortorder: "DESC",
