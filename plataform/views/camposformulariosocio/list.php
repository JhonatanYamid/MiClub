...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: [
                <?php if (SIMUser::get("Nivel") == 0)  $editar = SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION);
                echo "'$editar',"; ?> "<input id='headCheck' class='hdCheck' type='checkbox'/>", '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>',
                <?php if (SIMUser::get("Nivel") == 0) $campoTabla = SIMUtil::get_traduccion('', '', 'CampoTabla', LANGSESSION);
                $tipo = SIMUtil::get_traduccion('', '', 'Tipo', LANGSESSION);
                echo "'$campoTabla','$tipo',"; ?> '<?= SIMUtil::get_traduccion('', '', 'Grupo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Obligatorio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>'
                <?php if (SIMUser::get("Nivel") == 0) $eliminar = SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION);
                echo ",'$eliminar'"; ?>
            ],
            colModel: [
