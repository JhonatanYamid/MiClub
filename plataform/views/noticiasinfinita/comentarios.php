...
if (SIMNet::req("action") == "search") {
	...
	$url_search = "?IDNoticiaInfinita=" . $_GET["id"];
}
...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		<h4 class="widget-title lighter smaller">
			<i class="ace-icon fa fa-users orange"></i><?= SIMUtil::get_traduccion('', '', 'LISTADODECOMENTARIOS', LANGSESSION); ?>
		</h4>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Comentarios', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'publicar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Socio',
					index: 'Socio',
					align: "left"
