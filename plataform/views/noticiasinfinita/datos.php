<form class="form-horizontal formvalida" role="form" method="post" name="frmnoticias" id="frmnoticias" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				<input type="hidden" id="IDSeccionNoticiaInfinita" name="IDSeccionNoticiaInfinita" value="<?php echo $frm["IDSeccionNoticiaInfinita"]; ?>">
				<input type="text" id="NombreSeccion" name="NombreSeccion" class="input" value="<?php echo $dbo->getFields("SeccionNoticiaInfinita", "Nombre", "IDSeccionNoticiaInfinita = '" . $frm["IDSeccionNoticiaInfinita"] . "'") ?>" readonly>
				<a href="PopupSeccionNoticiaInfinita.php?IDModulo=<?php echo $_GET["IDModulo"] ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=1000'); return false;" class="ace-icon glyphicon glyphicon-search"></a>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$dirigidoa), $frm["DirigidoA"], "DirigidoA", "title=\"DirigidoA\"") ?> <?php
					...
					<option value=""><?= SIMUtil::get_traduccion('', '', 'SeleccionGrupo', LANGSESSION); ?></option> <?php
																														...
																														while ($row_grupos = $dbo->fetchArray($result_grupos)) : ?> <option value="<?php echo $row_grupos["IDGrupoSocio"]; ?>" <?php if ($frm["IDGrupoSocio"] == $row_grupos["IDGrupoSocio"]) echo "selected";  ?>><?php echo $row_grupos["Nombre"]; ?></option> <?php endwhile; ?>
				</select>
				...
				<br>
				<select name="SocioInvitado[]" id="SocioInvitadoGrupo" class="col-xs-8" multiple> <?php
																									$item = 1;
																									...
																									?> <option value="<?php echo "grupo-" . $IDSocioInvitacion; ?>"><?php echo $nombre_socio; ?></option> <?php
																																																		endif;
																																																	}
																																																endforeach; ?> </select>
	...
	<div class="form-group first"> <?= SIMUtil::get_traduccion('', '', 'Cuerpo', LANGSESSION); ?> <div class="col-sm-12"> <?php
	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Noticia para publicidad
				<!-- <?= SIMUtil::get_traduccion('', '', 'Publicar', LANGSESSION); ?> -->
			</label>
			<div class="col-sm-8"><?php echo SIMHTML::formRadioGroup(SIMResources::$sinoNum, $frm["ParaPublicidad"], "ParaPublicidad", "title=\"ParaPublicidad\"") ?></div>
		</div>
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Noticia para la sección publica
				<!-- <?= SIMUtil::get_traduccion('', '', 'Publicar', LANGSESSION); ?> -->
			</label>
			<div class="col-sm-8"><?php echo SIMHTML::formRadioGroup(SIMResources::$sinoNum, $frm["ParaSeccionPublica"], "ParaSeccionPublica", "title=\"ParaSeccionPublica\"") ?></div>
		</div>
	</div>
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto1File&id=" . $frm[$key] . " &IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																																	} else {
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto2File&id=" . $frm[$key] . " &IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																																	} else {
																																																		?> <input type="file" name="Adjunto2Documento" id="Adjunto2Documento" class="popup" title="Noticia Documento"> <?php
																																																																													}
																																																																														?>
			</div>
		</div>
	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=NoticiaFile&id=" . $frm[$key] . " &IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																																	} else {
																																																		?> <input type="file" name="NoticiaImagen" id="NoticiaImagen" class="popup" title="Noticia Imagen"> <?php
																																																																										}
																																																																											?>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=FotoPortada&id=" . $frm[$key] . " &IDModulo=" . $_GET[IDModulo]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																																	} else {
																																																		?> <input type="file" name="FotoPortada" id="FotoPortada" class="popup" title="Foto Portada"> <?php
																																																																									}
																																																																										?>
			</div>
		</div>
	...
	<div class="clearfix form-actions">
		<div class="col-xs-12 text-center">
			...
			<button class="btn btn-info btnEnviar" type="button" rel="frmnoticias">
