            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-registraralimentoscasino.php">
                            <table>
                                <tr>
                                    <td><input type="text" id="FechaTrEd" name="FechaTrEd" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaInicio', LANGSESSION); ?>" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td><input type="text" id="FechaTrEd" name="FechaTrEd" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaFin', LANGSESSION); ?>" class="col-xs-12 calendar" title="FechaTrEd" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Cedula', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Desayuno', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Almuerzo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Cena', LANGSESSION); ?>',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
