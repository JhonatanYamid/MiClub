		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'includes/async/administrarCaddie.async.php<?=$url_search ?>',
					datatype: "json",
					colNames:['nombre', 'apellido', 'numeroDocumento', 'categoria', 'Eliminar' ],
					colModel:[						
					...
					width:855,
					multiselect: true,
					editurl: "includes/async/administrarCaddie.async.php",
