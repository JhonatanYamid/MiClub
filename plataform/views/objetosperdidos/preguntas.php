			...
			<div class="timeline-container">
				<div class="timeline-label">
					<span class="label label-primary arrowed-in-right label-lg">
						<b><?= SIMUtil::get_traduccion('', '', 'Solicituddepertenencia', LANGSESSION); ?></b>
					</span>
				</div>

				<?
				$sql_pregunta = "SELECT * FROM ObjetoPerdidoSolicitud WHERE IDObjetoPerdido = '" . $_GET[id] . "' Order By IDObjetoPerdidoSolicitud Desc";
				$qry_pregunta = $dbo->query($sql_pregunta);
				while ($row_pregunta = $dbo->object($qry_pregunta)) {
					$preguntas[$row_pregunta->IDObjetoPerdidoSolicitud] = $row_pregunta;
				}
