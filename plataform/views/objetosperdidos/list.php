			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="jqGrid_container">
						...
						<form name="frmexportaobjetosperdidos" id="frmexportaobjetosperdidos" method="post" enctype="multipart/form-data" action="procedures/excel-objetosperdidos.php">
							<table>
								<tr>
									...
									<td>
										...
										<input class="btn btn-info" type="submit" name="expobjp" id="expobjp" value="<?= SIMUtil::get_traduccion('', '', 'Exportar', LANGSESSION); ?>">
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'producto', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Descripcion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
