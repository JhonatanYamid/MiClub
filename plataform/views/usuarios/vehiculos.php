<form class="form-horizontal formvalida" role="form" method="post" id="EditVehiculoUsuario<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        <div class="form-group first ">
                ...
                <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="col-sm-8">
                                <input id=Placa type=text size=25 name=Placa class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'Placa', LANGSESSION); ?>" value="<?= $EditVehiculoUsuario[Placa] ?>">
                        </div>
                </div>
        ...
        <div class="form-group first ">
                <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="col-sm-8">
                                <input type="text" id="FechaTecnomecanica" name="FechaTecnomecanica" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaTecnomecanica', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechaTecnomecanica', LANGSESSION); ?>" value="<?php echo $EditVehiculoUsuario["FechaTecnomecanica"] ?>">
                        </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="col-sm-8">
                                <input type="text" id="FechaSeguro" name="FechaSeguro" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaSeguro', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechaSeguro', LANGSESSION); ?>" value="<?php echo $EditVehiculoUsuario["FechaSeguro"] ?>">
                        </div>
                </div>
                ...
                ?>
                        ...
                        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                <td align="center" width="64">
                                        <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDVehiculoUsuario=" . $r->IDVehiculoUsuario ?>&tabsocio=VehiculoUsuarios" class="ace-icon glyphicon glyphicon-pencil"></a>
                                </td>
                                <td><?php echo $r->Placa; ?></td>
                                <td><?php echo $r->FechaTecnomecanica; ?></td>
                                <td><?php echo $r->FechaSeguro; ?></td>
                                <td align="center" width="64">
                                        <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaVehiculoUsuario&id=<?php echo $frm[$key]; ?>&IDVehiculoUsuario=<? echo $r->IDVehiculoUsuario ?>&tabsocio=VehiculoUsuarios"></a>
                                </td>
                        </tr>
                <?php
                }
