    ...
    <div class="widget-body">
                ...
                <div class="col-xs-12">
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="form-group first">
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="form-field-1">Numero de celular con WhatsApp para contacto</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="NumeroCelular" name="NumeroCelular" placeholder="" class="form-control " title="Valor" value="<?php echo $frm["NumeroCelular"] ?>">
                                    </div>
                                </div>                                
                            </div>
                            <div class="form-group first">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="Descripcion" id="Descripcion" cols="30" rows="10" class="form-control "><?php echo $frm["Descripcion"]; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="form-field-1">Valor Caddie</label>
                                    <div class="col-sm-8"> 
                                        <input type="text" id="Valor" name="Valor" placeholder="" class="form-control " title="Valor" value="<?php echo $frm["Valor"] ?>" required>
                                    </div>
                                </div>
                            </div>
        ...
        <table id="simple-table" class="table table-striped table-bordered table-hover">
          <tr>
            <td>Archivo Excel
              <br>
              <a class="link" href='https://www.miclubapp.com/plataform/views/caddiesecaddie/carga.xlsx' download="Ejemplo Carga Handicap">Ejemplo carga archivo</a>
            </td>
