                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    while ($r_club_canje = $dbo->object($sql_clubes_canje)) {
                                        ...
                                        $Descripcion[$r_club_canje->IDListaClubes] = $r_club_canje->Descripcion;
                                    }
                                    $arrayop = array();
                                    // consulto los clubes
                                    ...
                                    while ($r = $dbo->object($query_listaclubes)) {
                                        ...
                                        //ver si ya estan activos los clubes
                                        $query_DetalleClubCanje = $dbo->query("Select IDListaClubes from DetalleClubCanje Where IDClub = '" . SIMUser::get("club") . "' AND IDListaClubes='" . $r->IDListaClubes . "'");
                                        $DatosDetalleClubCanje = $dbo->fetchArray($query_DetalleClubCanje);

                                        // ver los nuevos clubes que se van activar
                                        $query_ListaDetalleClubCanje = $dbo->query("Select IDListaClubes from ListaDetalleClubCanje Where IDClub = '" . SIMUser::get("club") . "' AND IDListaClubes='" . $r->IDListaClubes . "'");
                                        $DatosListaDetalleClubCanje = $dbo->fetchArray($query_ListaDetalleClubCanje);

                                        if ($DatosDetalleClubCanje["IDListaClubes"] > 0 || $DatosListaDetalleClubCanje["IDListaClubes"] > 0) {
                                    ...
                                    echo formCheckGroup_especial($arrayclubes, $club_canje, "ClubCanje[]", "&nbsp;", "", $club_canje_correo, $club_canje_mensaje, $MaximoDias, $Descripcion); ?>

                                    <?php
                                    function formCheckGroup_especial($options, $selection, $name, $sep = "", $attrs = "", $club_canje_correo, $club_canje_mensaje, $MaximoDias, $Descripcion)
                                    {
                                        ...
                                        foreach ($options as $key => $val) {
                                            ...
                                            $checkgroup .= "<br><label class=\"checkgroup\"><input type=\"text\" name=\"Descripcion[" . $val . "]" . "\" id=\"Descripcion" . $name . "\" value=\"" . $Descripcion[$val] . "\" " . $attrs . " placeholder=\"Descripcion \" > " . "</label>";
