<form class="form-horizontal formvalida" role="form" method="post" id="frmadministrarPropiedadesTalega" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
