<div id="timeline-1">
	<a href="procedures/excel-candidatos.php?IDOferta=<?php echo  $frm[$key]; ?>&tipo=funcionarios"><img src="assets/img/xls.gif">Exportar</a>
	<div class="row">
									...
									<div class="widget-header widget-header-small">
										<h5 class="widget-title smaller">
											<a href="#" class="blue">
												...
												if($club==87 or $club==8 ){ echo "(Talento/Colaborador) " . (isset($nombre_cliente) ? $nombre_cliente  : '<em>N/A</em>');}else{
