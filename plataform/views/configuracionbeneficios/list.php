...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Texto Boton Favoritos', 'Texto Header Favoritos', 'Activo',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'LabelBotonFavoritos',
                    index: 'LabelBotonFavoritos',
                    align: "left"
                },
                {
                    name: 'LabelHeaderFavoritos',
                    index: 'LabelHeaderFavoritos',
                    align: "left"
                },
                {
                    name: 'Activo',
