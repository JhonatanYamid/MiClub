...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>/<?= SIMUtil::get_traduccion('', '', 'Usuario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Predio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Latitud', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Longitud', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>'
