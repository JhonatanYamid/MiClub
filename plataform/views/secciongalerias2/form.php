                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm" name="frm" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <? if (!empty($frm["Icono"])) {
                                        echo "<img src='" . GALERIA_ROOT . $frm["Icono"] . "' width='300px' height='300px'>";
                                    ?>
                                        <a href="<? echo $script . ".php?action=delfotoIcono&foto=$frm[Icono]&campo=Icono&id=" . $frm[IDSeccionGaleria2]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a>
                                    <?
                                    } // END if
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'SoloIcono', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
