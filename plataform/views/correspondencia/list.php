...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $("#btExporta").click(function() {
            ...
            window.location.href = "procedures/excel-correspondencia.php?IDClub=<?php echo SIMUser::get("club"); ?>&" + 'FechaInicio=' + Inicio + '&FechaFin=' + Fin;
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Dirigidoa', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Tipo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Creadopor', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'EntregadoPor', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaRecepcion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'EntregadoA', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Vivienda', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'NotificacionLeida', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
