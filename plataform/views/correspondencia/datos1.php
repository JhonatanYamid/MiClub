    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-4">
                ...
                <input type="date" id="FechaRecepcion" name="FechaRecepcion" min="<?php $hoy = date("Y-m-d");
                                                                                    echo $hoy; ?>" readonly placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaRecepcion', LANGSESSION); ?>" title="<?= SIMUtil::get_traduccion('', '', 'FechaRecepcion', LANGSESSION); ?>" value="<?php
                                                                                                                                                                                                                                                                                        if (empty($fechaRecepcion[0])) {
                                                                                                                                                                                                                                                                                            echo $hoy;
                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                            echo $fechaRecepcion[0];
                                                                                                                                                                                                                                                                                        } ?>">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-4">
                <input type="date" id="FechaEntrega" name="FechaEntrega" min="<?php $hoy = date("Y-m-d");
                                                                                echo $hoy; ?>" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechaEntrega', LANGSESSION); ?>" title="<?= SIMUtil::get_traduccion('', '', 'FechaEntrega', LANGSESSION); ?>" value="<?php echo $fechaEntrega[0] ?>">
            </div>
    ...
    <div class="form-group first ">
        ...
        <div class="form-group first ">
            <div class="col-xs-12 col-sm-6">
                ...
                <a href="./views/correspondencia/codigosbarraspdf.php?IDClub=<? echo  SIMUser::get("club"); ?>&IDCorrespondencia=<?php echo $frm[$key] ?>" target="_blank" class="btn btn-sm btn-primary" style="background-color:#5D9732">Exportar</a>

                <body>
                    <button type="button" class="btn btn-sm btn-primary" style="background-color:#5D9732" onclick="printJS('./views/correspondencia/codigosbarraspdf.php?IDClub=<? echo  SIMUser::get("club"); ?>&IDCorrespondencia=<?php echo $frm[$key] ?>')">
                        Imprimir
                    </button>
                    <br>
                ...
                <div class="col-sm-8">
                    ...
                    if (!empty($frm[CodigoBarraCorrespondencia]))
