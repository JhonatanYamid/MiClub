...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'MostrarNumeroFactura', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'ObligatorioNumeroFactura', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'publicar', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'MostrarNumeroFactura',
                    index: 'MostrarNumeroFactura',
                    align: "left"
                },
                {
                    name: 'ObligatorioNumeroFactura',
                    index: 'ObligatorioNumeroFactura',
                    align: "left"
                },
                {
                    name: 'Publicar',
