                        ...
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'MostrarNumeroFactura', LANGSESSION); ?> </label>
                                    <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["MostrarNumeroFactura"], 'MostrarNumeroFactura', "class='input mandatory'") ?>
                                </div>
                            ...
                            <div class="form-group first ">
                                <div class="col-xs-12 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'ObligatorioNumeroFactura', LANGSESSION); ?> </label>
                                    <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["ObligatorioNumeroFactura"], 'ObligatorioNumeroFactura', "class='input mandatory'") ?>
                                </div>
