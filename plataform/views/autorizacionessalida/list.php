	...
	<div class="widget-box transparent" id="recent-box">
		<div class="widget-header">
			<h4 class="widget-title lighter smaller">
				<i class="ace-icon fa fa-users orange"></i>Autorizacion PENDIENTES DE INGRESO 
			</h4>
       ...
       <div class="page-header">
							<h1>
								<a href="#" id="veringresado">Ver Autorizacion que ya ingresaron</a>
								<small>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'includes/async/autorizacionessalida.async.php<?=$url_search ?>',
					datatype: "json",
					colNames:['Registrar Ingreso','Documento', 'Nombre', 'Alumno','Fecha Inicio','Fecha Fin', 'Padre/Madre','Cod Familia', 'Creada por'],
					colModel:[
						...
						{name:'Alumno',index:'Alumno', align:"center"},											
						{
							name:'FechaInicio',
							index:'FechaInicio', 
							align:"center",
					...
					width:855,
					multiselect: true,
					editurl: "includes/autorizacionessalida.async.php",
								 ...
								 if(icol==1){
									...
									//var IDClub = $(this).attr("lang");
										if(confirm("Esta seguro de registrar el ingreso?")){
											jQuery.ajax( {
												"type" : "POST",
												"data" : { "IDSocioAutorizacion" : rowid },
												"dataType" : "json",
									...
									if(icol==2 || icol==3 || icol==4 || icol==5 || icol==6 || icol==7 ){										
										$("#detalle"+rowid).click();																			
										//location.href="autorizacionessalida.php?action=edit&id="+rowid;										
										//$('.fancybox').click();
										//$.fancybox.open
										$.fancybox.open([
										{
											type: 'iframe',
											href : 'autorizacionessalida.php?action=editinfo&id='+rowid,
				...
				jQuery(grid_selectoringresado).jqGrid({
					...
					datatype: "json",
					colNames:['Registrar Salida','Documento', 'Nombre', 'Tipo','Fecha de Ingreso', 'Padre/Madre'],
					colModel:[
						{name:'Ingreso',index:'Ingreso', align:"center"},						
						{name:'NumeroDocumento',index:'NumeroDocumento', align:"left"},
						{name:'Nombre',index:'Nombre', align:"center"},
