<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				<textarea id="ComentariosClub" name="ComentariosClub" cols="10" rows="5" class="col-xs-12" title="C<?= SIMUtil::get_traduccion('', '', 'ComentarioClub', LANGSESSION); ?>"><?php echo $frm["ComentariosClub"]; ?></textarea>
 ...
 if($club== 233): 
  $fotoprod="";
                            ...
                            <?php
                             $club= SIMUser::get("club");
if($club== 233): 
echo $r_detalle_pedido->NombreProducto;
else:
							...
							<td><?php 
                                           $club= SIMUser::get("club");
if($club== 233): 
echo $r_detalle_pedido->IDProductoExterno;
else:
