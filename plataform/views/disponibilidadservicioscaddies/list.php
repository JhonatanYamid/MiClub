...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Servicio Caddie', 'Elemento Servicios Caddies', 'Nombre', 'Hora Desde', 'Hora Hasta',
                'Eliminar'
            ],
            colModel: [{
                    name: 'Editar',
                ...
                {
                    name: 'ServicioCaddie',
                    index: 'ServicioCaddie',
                    align: "left"
                },
                {
                    name: 'ElementoServiciosCaddies',
                    index: 'ElementoServiciosCaddies',
                    align: "left"
                },
                {
                    name: 'Nombre',
