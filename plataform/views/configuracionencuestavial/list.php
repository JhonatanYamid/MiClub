...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoConfirmacionEnvio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoBotonRecargar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
                ...
                {
                    name: 'LabelConfirmacionEnvio',
                    index: 'LabelConfirmacionEnvio',
                    align: "left"
                },
                {
                    name: 'LabelBotonRecargar',
                    index: 'LabelBotonRecargar',
                    align: "left"
                },
                {
                    name: 'Eliminar',
            ...
            rowNum: 100,
            rowList: [20, 40, 100],
            sortname: 'IDConfiguracionEncuestaVial',
            viewrecords: true,
            sortorder: "ASC",
