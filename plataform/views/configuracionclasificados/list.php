...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'PublicarClasificadosAutomaticamente', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'PublicarClasificadosAutomaticamente',
                    index: 'PublicarClasificadosAutomaticamente',
                    align: "left"
                },
                {
                    name: 'Activo',
