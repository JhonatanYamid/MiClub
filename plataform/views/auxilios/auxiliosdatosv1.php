                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="form-group first ">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <div class="col-sm-8">
                                        <input type="checkbox" name="Dirigido[]" value="lapiz">
                                        <input type="checkbox" name="Dirigido[]" value="cepillo">
                                        <input type="checkbox" name="Dirigido[]" value="hoja">
                                        <?php
                                        foreach ($_POST['Dirigido'] as $id) {
                                            echo $frm["Dirigido"] = $id;
                                        }
