    ...
    <div class="widget-main padding-4">
      <div class="tabbable" id="myTABS" role="tablist">
        ...
        <div class="tab-content">
                ...
                <form class="form-horizontal" id="frmBuscarVacunado">
                  ...
                  <table id="simple-table" class="table table-striped table-bordered table-hover">
                    <tr>
                      ...
                      <td>
                        <label class="col-sm-8 control-label no-padding-right" for="form-field-1">Tipo Socio</label>
                        <select name="TipoSocio" id="TipoSocio" class="form-control">
                          <option value="">[Seleccione estado]</option>
                          <?php
                          echo $sql_TipoSocio = "SELECT c.IDTipoSocio,t.Nombre FROM ClubTipoSocio c LEFT JOIN TipoSocio t ON c.IDTipoSocio=t.IDTipoSocio WHERE IDClub = " . SIMUser::get('club') . " AND Publicar = 'S'";
                          $q_TipoSocio = $dbo->query($sql_TipoSocio);
                          while ($r_TipoSocio = $dbo->fetchArray($q_TipoSocio)) { ?>
                            <option value="<?= $r_TipoSocio['Nombre'] ?>"><?= $r_TipoSocio['Nombre'] ?></option>
                          <?php } ?>
                        </select>
                      </td>
                      <td>
                      ...
                      <td>
                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Acci&oacute;n </label>
                        <input name="Accion" id="Accion" class="form-control" placeholder="Accion">
                      </td>
          ...
          <? include("views/reportevacunacion2/vacunacion.php") ?>
          ...
          <script type="text/javascript">
            function getVacunacionParmas() {
              ...
              params += (Accion == undefined || Accion == "") ? "" : "Accion=" + Accion;
              params += (TipoUsuario == undefined || TipoUsuario == "") ? "" : "TipoUsuario=" + TipoUsuario;
              params += (TipoSocio == undefined || TipoSocio == "") ? "" : "TipoSocio=" + TipoSocio;
            ...
            $("#btExportaVacunados").click(function() {
              ...
              window.location.href = "./procedures/excel-vacuna2.php?" + params;
            ...
            $("#btBuscarVacunados").click(function() {
              ...
              jQuery("#grid-table").jqGrid('setGridParam', {
                url: 'includes/async/<?php echo $script; ?>.async.php?<?= $url_search ?>' + params,
                datatype: "json"
              }).trigger("reloadGrid");
            ...
            $("#pills-socio-tab").click(function() {
              ...
              let params = getVacunacionParmas();
              jQuery("#grid-table").jqGrid('setGridParam', {
                url: 'includes/async/<?php echo $script; ?>.async.php<?= $url_search ?>?tipoVacunados=socio&' + params,
                datatype: "json"
              }).trigger("reloadGrid");
            });
            ...
            $("#pills-usuario-tab").click(function() {
              ...
              let params = getVacunacionParmas();
              jQuery("#grid-table").jqGrid('setGridParam', {
                url: 'includes/async/<?php echo $script; ?>.async.php<?= $url_search ?>?tipoVacunados=usuario&' + params,
                datatype: "json"
              }).trigger("reloadGrid");
            });
            $("#pills-empleado-tab").click(function() {
              ...
              let params = getVacunacionParmas();
              jQuery("#grid-table").jqGrid('setGridParam', {
                url: 'includes/async/<?php echo $script; ?>.async.php<?= $url_search ?>?tipoVacunados=empleado&' + params,
                datatype: "json"
              }).trigger("reloadGrid");
            });
            $("#pills-estudiante-tab").click(function() {
              ...
              let params = getVacunacionParmas();
              jQuery("#grid-table").jqGrid('setGridParam', {
                url: 'includes/async/<?php echo $script; ?>.async.php<?= $url_search ?>?tipoVacunados=estudiante&' + params,
                datatype: "json"
              }).trigger("reloadGrid");
            });
          </script>