...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoTitulo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoSubtitulo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoPendientesPorEntregar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TextoEntregados', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'LabelSubtitulo',
                    index: 'LabelSubtitulo',
                    align: "left"
                },
                {
                    name: 'LabelPendientesPorEntregar',
                    index: 'LabelPendientesPorEntregar',
                    align: "left"
                },
                {
                    name: 'LabelEntregados',
                    index: 'LabelEntregados',
                    align: "left"
                },
