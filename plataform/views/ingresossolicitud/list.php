            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-IngresosSolicitud.php">
                            <table>
                                <tr>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Socio', 'Estado', 'Fecha Solicitud', 'Descargar PDF', 'Descargar ZIP', 'Exportar', 'Eliminar'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
