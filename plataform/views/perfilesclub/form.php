                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="IDClub" id="IDClub" class="form-control">
                                        <option value="<?php echo SIMUser::get("club"); ?>">SELECCIONE EL CLUB</option> <?php
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i><?= SIMUtil::get_traduccion('', '', 'Invitados', LANGSESSION); ?>
                            </h3>
                        </div>

                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Invitados', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoInvitados"], 'PermisoInvitados', "class='input'") ?>
                                </div>
                            </div>

                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Contratista', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoContratistas"], 'PermisoContratistas', "class='input'") ?>
                                </div>
                            </div>
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i><?= SIMUtil::get_traduccion('', '', 'PermisoModulosPqr', LANGSESSION); ?>
                            </h3>
                        </div>

                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Areas', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoAreasPqr"], 'PermisoAreasPqr', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TipoPqr', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoTipoPqr"], 'PermisoTipoPqr', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'CategoriaPqr', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoCategoriaPqr"], 'PermisoCategoriaPqr', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i><?= SIMUtil::get_traduccion('', '', 'PermisoModulosDomicilio', LANGSESSION); ?>
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Domicilios', LANGSESSION); ?> 1 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio1"], 'PermisoDomicilio1', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Domicilios', LANGSESSION); ?> 2 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio2"], 'PermisoDomicilio2', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Domicilios', LANGSESSION); ?> 3 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio3"], 'PermisoDomicilio3', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Domicilios', LANGSESSION); ?> 4 </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDomicilio4"], 'PermisoDomicilio4', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-info-circle green"></i> <?= SIMUtil::get_traduccion('', '', 'PermisoModulosCheckinFuncionarios', LANGSESSION); ?>
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Turnos', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoTurnos"], 'PermisoTurnos', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoDiaNoLaboral"], 'PermisoDiaNoLaboral', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'planificaciondiaria', LANGSESSION); ?></label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoPlanificacionDiaria"], 'PermisoPlanificacionDiaria', "class='input'") ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'CheckinFuncionarios', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoCheckinFuncionarios"], 'PermisoCheckinFuncionarios', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Novedades', LANGSESSION); ?></label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoNovedades"], 'PermisoNovedades', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'EncuestaInfinita', LANGSESSION); ?> </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(SIMResources::$sinoNum, $frm["PermisoEncuestaInfinita"], 'PermisoEncuestaInfinita', "class='input'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
