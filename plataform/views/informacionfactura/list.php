	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
					   ...
					   '<?= SIMUtil::get_traduccion('', '', 'Razonsocial', LANGSESSION); ?>', 
					   '<?= SIMUtil::get_traduccion('', '', 'Nombrecomercial', LANGSESSION); ?>', 
					   'Nit', 
			...
			colModel: [
                ...
                <?}?>
				{name: 'Nombre1',index: 'Nombre1',align: "left"},
				{name: 'Nombre2',index: 'Nombre2',align: "left"},
				{name: 'Nit',index: 'Nit',align: "left"},
