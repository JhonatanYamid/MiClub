			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">		
						...
						<a href="procedures/excel-empleados.php"><img src="assets/img/xls.gif" >Exportar</a>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Código empleado', 'Cédula', 'Nombre', 'Primer apellido', 'Segundo apellido','Estado' ],
					colModel:[						
						{name:'Editar',index:'', align:"center"},
						{name:'IDLukerEmpleado',index:'IDLukerEmpleado', align:"left"},
						{name:'EMP_CEDULA',index:'EMP_CEDULA', align:"left"},
						{name:'EMP_NOMBRE',index:'EMP_NOMBRE', align:"left"},
						{name:'EMP_APELLIDO1',index:'EMP_APELLIDO1', align:"left"},
						{name:'EMP_APELLIDO2',index:'EMP_APELLIDO2', align:"left"},					
