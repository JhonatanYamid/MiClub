...
CARTERA VENCIDA
            ...
            <td valign="top">
                <table id="simple-table" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <tr>
                        <td colspan="2">
                              <a href="/file/plantilla_cartera/EJEMPLO.xlsx" download> Descargar plantilla  </a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <input type="hidden" name="IDClub" id="IDClub" value="<?php echo empty($frm["IDClub"]) ?  SIMUser::get("club") : $frm["IDClub"];  ?>" />
                            <input type="hidden" name="action" id="action" value="cartera_vencida" />
                            <input type="submit" class="submit" value="<?= SIMUtil::get_traduccion('', '', 'Cargar', LANGSESSION); ?>">
                        </td>
                    </tr>
 ...
 if($IDClub==8 or $IDClub==127){
 
 ?>

<form class="form-horizontal formvalida" role="form" method="post" id="frmSocioPlano" name="frmSocioPlano" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    <br>
CUENTA DE COBRO CABO TORTUGA
    <br>
    <table id="simple-table" class="table table-striped table-bordered table-hover">
        <tr>
            <td>
            ...
            <td valign="top">
                <table id="simple-table" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <tr>
                        <td colspan="2">
                              <a href="/file/plantilla_cartera/CaboTortuga.xlsx" download> Descargar plantilla  </a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <input type="hidden" name="IDClub" id="IDClub" value="<?php echo empty($frm["IDClub"]) ?  SIMUser::get("club") : $frm["IDClub"];  ?>" />
                            <input type="hidden" name="action" id="action" value="cartera_cabo_tortuga" />
                            <input type="submit" class="submit" value="<?= SIMUtil::get_traduccion('', '', 'Cargar', LANGSESSION); ?>">
                        </td>
                    </tr>
