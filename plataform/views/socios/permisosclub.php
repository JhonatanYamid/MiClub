<form class="form-horizontal formvalida" role="form" method="post" name="SocioClubPermiso" id="SocioClubPermiso" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data"> <?php
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Clubesconpermiso', LANGSESSION); ?>: </label>
            <div class="col-sm-8">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'ServiciosClub', LANGSESSION); ?>: </label>
            <div class="col-sm-8">
                <select name="IDServicio" id="IDServicio" class="form-control">
                    <option value=""><?= SIMUtil::get_traduccion('', '', 'SELECCIONEUNSERVICIO', LANGSESSION); ?></option>
                </select>
                <br>
                <a id="agregar_servicioclub" href="#"><?= SIMUtil::get_traduccion('', '', 'AgregarServicio', LANGSESSION); ?></a> | <a id="borrar_servicio" href="#"><?= SIMUtil::get_traduccion('', '', 'BorrarServicio', LANGSESSION); ?></a>
                <br>
...
<table id="simple-table" class="table table-striped table-bordered table-hover">
    <tr>
        ...
        <th><?= SIMUtil::get_traduccion('', '', 'Club', LANGSESSION); ?></th>
