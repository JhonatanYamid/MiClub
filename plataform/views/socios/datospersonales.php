...
<form class="form-horizontal formvalida" role="form" method="post" id="frmSocio" action="<? echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	...
	try {
		...
		while ($rowGrupo = $dbo->fetchArray($resultGrupo)) {
			...
			<div class="widget-header widget-header-large">
				<h3 class="widget-title grey lighter">
					...
					<?= SIMUtil::get_traduccion('', '', $rowGrupo['Grupo'], LANGSESSION); ?>
				</h3>
			</div>
						...
						<div class="col-sm-8">
							<? if (SIMUser::get("IDPerfil") == 7) {
								...
								<select name="TipoSocio" id="TipoSocio" class="form-control" onchange="cambioTipoSocio()">
									<option value=""><?= SIMUtil::get_traduccion('', '', '[Seleccione Tipo Socio]', LANGSESSION); ?></option>
			...
			while ($rowCampo = $dbo->fetchArray($resultCampo)) {
				...
				if ($nombreCampo == 'NumeroDerecho' || $nombreCampo == 'Predio') {
					...
					$nombre = $ArrayMensajesWeb[$tipo_club][$nombreCampo];
				}
				...
				<div class="col-xs-12 col-sm-6 <? echo $classDiv ?>" <? echo $adDiv ?>>
					<label class="col-sm-4 control-label no-padding-right" id="label_<? echo $idCampo; ?>" for="<? echo $idCampo; ?>">
						<!-- <? echo $nombreCampo; ?> -->
						<?
						if (trim($nombreCampo) == "N&uacute;mero de Derecho") {
							$campoMostrar = "Número de Derecho";
							echo trim(SIMUtil::get_traduccion('', '', trim($campoMostrar), LANGSESSION));
						} else {
							echo trim(SIMUtil::get_traduccion('', '', trim($nombreCampo), LANGSESSION));
						}
					...
					<div class="col-sm-8" id="div_<?= $idCampo; ?>"><?
																	...
																	if ($tipoCampo == "text" || $tipoCampo == "number" || $tipoCampo == "date" || $tipoCampo == "time" || $tipoCampo == "email" || $tipoCampo == "password") {
																		...
																		$txtCampo = SIMUtil::get_traduccion('', '', $txtCampo, LANGSESSION);
				...
				<? if ($_GET["action"] == "edit") { ?>
					<div class="form-group first ">
						<div class="col-xs-12 col-sm-6">
							<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Registrarhuella', LANGSESSION); ?> </label>
							<div class="col-sm-8">
						...
						<div class="col-xs-12 col-sm-6">
							<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Movimientos', LANGSESSION); ?> </label>
							<div class="col-sm-8">
			...
			<div class="widget-header widget-header-large">
				<h3 class="widget-title grey lighter">
					<i class="ace-icon fa fa-user green"></i> <?= SIMUtil::get_traduccion('', '', 'DatosPerfil', LANGSESSION); ?>
				</h3>
			</div>
			<?php
					$sql_campos = "SELECT SCES.Valor,CED.Nombre,CED.Tipo FROM CampoEditarSocio CED, SocioCampoEditarSocio SCES
					...
					while ($r = $dbo->object($r_campos)) {
						if ($r->Tipo == "imagen") {
							$array_respuesta[] = "<a href='" . EDITARPERFIL_ROOT . $r->Valor . "' target='_blank' >" . " <img src='" . EDITARPERFIL_ROOT . $r->Valor . "' width='100px' height='100px' ></a>";
						} else if ($r->Tipo == "imagenarchivo") {
							$array_respuesta[] = "<a href='" . EDITARPERFIL_ROOT .  $r->Valor . "' target='_blank' >" . "Ver archivo</a>";
						} else {
			...
			<div class="widget-header widget-header-large">
				<h3 class="widget-title grey lighter">
					<i class="ace-icon fa fa-credit-card green"></i> <?= SIMUtil::get_traduccion('', '', 'VinculoFamiliar', LANGSESSION); ?>
				</h3>
			</div>
			<div class="form-group first ">
		...
		<div class="contentCortesia <?php echo $oculta_cortesia; ?>  contentAuxiliar">
			<h4 class="blue ">
				<i class="ace-icon fa fa-check bigger-110"></i> <?= SIMUtil::get_traduccion('', '', 'Cortesía', LANGSESSION); ?>
			</h4>
			<div class="form-group first ">
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeInicio', LANGSESSION); ?></label>
					<div class="col-sm-8">
						<input type="text" id="FechaInicioCortesia" name="FechaInicioCortesia" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeInicioCortesía', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechadeInicio', LANGSESSION); ?>" value="<?php echo $frm["FechaInicioCortesia"]; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeFin', LANGSESSION); ?> </label>
					<div class="col-sm-8">
						<input type="text" id="FechaFinCortesia" name="FechaFinCortesia" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeFinCortesía', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechadeFin', LANGSESSION); ?>" value="<?php echo $frm["FechaFinCortesia"]; ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="contentCanje <?php echo $oculta_canje; ?>  contentAuxiliar" id="divdatosCanje">
			<h4 class="blue ">
				<i class="ace-icon fa fa-check bigger-110"></i> <?= SIMUtil::get_traduccion('', '', 'Canje', LANGSESSION); ?>
			</h4>
			<div class="form-group first ">
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeInicio', LANGSESSION); ?></label>
					<div class="col-sm-8">
						<input type="text" id="FechaInicioCanje" name="FechaInicioCanje" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeInicioCanje', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechadeInicioCanje', LANGSESSION); ?>" value="<?php echo $frm["FechaInicioCanje"]; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeFin', LANGSESSION); ?> </label>
					<div class="col-sm-8">
						<input type="text" id="FechaFinCanje" name="FechaFinCanje" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeFinCanje', LANGSESSION); ?>" class="col-xs-12 calendar" title="<?= SIMUtil::get_traduccion('', '', 'FechadeFinCanje', LANGSESSION); ?>" value="<?php echo $frm["FechaFinCanje"]; ?>">
					</div>
				</div>
			</div>
			<div class="form-group first ">
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'ClubCanje', LANGSESSION); ?> </label>
					<div class="col-sm-8">
				...
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'TipodeCanje', LANGSESSION); ?> </label>
					<div class="col-sm-8">
						<?php
		...
		<div class="contentInvitado <?php echo $oculta_invitado; ?>  contentAuxiliar" id="divdatosInvitado">
			<h4 class="blue ">
				<i class="ace-icon fa fa-check bigger-110"></i> <?= SIMUtil::get_traduccion('', '', 'InvitadoFechas', LANGSESSION); ?>
			</h4>
			<div class="form-group first ">
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'FechadeInicio', LANGSESSION); ?></label>
					<div class="col-sm-8">
						<input type="text" id="FechaInicioInvitado" name="FechaInicioInvitado" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeInicioInvitado', LANGSESSION); ?>" class="col-xs-12 calendar" title="fecha de inicio invitado" value="<?php echo $frm["FechaInicioInvitado"]; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeFinCanje', LANGSESSION); ?> </label>
					<div class="col-sm-8">
						<input type="text" id="FechaFinInvitado" name="FechaFinInvitado" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeFinInvitado', LANGSESSION); ?>" class="col-xs-12 calendar" title="fecha de fin Invitado" value="<?php echo $frm["FechaFinInvitado"]; ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="contentArrendatario <?php echo $oculta_arrendatario; ?>  contentAuxiliar" id="divdatosArrendatario">
			<h4 class="blue ">
				<i class="ace-icon fa fa-check bigger-110"></i> <?= SIMUtil::get_traduccion('', '', 'FechasdeArrendatario', LANGSESSION); ?>
			</h4>
			<div class="form-group first ">
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeInicio', LANGSESSION); ?></label>
					<div class="col-sm-8">
						<input type="text" id="FechaInicioArrendatario" name="FechaInicioArrendatario" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeInicioArrendatario', LANGSESSION); ?>" class="col-xs-12 calendar" title="fecha de inicio arrendatario" value="<?php echo $frm["FechaInicioArrendatario"]; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6">
					<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'FechadeFinCanje', LANGSESSION); ?> </label>
					<div class="col-sm-8">
						<input type="text" id="FechaFinArrendatario" name="FechaFinArrendatario" placeholder="<?= SIMUtil::get_traduccion('', '', 'FechadeFinArrendatario', LANGSESSION); ?>" class="col-xs-12 calendar" title="fecha de fin arrendatario" value="<?php echo $frm["FechaFinArrendatario"]; ?>">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="clearfix form-actions">
		<div class="col-xs-12 text-center">
			...
			<button class="btn btn-info btnEnviar" type="button" rel="frmSocio">
				<i class="ace-icon fa fa-check bigger-110"></i> <!-- <? echo $titulo_accion; ?> Socio -->
