...
<div class="widget-box transparent" id="recent-box">
    ...
    <div class="widget-body">
        <div class="widget-main padding-4">
            <div class="row">
                <div class="col-xs-12">
                    <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-objetosprestados.php">
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="btn btn-purple" type="button" name="searchCheckin" id="searchCheckin" rel="<?= $script; ?>.php?action=searchDate" value="<?= SIMUtil::get_traduccion('', '', 'Buscar', LANGSESSION); ?>">
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', 'Lugar', 'Nombre Objeto', 'Cantidad Prestada', 'Cantidad Pendiente', 'Cantidad Entregada', 'Eliminar', 'Entregar'],
            colModel: [{
                    name: 'Socio',
                    index: 'Socio',
                    align: "left"
        ...
        jQuery(grid_selector).jqGrid('navGrid', pager_selector, { //navbar options
            ...
            */
            ...
            caption: "Ver Objetos Entregados",
            buttonicon: 'ace-icon fa fa-eye',
            onClickButton: function() {

                location.href = "<?php echo $script; ?>.php?action=VerObjetosEntregados";
