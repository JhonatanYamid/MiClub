...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            url: 'includes/async/<?php echo $script; ?>entregados.async.php<?= $url_search ?>',
            datatype: "json",
            ...
            width: 855,
            multiselect: true,
            editurl: "includes/async/<?php echo $script; ?>entregados.async.php",
        ...
        jQuery(grid_selector).jqGrid('navGrid', pager_selector, { //navbar options
            ...
            */
            ...
            caption: "Ver Objetos Pendientes",
            buttonicon: 'ace-icon fa fa-eye',
            onClickButton: function() {

                location.href = "<?php echo $script; ?>.php?action=";
