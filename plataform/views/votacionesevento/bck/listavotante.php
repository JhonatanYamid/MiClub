...
<form class="form-horizontal formvalida" role="form" method="post" id="EditVotante<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
                ...
                <div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										  <input id=Nombre type=text size=25  name=Nombre class="col-xs-12 mandatory" title="Nombre" value="<?=$EditVotante["Nombre"]; ?>" placeholder="Nombre">
										</div>
								</div>

								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Numero de casa:</label>

										<div class="col-sm-8">
											<input id=NumeroCasa type=text size=25  name=NumeroCasa class="col-xs-12" title="NumeroCasa" value="<?=$EditVotante["NumeroCasa"];  ?>" placeholder="Numero Casa">
										</div>
								</div>
							</div>
                ...
                <div  class="col-xs-12 col-sm-6">
										...
										<div class="col-sm-8">
										  <input id=Cedula type=number size=25  name=Cedula class="col-xs-12 mandatory" title="Cedula" value="<?=$EditVotante["Cedula"]; ?>" placeholder="Cedula">
										</div>
								</div>

								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Coeficiente:</label>

										<div class="col-sm-8">
											<input id=Coeficiente type=number size=25  name=Coeficiente class="col-xs-12" title="Coeficiente" value="<?=$EditVotante["Coeficiente"];  ?>" placeholder="Coeficiente" step="0.00000000001" min="0" max="100">
										</div>
								</div>
							</div>
							...
							<div  class="form-group first ">
                <div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Es consejero: </label>
								...
								<div  class="col-xs-12 col-sm-6">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Moroso:</label>
							...
							<div class="clearfix form-actions">
								<div class="col-xs-12 text-center">
									...
									<input type="submit" class="submit btn btn-primary" value="Guardar ">
		...
		$(".fancyboxpoder").fancybox({
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Nombre', 'Cedula', 'Numero Casa','Coeficiente','Consejero','Moroso', 'Registrado' ],
					colModel:[
						{name:'Editar',index:'', align:"center"},
						{name:'Nombre',index:'Nombre', align:"left"},
						{name:'Cedula',index:'Cedula', align:"left"},
						{name:'NumeroCasa',index:'NumeroCasa', align:"left"},
						{name:'Coeficiente',index:'Coeficiente', align:"left"},
						{name:'Consejero',index:'Consejero', align:"left"},
						{name:'Moroso',index:'Moroso', align:"left"},
						{name:'Presente',index:'Presente', align:"center"},
