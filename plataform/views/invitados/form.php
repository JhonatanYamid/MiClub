					...
					<form class="form-horizontal formvalida" role="form" method="post" name="frm" id="frm" action="<?= SIMUtil::lastURI() ?>" enctype="multipart/form-data">
						...
						for ($cont_invitado = 1; $cont_invitado <= 1; $cont_invitado++) : ?>
							...
							<div class="form-group first ">
								...
								<div class="col-xs-12 col-sm-6">
									<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Placa veh&iacute;culo <?= $cont_invitado; ?></label>

									<div class="col-sm-8">
										<input id="Nombre<?= $cont_invitado; ?>" type="text" size="25" title="Placa" name="Placa<?= $cont_invitado; ?>" alt="<?= $cont_invitado; ?>" class="input " value="<?= (!empty($frm["Placa"]) && $cont_invitado == 1) ? $frm["Placa"] : ""; ?>" />
									</div>
								</div>
...
<div class="form-group first">
								...
								<div class="col-xs-12 col-sm-6">
									<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo Invitacion</label>

									<div class="col-sm-8">
										<input type="text" id="TipoInvitacion" rows="4" title="TipoInvitacion" name="TipoInvitacion" class="form-control" value="<?= $frm["TipoInvitacion"] ?>" >
									</div>
								</div>
