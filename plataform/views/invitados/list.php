...
$fechaInicio = (SIMNet::get("inicio")) ? SIMNet::get("inicio") : date("Y-m-d");
$fechaFin = (SIMNet::get("fin")) ? SIMNet::get("fin") : date("Y-m-d");
?>
...
<div class="widget-box transparent" id="recent-box">
	<div class="widget-header">
		<h4 class="widget-title lighter smaller">
			<i class="ace-icon fa fa-users orange"></i>INVITADOS PENDIENTES DE INGRESO
		</h4>
	</div>
	<div id="jqGrid_container">
		<form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-invitado-socio.php">
			<table>
				<tr>
					<td><input type="text" id="FechaInicio" name="FechaInicio" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="FechaInicio" value="<?= $fechaInicio ?>"></td>

					<td><input type="text" id="FechaFinal" name="FechaFinal" placeholder=" Fecha Final" class="col-xs-12 calendar" title="FechaFinal" value="<?= $fechaFin ?>"></td>
					<td>
						...
						<input class="btn btn-purple" type="button" name="searchCheckin" id="searchCheckin" rel="<?= $script; ?>.php?action=searchDate" value="Buscar">
					</td>
				<tr>
			</table>
		</form>
		...
		<div class="widget-main padding-4">
			<div class="row">
				<div class="col-xs-12">
					...
					<a href="procedures/excel-invitado-socio.php"><img src="assets/img/xls.gif">Exportar</a>
					<table id="grid-table"></table>
	...
	<div class="page-header">
		<h1>
			<a href="#" id="veringresado">Ver Invitados que ya ingresaron al club</a>
			<small>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			url: 'includes/async/invitados.async.php<?= $url_search ?>',
			datatype: "json",
			colNames: ['Registrar Ingreso', 'Estado', 'Socio', 'Numero de derecho', 'Documento Invitado', 'Tipo Invitacion','Nombre Invitado', 'Fecha de Ingreso', 'Obs', 'Alerta', 'Finalizar Inv'],
			colModel: [{
					name: 'Ingreso',
					index: 'Ingreso',
					align: "center"
			...
			onCellSelect: function(rowid, icol, cellcontent, e) {
				if (icol == 1) {
					...
					if (icol == 2 || icol == 3 || icol == 4 || icol == 5 || icol == 6 || icol == 7) {
						...
						$.fancybox.open([{
							type: 'iframe',
							href: 'invitados.php?action=editinfo&id=' + rowid,
		...
		jQuery(grid_selectoringresado).jqGrid({
			...
			datatype: "json",
			colNames: ['Estado', 'Socio', 'Numero de derecho', 'Documento Invitado', 'Tipo Invitacion', 'Nombre Invitado', 'Fecha de Ingreso', 'Obs'],
			colModel: [{
					name: 'Estado',
					index: 'Estado',
					align: "center"
