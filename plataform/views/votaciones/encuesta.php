...
<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'Solopermitirvotar1vezporsocio', LANGSESSION); ?>?</label>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'SolicitarSegundaclave', LANGSESSION); ?>?</label>

			<div class="col-sm-8">
				<?php echo SIMHTML::formRadioGroup(array_flip(SIMResources::$sino), $frm["SegundaClave"], "SegundaClave", "title=\"Segunda Clave\"") ?>
			</div>
		</div>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			<label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'SoloreservassegunGeoreferenciacion', LANGSESSION); ?>?</label>
			<div class="col-sm-8">
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-12">
			...
			<div class="col-sm-8">
				...
				<input type="radio" name="DirigidoAGeneral" id="DirigidoAGeneral" value="L" title="DirigidoA" <?php if ($frm["DirigidoAGeneral"] == "L") echo "checked"; ?> /><?= SIMUtil::get_traduccion('', '', 'Listadevotantes(sedebecrearelevento)', LANGSESSION); ?>
