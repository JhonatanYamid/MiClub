                        ...
                        <div class="tabbable">
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <?php if (SIMNet::req("action") == "edit") : ?>
                                    ...
                                    <li class="<?php if ($_GET[tabencuesta] == "respondervotaciones") echo "active"; ?>">
                                        <a data-toggle="tab" href="#respondervotaciones">
                                            <i class="green ace-icon fa fa-ticket  bigger-120"></i>
                                            Responder Votaciones
                                        </a>
                                    </li>
                            ...
                            <div class="tab-content">
                                ...
                                <?php if (SIMNet::req("action") == "edit") : ?>
                                    ...
                                    <div id="respondervotaciones" class="tab-pane fade <?php if ($_GET[tabencuesta] == "respondervotaciones") echo "in active"; ?>">
                                        <?php include("respondervotaciones.php"); ?>
                                    </div>
