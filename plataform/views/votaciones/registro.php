			...
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				<tr>
					...
					<th>Votante desde el administrador</th>
				...
				<tbody id="listacontactosanunciante">
					...
					$r_datos = $dbo->query("Select IDSocio,P.IDPregunta,IDUsuarioRemplazoVotante From PreguntaVotacion P,VotacionRespuesta ER Where ER.IDPregunta=P.IDPregunta and P.IDVotacion = '" . $frm[$key] . "' Group by IDSocio");
					...
					?>
						<tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
							...
							<td><?php echo utf8_encode($dbo->getFields("Usuario", "Nombre", "IDUsuario = '" . $r->IDUsuarioRemplazoVotante . "'")); ?></td>
