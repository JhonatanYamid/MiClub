<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Accion Socio </label>

            <div class="col-sm-8">
                <input type="text" id="AccionSocio" name="AccionSocio" placeholder="" class="col-xs-12" title="" value="<?php echo  $r_socio["Accion"]; ?>" readonly>
            </div>
        </div>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                if ($datos_pagoCredibanco["Modulo"] == "Domicilio" && ($frm[IDClub] == 8 || $frm[IDClub] == 16 || $frm[IDClub] == 72)) {
                    ...
                    //MOSTRAR NUMERO DE LA TARJETA
                    if ($frm[IDClub] == 72 || $frm[IDClub] == 8) {
                        echo "<br>";
                        echo "Número de la tarjeta:" . substr($data["cardAuthInfo"]["maskedPan"], -4);
                        echo "<br>";
                        echo "Código autorización:" . $data["authDateTime"];
                        echo "<br>";
                        echo "Franquicia:" . $data["cardAuthInfo"]["paymentSystem"];
                    }
                }
...
echo $r_detalle_pedido->IDProductoExterno;
                ...
                if (($frm[IDClub] == 8 || $frm[IDClub] == 7) && $frm["Propina"] == "S") { ?>
                    <tr>
                        <td align="center" colspan="13"><?= SIMUtil::get_traduccion('', '', 'Propina', LANGSESSION); ?>:
