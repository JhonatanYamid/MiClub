			...
			<div class="widget-main padding-4">
				<div class="row">
					<div class="col-xs-12">
						...
						<a href="procedures/excel-invitados.php?IDClub=<?php echo SIMUser::get("club") . $otos_parametros; ?>"><img src="assets/img/xls.gif" >Exportar</a>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Documento','Nombre','Apellido', 'Tipo','Clasificacion','Arl','Predio','Eliminar' ],
					colModel:[
						...
						{name:'Clasificacion',index:'Clasificacion', align:"left"},
						{name:'Arl',index:'Arl', align:"left"},
