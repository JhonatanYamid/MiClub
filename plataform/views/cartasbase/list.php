...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Numero', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Nombres', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Carta', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Tipo', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaCreacion', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
