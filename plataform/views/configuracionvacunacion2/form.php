                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-paper-plane green"></i> Configuracion estas vacunado
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar boton de Esta vacunado? </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label esta vacunado </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label respuesta "SI" para Esta Vacunado </label>
                                <div class="col-sm-8">
                                    <input id=LabelSi type=text size=25 name=LabelSi class="input" title="Label Si" value="<?=$frm["LabelSi"]?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label respuesta "NO" para Esta Vacunado </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label confirmación respuesta "SI" </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label confirmación respuesta "NO" </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label no quiero confirmacion </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite no quiero vacunar </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label no quiero vacunar </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Solicitar pedir terminos y condiciones? </label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-paper-plane green"></i> Configuracion Citas
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar boton registrar cita vacuna? </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label boton registrar cita vacuna </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label pregunta entidad que vacuna </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label confirma registrar cita para vacuna </label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-paper-plane green"></i> Configuracion Registro de vacuna
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar boton registrar vacuna? </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label boton registrar vacuna </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label pregunta entidad que vacunó </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label pregunta marca de vacuna </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label pregunta lugar de vacunación </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label confirma registrar vacuna </label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-paper-plane green"></i> Configuracion carnet del gobierno
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar Registrar Carne Gobierno </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label Registrar Carne Gobierno </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Intro Registrar Carne Gobierno </label>
                                <div class="col-sm-8">
                        ...
                        <div class="widget-header widget-header-large">
                            <h3 class="widget-title grey lighter">
                                <i class="ace-icon fa fa-paper-plane green"></i> Otros datos
                            </h3>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Email Notificación </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo campo entidad? </label>
                                <div class="col-sm-8">
                                    <select name="TipoCampoEntidad" id="TipoCampoEntidad" class="form-control">
                                        <option value=""></option>
                                        <option value="Texto" <?php if ($frm["TipoCampoEntidad"] == "Texto") {
                                            echo "selected";
                                        }
                                        ?>>Texto</option>
                                        <option value="Seleccion" <?php if ($frm["TipoCampoEntidad"] == "Seleccion") {
                                            echo "selected";
                                        }
                                        ?>>Seleccion</option>
                                    </select>
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto Ver Certificado Digital </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto Ejemplo Pdf Certificado </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto para indicar que puede ver y diligenciar el carne del nucelo familiar </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto boton para editar dosis </label>
                                <div class="col-sm-8">
                                    <input id=LabelBotonEditarDosis type=text size=25 name=LabelBotonEditarDosis class="input" title="LabelBotonEditarDosis" value="<?=$frm["LabelBotonEditarDosis"]?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label boton eliminar todas las dosis </label>
                                <div class="col-sm-8">
                                    <input id=LabelBotonEliminarTodas type=text size=25 name=LabelBotonEliminarTodas class="input" title="LabelBotonEliminarTodas" value="<?=$frm["LabelBotonEliminarTodas"]?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto confirmación eliminar dosis </label>
                                <div class="col-sm-8">
                                    <input id=LabelConfirmarEliminarTodas type=text size=25 name=LabelConfirmarEliminarTodas class="input" title="LabelConfirmarEliminarTodas" value="<?=$frm["LabelConfirmarEliminarTodas"]?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite editar la información de las dosis </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteEditar"], 'PermiteEditar', "class='input mandatory'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Permite eliminar todas las dosis </label>
                                <div class="col-sm-8">
                                    <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteEliminarTodas"], 'PermiteEliminarTodas', "class='input mandatory'") ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group first ">
                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Terminos y Condiciones </label>
