...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'DisponiblesEnStock', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Entregadas', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'publicar', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'NombreCategoriaObjeto',
                    index: 'NombreCategoriaObjeto',
                    align: "left"
                },
                {
                    name: 'DisponiblesEnStock',
                    index: 'DisponiblesEnStock',
                    align: "left"
                },
                {
                    name: 'Entregadas',
