            ...
            <tr>
              <td valign="top">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
                    ...
                    <td width="74%">
                      <select name="IDPropiedadProducto" id="IDPropiedadProducto" class="input mandatory" required>
                        ...
                        <?php $sql = "SELECT IDPropiedadProducto, Nombre
                                ...
                                WHERE IDClub = '" . $frm["IDClub"] . "' and Version= 3  ";
                  ...
                  <tr>
                    <td>Ocultar Precio</td>
                    <td><? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $EditCaracteristicaProducto["OcultarPrecioEnCero"], 'OcultarPrecioEnCero', "class='input'") ?></td>
                  </tr>
  ...
  <table id="simple-table" class="table table-striped table-bordered table-hover">
    ...
    <tbody id="listacontactosanunciante">
      ...
      $sql_carac = "SELECT CP.*,PP.Nombre as Categoria
                                    ...
                                    And CP.IDConfiguracionDomicilio = '" . $frm[$key]  . "' and PP.Version=3";
      ...
      ?>
        ...
        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
          <td align="center" width="64">
            <a href="<?php echo "?mod=" . SIMReg::get("mod") . "&action=edit&id=" . $_GET[id] . "&IDCaracteristicaProducto=" . $r->IDCaracteristicaProducto ?>&tabsocio=caracteristica&tab=caracteristicap" class="ace-icon glyphicon glyphicon-pencil"></a>
          </td>
          <td><?php echo $r->Nombre; ?></td>
          <td><?php echo $r->Categoria; ?></td>
          <td><?php echo $r->Publicar; ?></td>
          <td align="center" width="64">
            <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaCaracteristicaProducto&id=<?php echo $_GET[id]; ?>&IDCaracteristicaProducto=<? echo $r->IDCaracteristicaProducto ?>&tabsocio=caracteristica&tab=caracteristicap"></a>
          </td>
        </tr>
      <?php
      }
