...
<div class="widget-box transparent" id="recent-box">
    <div class="widget-header">
        <h4 class="widget-title lighter smaller">
            <i class="ace-icon fa fa-users orange"></i> Listado kits entregados
        </h4>
        ...
        <div class="widget-main padding-4">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <table id="grid-tablekitentregado"></table>

                    <div id="grid-pagerkitentregado"></div>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        var grid_selector = "#grid-tablekitentregado";
        var pager_selector = "#grid-pagerkitentregado";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Usuario que entrega', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>',
                'Apellido',
                'Numero camiseta',
                'Carrera',
                'Categoria',
            ...
            colModel: [{
                    name: 'UsuarioQueEntrega',
                    index: 'UsuarioQueEntrega',
                    align: "left"
                },
                {
                    name: 'Nombre',
        ...
        $(document).ready(function() {
            ...
            $('#btFiltrar').click(function() {
                ...
                $("#grid-tablekitentregado").jqGrid('setGridParam', {
                    url: ruta,
                    search: true,
                    postData: {
