...
<div class="widget-box transparent" id="recent-box">
    <div class="widget-header">
        <h4 class="widget-title lighter smaller">
            <i class="ace-icon fa fa-users orange"></i>Respuestas
        </h4>
        ...
        <div class="widget-main padding-4">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <table id="grid-tablekitrespuestas"></table>

                    <div id="grid-pagerkitrespuestas"></div>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        var grid_selector = "#grid-tablekitrespuestas";
        var pager_selector = "#grid-pagerkitrespuestas";
        ...
        ?>
            ...
            jQuery(grid_selector).jqGrid({
                ...
                echo "colNames: ['Usuario que entrega','Fecha','Hora','Documento corredor','Nombre Corredor','" . str_replace(",", "','", implode(",", $array_preguntas)) . '\'],'; ?>
                colModel: [{
                        name: 'Nombre',
                        index: 'Nombre',
                        width: '190',
                ...
                width: 855,
                multiselect: true,
                editurl: "includes/async/<?php echo $script; ?>.async.php<?= $url_search ?>",
        ...
        //enable  filtros de texto search/filter toolbar
        ...
        $(document).ready(function() {
            ...
            $('#btFiltrar').click(function() {
                ...
                $("#grid-tablekitrespuestas").jqGrid('setGridParam', {
                    url: ruta,
                    search: true,
                    postData: {
