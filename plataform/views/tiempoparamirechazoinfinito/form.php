                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                while ($r_area = $dbo->fetchArray($sql_id_auxilios)) : ?>
                                    <!-- <option value="<?php echo $r_area["IDAuxiliosInfinito"]; ?>" <?php if ($r_area["IDAuxiliosInfinito"] == $frm["IDAuxiliosInfinito"]) echo "selected";  ?>><?php echo $r_area["IDAuxilios"]; ?></option>-->
                                <?php
                                endwhile;    ?>
