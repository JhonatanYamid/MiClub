            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="col-sm-8">
                    ...
                    <?php if ($r->TipoCampo == "text") {
                        ...
                        if($r->IDPregunta == 7536):
                        
 
                     $accion_default = $dbo->query("SELECT * FROM Socio WHERE IDSocio =".$frm["IDSocio"]);
                     $accion_socio = $dbo->fetchArray($accion_default);
                    ?>
                       <input type="text"   name="Campo<?php echo $r->IDPregunta; ?>" id="Accion_Socio" class="mandatory"  placeholder="<?php echo $r->EtiquetaCampo; ?>" class="col-xs-12" title="<?php echo $r->EtiquetaCampo; ?>" value="<?php echo $accion_socio["Accion"]; ?>" <?php echo $ObligatorioTexto; ?>>
