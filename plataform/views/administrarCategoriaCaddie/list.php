...
//			jQuery(function($) {
                                    ...
                                    jQuery(grid_selector).jqGrid({
                                        ...
                                        url: 'includes/async/administrarCategoriaCaddie.async.php<?= $url_search ?>',
                                        datatype: "json",
                                        colNames: ['nombre', 'orden', 'Eliminar'],
                                        colModel: [
                                        ...
                                        width: 855,
                                        multiselect: true,
                                        editurl: "includes/async/administrarCategoriaCaddie.async.php",
