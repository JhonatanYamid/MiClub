<form class="form-horizontal formvalida" role="form" method="post" id="frmadministrarCategoriaCaddie" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
    ...
    <div  class="form-group first ">
        ...
        <div  class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="number" id="orden" name="orden" placeholder="Orden" class="col-xs-12 mandatory" title="orden" value="<?php echo utf8_encode($frm["orden"]); ?>" >
            </div>
        </div> 
