                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'PrecioNoAfiliado', LANGSESSION); ?> </label>

                                <div class="col-sm-8">
                                    <input type="number" id="PrecioNoAfiliado" name="PrecioNoAfiliado" placeholder="<?= SIMUtil::get_traduccion('', '', 'PrecioNoAfiliado', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'PrecioNoAfiliado', LANGSESSION); ?>" value="<?php echo $frm["PrecioNoAfiliado"]; ?>" <?php if (SIMUser::get("IDPerfil") == 86) echo "readonly"; ?>>
                                </div>
                            </div>
                        ...
                        <div class="form-group first ">
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Precioempaque', LANGSESSION); ?> </label>

                                <div class="col-sm-8">
                                    <input type="number" id="PrecioEmpaque" name="PrecioEmpaque" placeholder="<?= SIMUtil::get_traduccion('', '', 'Precioempaque', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Precioempaque', LANGSESSION); ?>" value="<?php echo $frm["PrecioEmpaque"]; ?>" <?php if (SIMUser::get("IDPerfil") == 86) echo "readonly"; ?>>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'Preciousuario', LANGSESSION); ?> </label>

                                <div class="col-sm-8">
                                    <input type="number" id="PrecioUsuario" name="PrecioUsuario" placeholder="<?= SIMUtil::get_traduccion('', '', 'Preciousuario', LANGSESSION); ?>" class="col-xs-12 mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Preciousuario', LANGSESSION); ?>" value="<?php echo $frm["PrecioUsuario"]; ?>" <?php if (SIMUser::get("IDPerfil") == 86) echo "readonly"; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> <?= SIMUtil::get_traduccion('', '', 'OcultarMostrarCantidad', LANGSESSION); ?> </label>

                                <div class="col-sm-8">
                                    <?php if (SIMUser::get("IDPerfil") != 86) { ?>
                                        <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["OcultarMostrarCantidad"], 'OcultarMostrarCantidad', "class='input mandatory'") ?>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="form-group first ">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    $sql_categoria_producto = $dbo->query("select * from ProductoCategoria2 where IDProducto = '" . $frm["IDProducto"] . "'");
                                    ...
                                    $query_categoria = $dbo->query("Select * from CategoriaProducto2 Where IDClub = '" . SIMUser::get("club") . "' Order by Nombre");
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    $query_carac = "SELECT CP.*,PP.Nombre as Categoria
																		...
																		And CP.IDClub = '" . SIMUser::get("club")  . "' and CP.Version = 2
