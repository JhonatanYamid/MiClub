			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="jqGrid_container">
						<a href="procedures/excel-producto.php?IDClub=<?php echo SIMUser::get("club") . $otos_parametros; ?>&Version=2"><img src="assets/img/xls.gif">Exportar</a>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'nombre', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Categoria', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Descripcion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Existencias', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'publicar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
