	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', 
					   ...
					   '<?= SIMUtil::get_traduccion('', '', 'cuentacontable', LANGSESSION); ?>', 
			...
			colModel: [
				...
				{name: 'TipoImpuesto',index: 'TipoImpuesto',align: "left"},
				{name: 'ValorImpuesto',index: 'ValorImpuesto',align: "left"},
				{name: 'CuentaContable',index: 'CuentaContable',align: "left"},
