					...
					<div class="col-sm-12">
						<div class="tabbable" id="myTABS" role="tablist">
							<ul class="nav nav-tabs" id="myTab">
								<li class="<?php if (empty($_GET[tabregistrosdinamicos])) echo "active"; ?>">
									<a data-toggle="tab" href="#home">
										<i class="green ace-icon fa fa-home bigger-120"></i>
										<?= SIMUtil::get_traduccion('', '', 'TipoFormulario', LANGSESSION); ?>
									</a>
								</li>

								<?php if (SIMNet::req("action") == "edit") : ?>
									<li class="<?php if ($_GET[tabregistrosdinamicos] == "formulario") echo "active"; ?>">
									...
									<li class="<?php if ($_GET[tabregistrosdinamicos] == "registros") echo "active"; ?>">
							...
							<div class="tab-content">
								<div id="home" class="tab-pane fade <?php if (empty($_GET[tabregistrosdinamicos])) echo "in active"; ?> ">
									<?php include("registrosdinamico.php"); ?>
								</div>

								<?php if (SIMNet::req("action") == "edit") : ?>
									<div id="messages" class="tab-pane fade <?php if ($_GET[tabregistrosdinamicos] == "formulario") echo "in active"; ?>">
										<?php include("preguntas.php"); ?>
									</div>



									<div id="invitaciones" class="tab-pane fade <?php if ($_GET[tabregistrosdinamicos] == "registros") echo "in active"; ?>" role="tabpanel">
		...
		?>
			$('#myTABS a[href="#invitaciones"]').on('click', function(e) {
				jQuery(grid_selector).jqGrid({
					url: 'includes/async/get_TipoFormulario.async.php?id=<?php echo $_GET["id"]; ?>',
					datatype: "json",
					//colNames:['Usuario','Valor','Fecha' ],
					<?php

					echo "colNames: ['Usuario','Fecha','Hora','" . str_replace(",", "','", implode(",", $array_preguntas)) . '\'],'; ?>
					colModel: [{
							name: 'Nombre',
							index: 'Nombre',
							width: '190',
