<? 
    ...
    switch($oper){
        ...
        case "crearArchivo":
            ...
            $codigoMunicipio = trim($info['IDCiudad']);//Codigo del municipio segun tabla de la Dian 
            ...
            foreach($productos as $producto){
                ...
                $prcntjImpuesto = $producto['PorcentajeImpuesto'] == 0 ? '0' : trim($producto['PorcentajeImpuesto']);//Porcentaje del IVA aplicado al item
