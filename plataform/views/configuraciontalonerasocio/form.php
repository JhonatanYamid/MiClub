            ...
            <div class="row">
                <div class="col-xs-8">
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group first ">
                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Hora Inicio Comida</label>
                            <div class="col-sm-4"><input type="time" id="HoraInicioComida" name="HoraInicioComida" class="form-control" title="Hora Inicio Comida" value="<?php echo $frm["HoraInicioComida"] ?>" required></div>
                        </div>
                        <div class="form-group first ">
                            <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Hora Fin Comida</label>
                            <div class="col-sm-4"><input type="time" id="HoraFinComida" name="HoraFinComida" class="form-control" title="Hora Fin Comida" value="<?php echo $frm["HoraFinComida"] ?>" required></div>
                        </div>
                        <div class="form-group first ">
                ...
                <div class="form-group first ">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Label para error de permisos con Comida</label>

                        <div class="col-sm-8">
                            <input type="text" id="LabelErrorComida" name="LabelErrorComida" placeholder="LabelErrorComida" class="col-xs-12 mandatory" title="LabelErrorComida" value="<?php echo $frm["LabelErrorComida"]; ?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4">
