...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Permitepais', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Permiteciudad', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Textobotonpais', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Textobotonciudad', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Activo', LANGSESSION); ?>',
            ...
            colModel: [{
                ...
                {
                    name: 'LabelBotonPais',
                    index: 'LabelBotonPais',
                    align: "left"
                },
                {
                    name: 'LabelBotonCiudad',
                    index: 'LabelBotonCiudad',
                    align: "left"
                },
                {
                    name: 'Activo',
