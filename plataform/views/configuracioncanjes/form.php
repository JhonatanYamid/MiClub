                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="form-group first">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="PermiteCanjeActivo"><?= SIMUtil::get_traduccion('', '', 'Permiteenviarcorreoalclubdestinoalmomentodecrearelcanje', LANGSESSION); ?>?</label>
                                    <div class="col-sm-8">
                                        <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteEnviarCorreoClubDestino"], 'PermiteEnviarCorreoClubDestino', "class='input'") ?>
                                    </div>
                            ...
                            <div class="form-group first">
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="PermiteCanjeActivo">Permite comentarios del socio?</label>
                                    <div class="col-sm-8">
                                        <? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["PermiteComentarios"], 'PermiteComentarios', "class='input'") ?>
                                    </div>
