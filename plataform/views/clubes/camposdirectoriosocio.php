                                                                              ...
                                                                              <tr>
                                                                                      ...
                                                                                      <td>
                                                                                              <select name="TipoCampo" id="TipoCampo" required>
                                                                                                      <option value=""></option>
                                                                                                      <option value="texto" <?php if ($EditCampoDirectorioSocio["TipoCampo"] == "texto") echo "selected"; ?>>Texto</option>
                                                                                                      <option value="telefono" <?php if ($EditCampoDirectorioSocio["TipoCampo"] == "telefono") echo "selected"; ?>>Telefono</option>
                                                                                                      <option value="email" <?php if ($EditCampoDirectorioSocio["TipoCampo"] == "email") echo "selected"; ?>>Email</option>
                                                                                                      <option value="whatsapp" <?php if ($EditCampoDirectorioSocio["TipoCampo"] == "whatsapp") echo "selected"; ?>>whatsapp</option>
                                                                                              </select>
                                                                                      </td>
                                                                              </tr>
                                                                              <tr>
                                ...
                                ?>
                                      ...
                                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                              <td align="center" width="64">
                                                      <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDCampoDirectorioSocio=" . $r->IDCampoDirectorioSocio ?>&tabclub=parametros&tabparametro=camposdirectoriosocio" class="ace-icon glyphicon glyphicon-pencil"></a>
                                              </td>
                                              ...
                                              <td align="center" width="64">
                                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaCampoDirectorioSocio&id=<?php echo $frm[$key]; ?>&IDCampoDirectorioSocio=<? echo $r->IDCampoDirectorioSocio ?>&tabclub=parametros&tabparametro=camposdirectoriosocio"></a>
                                              </td>
                                      </tr>
                              <?php
                                }
