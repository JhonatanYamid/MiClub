    ...
    <tbody id="listacontactosanunciante">
        ...
        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
            <td align="center" width="64">
                <a href="<?php echo $script.".php" . "?action=edit&id=" . $frm[$key] ."&IDPermisoSocioModulo=".$r->IDPermisoSocioModulo?>&tabclub=permisosociomodulo" class="ace-icon glyphicon glyphicon-pencil"></a>
            </td>
            <td>
                <?php
                ...
                foreach($array_invitados as $id_invitado => $datos_invitado):
                        ...
                        $IDSocioInvitacion=$array_datos_invitados[1];
                        if($IDSocioInvitacion>0):
                            $nombre_socio = $dbo->getFields( "Socio" , "Nombre" , "IDSocio = '".$IDSocioInvitacion."'" ) . "  " . $dbo->getFields( "Socio" , "Apellido" , "IDSocio = '".$IDSocioInvitacion."'" );
            ...
            <td align="center" width="64">
                <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get( "mod" )?>&action=EliminaPermisoSocioModulo&id=<?php echo $frm[$key];?>&IDPermisoSocioModulo=<? echo $r->IDPermisoSocioModulo ?>&tabclub=permisosociomodulo"></a>
            </td>
        </tr>
        <?php
                      }
