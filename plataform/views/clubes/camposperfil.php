      <div id="CampoEditarSocio">
              <form name="frmproCampoDirectorioSocio" id="frmproCampoDirectorioSocio" action="?mod=<?php echo SIMReg::get("mod") ?>" method="post" class="formvalida" enctype="multipart/form-data">
                  ...
                  -->
                                                                                      ...
                                                                                      <td>
                                                                                              <select class="form-control" id="Tipo" name="Tipo">
                                                                                                      ...
                                                                                                      <optgroup label="Elegantes">
                                                                                                              ...
                                                                                                              <option value="imagen" <?php if ($EditCampoEditarSocio["Tipo"] == "imagen") echo "selected"; ?>>Imagen</option>
                                                                                                              <option value="imagenarchivo" <?php if ($EditCampoEditarSocio["Tipo"] == "imagenarchivo") echo "selected"; ?>>Archivo</option>
                                                                                                      </optgroup>
                                                                              ...
                                                                              <tr>
                                                                                      <td>Publicar</td>
                                                                                      <td><? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $EditCampoEditarSocio["Publicar"], 'Publicar', "class='input'") ?></td>
                                                                              </tr>
                                                                              <tr>
                                                                                      <td align="center">&nbsp;</td>
                                                                              </tr>
                                ...
                                ?>
                                      ...
                                      <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                                              <td align="center" width="64">
                                                      <a href="<?php echo $script . ".php" . "?action=edit&id=" . $frm[$key] . "&IDCampoEditarSocio=" . $r->IDCampoEditarSocio ?>&tabclub=parametros&tabparametro=camposperfil" class="ace-icon glyphicon glyphicon-pencil"></a>
                                              </td>
                                              ...
                                              <td align="center" width="64">
                                                      <a class="ace-icon glyphicon glyphicon-remove confirma_eliminacion" href="?mod=<?php echo SIMReg::get("mod") ?>&action=EliminaCampoEditarSocio&id=<?php echo $frm[$key]; ?>&IDCampoEditarSocio=<? echo $r->IDCampoEditarSocio ?>&tabclub=parametros&tabparametro=camposperfil"></a>
                                              </td>
                                      </tr>
                              <?php
                                }
