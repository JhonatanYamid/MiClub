<form class="form-horizontal formvalida" role="form" method="post" id="SubModulos<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
  ...
  <div  class="form-group first ">
                          ...
                          $r_sql_modulo =& $dbo->all( "Modulo" , " IDModulo in (102,8,10,12,44,6,13,14,9) ");
                                          ...
                                          <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1'?>">
                                            <td width="10%" aling="center" >
                                                  ...
                                                  <select multiple class=" chosen-select form-control" name="Servicio<?php echo $r->IDModulo; ?>[]" id="Servicio<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione servicios...">
														  <?php
                                                           ...
                                                           foreach( $array_servicios as $id => $r_valor):
																		...
																		if(!empty($valores_guardados)):
																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                  ...
                                                                                  ?>
                                                                                  <option value="<?php echo $IDServicio ?>" <?php echo $seleccionar; ?>>
																				  	<?php
                                                  ...
                                                  <td width="200px">
                                                  <select multiple class=" chosen-select form-control" name="SeccionNoticia<?php echo $r->IDModulo; ?>[]" id="SeccionNoticia<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione secciones noticia...">
														  <?php
														  unset($array_valores_guardados);
                                                           ...
                                                           foreach( $array_secc_not as $id => $r_valor):
																		...
																		if(!empty($valores_guardados)):
																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                  ...
                                                                                  ?>
                                                                                  <option value="<?php echo $r_valor->IDSeccion ?>" <?php echo $seleccionar; ?>>
                                                 ...
                                                 <td width="200px">
                                                  <select multiple class=" chosen-select form-control" name="SeccionEvento<?php echo $r->IDModulo; ?>[]" id="SeccionEvento<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione secciones eventos...">
														  <?php
														  unset($array_valores_guardados);
                                                           foreach( $array_secc_eve as $id => $r_valor):
																		...
																		if(!empty($valores_guardados)):
																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                  ...
                                                                                  ?>
                                                                                  <option value="<?php echo $r_valor->IDSeccionEvento ?>" <?php echo $seleccionar; ?>>
																				  	<?php  echo $r_valor->Nombre; ?>
                                                                                  </option>
                                                  ...
                                                  <td width="200px">
                                                  <select multiple class=" chosen-select form-control" name="SeccionGaleria<?php echo $r->IDModulo; ?>[]" id="SeccionGaleria<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione secciones galeria...">
														  <?php
														  unset($array_valores_guardados);
                                                          foreach( $array_secc_gal as $id => $r_valor):
																		...
																		if(!empty($valores_guardados)):
																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                  ...
                                                                                  ?>
                                                                                  <option value="<?php echo $r_valor->IDSeccionGaleria ?>" <?php echo $seleccionar; ?>>
																				  	<?php  echo $r_valor->Nombre; ?>
                                                                                  </option>
                                                 ...
                                                 <td width="200px">
                                                  <select multiple class=" chosen-select form-control" name="TipoArchivo<?php echo $r->IDModulo; ?>[]" id="TipoArchivo<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione secciones galeria...">
														  <?php
														  unset($array_valores_guardados);
                                                          foreach( $array_tipo_arch as $id => $r_valor):
																		...
																		if(!empty($valores_guardados)):
																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                  ...
                                                                                  ?>
                                                                                  <option value="<?php echo $r_valor->IDTipoArchivo ?>" <?php echo $seleccionar; ?>>
																				  	<?php  echo $r_valor->Nombre; ?>
                                                                                  </option>
                                                  ...
                                                  <td width="200px">
                                                   <select multiple class=" chosen-select form-control" name="ModuloHijo<?php echo $r->IDModulo; ?>[]" id="ModuloHijo<?php echo $r->IDModulo; ?>" data-placeholder="Seleccione modulo...">
 														  <?php
 														  unset($array_valores_guardados);
                                                           foreach( $array_datos_modulo as $id => $r_valor):
 																		...
 																		if(!empty($valores_guardados)):
 																			$array_valores_guardados = explode("|",$valores_guardados);
                                                                                   ...
                                                                                   ?>
                                                                                   <option value="<?php echo $r_valor->IDModulo ?>" <?php echo $seleccionar; ?>>
 																				  	<?php  echo $r_valor->Nombre; ?>
                                                                                   </option>
