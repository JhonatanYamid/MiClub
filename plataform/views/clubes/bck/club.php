...
?> <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI()?>" enctype="multipart/form-data">
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Datos Basicos
        </h3>
    </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input name="Color1" type="color" value="<?php if (empty($frm["Color1"])) { echo "#FFFFFF"; } else{ echo $frm["Color1"]; }    ?>" />
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Color 2 </label>
            <div class="col-sm-8">
                <input name="Color2" type="color" value="<?php if (empty($frm["Color2"])) { echo "#FFFFFF"; } else{ echo $frm["Color2"]; }    ?>" />
            </div>
        </div>
    </div>
    <div class="form-group first ">
            ...
            <div class="col-sm-8">
                <select name="IDClubPadre" id="IDClubPadre">
                    <option value=""></option> <?php
                            ...
                            while ($r_club_padre = $dbo->fetchArray($qry_club_padre)): ?> <option value="<?php echo $r_club_padre["IDClub"]; ?>" <?php if($r_club_padre["IDClub"]==$frm["IDClubPadre"]) echo "selected";  ?>><?php echo $r_club_padre["Nombre"]; ?></option> <?php
                            endwhile;
                            ?>
                </select>
            </div>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Contrato y Envio Aceptación
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <a href="<? echo $script." .php?action=enviarcontratos&id=".$frm[$key]; ?>">
                    <button class="btn btn-info btnEnviarContrato" type="button">
                        <i class="ace-icon fa fa-check bigger-110"></i> Enviar contrato para aceptación. </button>
                </a>
            </div>
        </div> <?php
        } ?>
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-cloud-download green"></i> Control de Versiones
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-paper-plane green"></i> Configuraci&oacute;n Push
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
  ...
  -->
    ...
    <div class="form-group first ">
        ...
        <!-- <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input name="ColorFondoCarne" type="color" value="<?php if (empty($frm["ColorFondoCarne"])) { echo "#FFFFFF"; } else{ echo $frm["ColorFondoCarne"]; }    ?>" />
            </div>
        </div> -->
    </div>
    <!-- <div class="form-group first ">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Otros datos
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tipo: </label>
            <div class="col-sm-8"> <?php echo SIMHTML::formPopUp( "TipoClub" , "Nombre" , "Nombre" , "IDTipoClub" , $frm["IDTipoClub"] , "[Seleccione el Tipo]" , "popup mandatory" , "title = \"Tipo\"" )?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="TipoImagenBanner" id="TipoImagenBanner" value="Expandida" <?php if($frm["TipoImagenBanner"]=="Expandida") echo "checked"; ?>> <b>Expandida</b> (La imagen ocupará todo el espacio de la pantalla (100% ancho - 100% alto), manteniendo el aspect_ratio de la imagen) <br>
                <input type="radio" name="TipoImagenBanner" id="TipoImagenBanner" value="Ajustada" <?php if($frm["TipoImagenBanner"]=="Ajustada") echo "checked"; ?>> <b>Ajustada</b> (La imagen ocupará el espacio posible sin salirse de la pantalla, esto puede resultar en ocupar el 100% del ancho o 100% del alto, pero no los dos) <br>
 ...
 -->
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Boton para cargar pasaporte </label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["BotonCargarPasaporte"] , 'BotonCargarPasaporte' , "class='input '" ) ?> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Boton para cargar diploma </label>
            <div class="col-sm-8"> <?php echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["BotonCargarDiploma"] , 'BotonCargarDiploma' , "class='input '" ) ?> </div>
        </div>
    </div>
    <div class="form-group first">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto para boton para cargar pasaporte </label>
            <div class="col-sm-8">
                <input id=PasaporteCarneLabel type=text size=25 name=PasaporteCarneLabel class="col-xs-12" title="PasaporteCarneLabel" value="<?=$frm["PasaporteCarneLabel"] ?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Texto para boton para cargar diploma </label>
            <div class="col-sm-8">
                <input id=DiplomaCarneLabel type=text size=25 name=DiplomaCarneLabel class="col-xs-12" title="DiplomaCarneLabel" value="<?=$frm["DiplomaCarneLabel"] ?>">
            </div>
        </div>
    </div>
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Configuracion Modulo 1 Eventos
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="EventoLista" value="Imagen" <?php if($frm["EventoLista"]=="Imagen") echo "checked"; ?>>Imagen <input type="radio" name="EventoLista" value="Calendario" <?php if($frm["EventoLista"]=="Calendario") echo "checked"; ?>>Calendario
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Color encabezado eventos (modulo 1) </label>
            <div class="col-sm-8">
                <input name="ColorFondoEvento" type="color" value="<?php if (empty($frm["ColorFondoEvento"])) { echo "#FFFFFF"; } else{ echo $frm["ColorFondoEvento"]; }    ?>" />
            </div>
        </div>
    </div>
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="TipoCeldaEvento" value="Compacto" <?php if($frm["TipoCeldaEvento"]=="Compacto") echo "checked"; ?>>Compacto <input type="radio" name="TipoCeldaEvento" value="Ancho" <?php if($frm["TipoCeldaEvento"]=="Ancho") echo "checked"; ?>>Ancho
            </div>
        </div>
    </div>
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-info-circle green"></i> Configuracion Modulo 2 Eventos
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="EventoLista2" value="Imagen" <?php if($frm["EventoLista2"]=="Imagen") echo "checked"; ?>>Imagen <input type="radio" name="EventoLista2" value="Calendario" <?php if($frm["EventoLista2"]=="Calendario") echo "checked"; ?>>Calendario
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Color encabezado eventos (modulo2)</label>
            <div class="col-sm-8">
                <input name="ColorFondoEvento2" type="color" value="<?php if (empty($frm["ColorFondoEvento2"])) { echo "#FFFFFF"; } else{ echo $frm["ColorFondoEvento2"]; }    ?>" />
            </div>
        </div>
    </div>
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="radio" name="TipoCeldaEvento2" value="Compacto" <?php if($frm["TipoCeldaEvento2"]=="Compacto") echo "checked"; ?>>Compacto <input type="radio" name="TipoCeldaEvento2" value="Ancho" <?php if($frm["TipoCeldaEvento2"]=="Ancho") echo "checked"; ?>>Ancho
            </div>
        </div>
    </div>
    <!-- <div class="widget-header widget-header-large">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-gavel green"></i> PASA LA PAGINA
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> Configuracion Fedegolf
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="text" id="FechaInicioEditarPerfil" name="FechaInicioEditarPerfil" placeholder="Fecha Fin" class="col-xs-12 calendar" title="fecha fin" value="<?php if($frm["FechaInicioEditarPerfil"]=="" || $frm["FechaInicioEditarPerfil"]=="0000-00-00") echo ""; else echo $frm["FechaInicioEditarPerfil"] ?>">
            </div>
        </div>
    </div>
    <div class="form-group first ">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-bell-o green"></i> Configuraci&oacute;n Lista de espera
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-coffee green"></i> Configuraci&oacute;n Domicilios
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-coffee green"></i> Configuraci&oacute;n sección publica app
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Mostrar Publicidad: </label>
            <div class="col-sm-8">
                <? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["MostrarPublicidadPublica"] , 'MostrarPublicidadPublica' , "class='input '" ) ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Tiempo rotar Publicidad? </label>
            <div class="col-sm-8">
                <input id="PublicidadTiempoPublica" type=text size=25 name="PublicidadTiempoPublica" class="col-xs-12" title="PublicidadTiempoPublica" value="<?=$frm["PublicidadTiempoPublica"] ?>">segundos
            </div>
        </div>        
    </div>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <input type="radio" name="TipoHeaderApp" id="TipoHeaderApp" value="Noticias" <?php if($frm["TipoHeaderApp"]=="Noticias") echo "checked"; ?>> Noticias
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first "> 3 <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> PLACE TO PAY
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> ZONA VIRTUAL
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> CREDIBANCO REST
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> CREDIBANCO WEB
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> CREDIBANCO PAGO
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> Pasarela Wompi
        </h3>
    </div>
    <div class="form-group first ">
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6"><label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Api Key Privada Wompi </label>
            <div class="col-sm-8">
                <input type="password" id="PrivKeyWompi" name="PrivKeyWompi" placeholder="PrivKeyWompi" class="col-xs-12" title="ApiKey Wompi" value="<?php echo $frm["PrivKeyWompi"]; ?>">
            </div>
        </div>
    </div>
    <div class="form-group first ">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon"></i> Orden de Club
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-envelope-o green"></i> Parametros Envio Correos
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-envelope-o green"></i> Parametros PQR
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
    ...
    <div class="form-group first"> Respuesta automatica al crear PQR <div class="col-sm-12"> <?php
    ...
    <div class="form-group first"> Respuesta pesonalizada al responder PQR <div class="col-sm-12"> <?php
    ...
    <div class="form-group first"> Instrucciones QR <div class="col-sm-12"> <?php
    ...
    <div class="widget-header widget-header-large">
        <h3 class="widget-title grey lighter">
            <i class="ace-icon fa fa-glass green"></i> Configuracion de Servicios
        </h3>
    </div>
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-12"> <?php
						  ...
						  //echo SIMHTML::formCheckGroup( $arrayservicio , $servicio_club , "ServicioClub[]") ?> <table id="simple-table" class="table table-striped table-bordered table-hover">
                <tr>
                    <th>Activo</th>
                    <th>Servicio</th>
                    <th>Titulo</th>
        ...
        <div class="col-xs-12 col-sm-12"> <?php
                ...
                <tbody id="listacontactosanunciante"> <?php
                        ...
                        <td>
                            ...
                            <input type="hidden" name="ImagenOriginal<?php echo $r->IDModulo; ?>" id="ImagenOriginal<?php echo $r->IDModulo; ?>" value="<?php echo $r->Icono; ?>"> <?php
                                                    if($frm[IDClub]=="51"){
                                                        if (!empty($r->IconoLateral)) {
                                														echo "<img src='".MODULO_ROOT."$r->IconoLateral' width=55 >";
                                														?> <a href="<? echo $script." .php?action=delfotomodulo&foto=$r->IconoLateral&campo=IconoLateral&idclubmodulo=".$r->IDClubModulo; ?>&id=<?php echo $frm[IDClub]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
                                													}// END if
                            ...
                            <input type="hidden" name="ImagenOriginalLateral<?php echo $r->IDModulo; ?>" id="ImagenOriginalLateral<?php echo $r->IDModulo; ?>" value="<?php echo $r->IconoLateral; ?>"> <?php } ?>
                        </td>
                        ...
                        <td> <?php
                        												  ...
                        												  ?> <input type="checkbox" name="UbicacionModulo<?php echo $r->IDModulo; ?>[]" <?php if (in_array("Lateral",$ubicacion_modulo)) echo "checked"; ?> value="Lateral"> Menu Lateral app <br><input type="checkbox" name="UbicacionModulo<?php echo $r->IDModulo; ?>[]" <?php if (in_array("Central",$ubicacion_modulo)) echo "checked"; ?> value="Central">Menu central app </td>
                    </tr> <?php
                                          }
                                          ?> </tbody>
                <tr>
