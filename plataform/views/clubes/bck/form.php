			...
			<div class="row">
				<div class="col-xs-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <li class="<?php if($_GET[tabclub]=="sanciones") echo "active"; ?>">
													<?php if($_GET["vista"]=="otros") { ?>
														<a data-toggle="tab" href="#sanciones">
													<?php } else{	?>
															<a href="clubes.php?action=edit&vista=otros&tabclub=sanciones&id=<?=$id ?>">
													<?php }?>
                        ...
                        <div id="sanciones" class="tab-pane fade <?php if($_GET[tabclub]=="sanciones") echo "in active"; ?>">
													Sanciones
													<?php
													if(!empty($_GET["vista"]) || !empty($_GET["tabclub"]))
														include ("sanciones.php");
													?>
												</div>
