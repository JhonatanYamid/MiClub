                            ...
                            <td valign="top">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <? echo SIMHTML::formradiogroup(SIMResources::$sino, $EditConfiguracionGaleriaEmpleados["PermiteMeGusta"], 'PermiteMeGusta', "class='input mandatory'") ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="70%">
                                            <? if (!empty($EditConfiguracionGaleriaEmpleados[ImagenMeGustaLleno])) {
                                                echo "<img src='" . GALERIA_ROOT . "$EditConfiguracionGaleriaEmpleados[ImagenMeGustaLleno]' width=55 >";
                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="70%">
                                            <? if (!empty($EditConfiguracionGaleriaEmpleados[ImagenMeGustaVacio])) {
                                                echo "<img src='" . GALERIA_ROOT . "$EditConfiguracionGaleriaEmpleados[ImagenMeGustaVacio]' width=55 >";
                                            ?>
