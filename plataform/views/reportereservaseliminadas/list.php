	...
	<div class="widget-box transparent" id="recent-box">
		<div class="widget-header">
			<h4 class="widget-title lighter smaller">
				<i class="ace-icon fa fa-users orange"></i>REPORTE RESERVAS ELIMINADAS
			</h4>
		...
		<div class="widget-body">
			<div class="widget-main padding-4">
				<div class="row">
                    ...
                    <form class="form-horizontal formvalida" role="form" method="get" name="frm" id="frm" action="downloadreservaeliminada.php" enctype="multipart/form-data">
                                                                   ...
                                                                   <input type="hidden" name="IDServicio" id="IDServicio" value="T">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url:'includes/async/reportereservaseliminadas.async.php<?=$url_search ?>',
					datatype: "json",
					colNames:['Servicio', 'Nombre Socio', 'Apellido Socio', 'Fecha', 'Creada Por'],
					colModel:[						
						{name:'Servicio',index:'Servicio', align:"left"},
						...
						{name:'Creada Por',index:'UsuarioTrCr', align:"left"},					
					...
					width:855,
					multiselect: true,
					editurl: "includes/async/reportereservas.async.php",
