	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				<input type="text" id="NombreSeccion" name="NombreSeccion" class="input" value="<?php echo $dbo->getFields("Seccion3", "Nombre", "IDSeccion = '" . $frm["IDSeccion"] . "'") ?>" readonly>
				<a href="PopupSeccion3.php" target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=1000'); return false;" class="ace-icon glyphicon glyphicon-search"></a>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6">
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto2File&id=" . $frm[$key]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																								} else {
	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto3File&id=" . $frm[$key]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																								} else {
																																									?> <input type="file" name="Adjunto3Documento" id="Adjunto3Documento" class="popup" title="Noticia Documento"> <?php
																																																																				}
																																																																					?>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelDocNot&cam=Adjunto4File&id=" . $frm[$key]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																								} else {
																																									?> <input type="file" name="Adjunto4Documento" id="Adjunto4Documento" class="popup" title="Noticia Documento"> <?php
																																																																				}
																																																																					?>
			</div>
		</div>
	...
	<div class="form-group first ">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=NoticiaFile&id=" . $frm[$key]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																								} else {
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8"> <?php
					...
					<a href="<? echo $script . ".php?action=DelImgNot&cam=FotoPortada&id=" . $frm[$key]; ?>" class="ace-icon glyphicon glyphicon-trash">&nbsp;</a> <?php
																																								} else {
