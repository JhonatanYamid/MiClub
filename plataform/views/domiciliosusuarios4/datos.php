<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" <?php if ($_GET['action'] == 'edit') echo "disabled" ?>>
                    <option value=""></option>
                    <?php
                    $sql_restaurante_club = "Select IDRestauranteDomicilio,Nombre From RestauranteDomicilio4 Where IDClub = '" . SIMUser::get("club") . "' AND Publicar='S'";
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <textarea id="ComentariosSocio" name="ComentariosSocio" cols="10" rows="5" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'ComentarioUsuario', LANGSESSION); ?>" <?php if ($_GET["action"] != "add") echo "readonly"; ?>><?php echo $frm["ComentariosSocio"]; ?></textarea>
            </div>
        </div>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                <input type="text" id="Celular" name="Celular" placeholder="<?= SIMUtil::get_traduccion('', '', 'CelularUsuario', LANGSESSION); ?>" class="col-xs-12" title="<?= SIMUtil::get_traduccion('', '', 'CelularUsuario', LANGSESSION); ?>" value="<?php echo $frm["Celular"]; ?>" readonly>
            </div>
        </div>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"><?= SIMUtil::get_traduccion('', '', 'NotificaraUsuario', LANGSESSION); ?>? </label>
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <!--<input type="text" id="FormaPago" name="FormaPago" placeholder="Forma Pago" class="col-xs-12" title="FormaPago" value="<?php echo $frm["FormaPago"]; ?>" readonly >-->
            </div>
        </div>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                ?>
                    <tr>
                        <td><?php echo $dbo->getFields("DomicilioPregunta", "Nombre", "IDDomicilioPregunta = '" . $row_otro_dato["IDDomicilioPregunta"] . "' AND Version='4'"); ?></td>
    ...
    <div class="form-group first ">
        ...
        <div class="col-xs-12 col-sm-12">
            ...
            $sql_detalle_pedido = $dbo->query("select * from DomicilioDetalle4 where IDDomicilio = '" . $frm[IDDomicilio] . "'");
                ...
                <tbody id="listacontactosanunciante">
                    ...
                    ?>
                        ...
                        <tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
                            <td aling="center">
                                <?
                                $fotoprod = $dbo->getFields("Producto4", "Foto1", "IDProducto = '" . $r_detalle_pedido->IDProducto . "'");
                                if (!empty($fotoprod)) {
                            ...
                            <td><?php
                                $datos_producto = $dbo->fetchAll("Producto4", " IDProducto = '" . $r_detalle_pedido->IDProducto . "' ", "array");
