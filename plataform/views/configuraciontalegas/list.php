...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Boton Solicitar Talega', 'Boton Lugar de Solicitud', 'Boton Fecha de Solicitud', 'Activo', 'Eliminar'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
                ...
                {
                    name: 'LabelBotonSolicitarTalega',
                    index: 'LabelBotonSolicitarTalega',
                    align: "left"
                },

                {
                    name: 'LabelLugarSolicitarTalega',
                    index: 'LabelLugarSolicitarTalega',
                    align: "left"
                },
                {
                    name: 'LabelFechaSolicitarTalega',
                    index: 'LabelFechaSolicitarTalega',
                    align: "left"
                },
                {
                    name: 'Activo',
            ...
            rowNum: 100,
            rowList: [20, 40, 100],
            sortname: 'LabelBotonSolicitarTalega',
            viewrecords: true,
            sortorder: "ASC",
