...
$sql_usuario_restaurante = $dbo->query("select * from UsuarioRestaurante3 where IDUsuario = '" . SIMUser::get("IDUsuario") . "'");
...
<form class="form-horizontal formvalida" role="form" method="post" id="frmOrden" name="frmOrden" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-sm-8">
                ...
                <select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" class="form-control mandatory" title="<?= SIMUtil::get_traduccion('', '', 'Restaurante', LANGSESSION); ?>">
                    ...
                    <?php
                    $sql_grupos = "Select * From RestauranteDomicilio3 Where IDClub = '" . SIMUser::get("club") . "' $condicionRestaurante";
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Comentario Socio </label>
    ...
    <div class="form-group first ">
        <div class="col-xs-12 col-sm-6">
            <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Celular Socio </label>
            <div class="col-sm-8">
    ...
    <?php
    $sql = "SELECT IDCategoriaProducto, Nombre FROM CategoriaProducto3 WHERE IDClub = '" . SIMUser::get("club") . "'  $condicionRestaurante ORDER BY Orden ASC";
    $query = $dbo->query($sql);
    ...
    ?>
        ...
        <div class="form-group first ">
            ...
            $sqlProductos = "SELECT P.IDProducto, P.Nombre FROM Producto3 P, CategoriaProducto3 CP, ProductoCategoria3 PC WHERE CP.IDCategoriaProducto = " . $row['IDCategoriaProducto'] . " AND PC.IDCategoriaProducto = CP.IDCategoriaProducto AND PC.IDProducto = P.IDProducto";
