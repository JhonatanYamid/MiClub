<form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				<select name="IDRestauranteDomicilio" id="IDRestauranteDomicilio" <?php if ($_GET['action'] == 'edit') echo "disabled" ?>>
					<option value=""></option>
					<?php
					$sql_restaurante_club = "Select IDRestauranteDomicilio,Nombre From RestauranteDomicilio3 Where IDClub = '" . SIMUser::get("club") . "' AND Publicar='S'";
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<div class="col-sm-8">
				...
				?>
					<tr>
						<td><?php echo $dbo->getFields("DomicilioPregunta", "Nombre", "IDDomicilioPregunta = '" . $row_otro_dato["IDDomicilioPregunta"] . "' AND Version='3'"); ?></td>
	...
	<div class="form-group first ">
		...
		<div class="col-xs-12 col-sm-12">
			...
			$sql_detalle_pedido = $dbo->query("select * from DomicilioDetalle3 where IDDomicilio = '" . $frm[IDDomicilio] . "'");
				...
				<tbody id="listacontactosanunciante">
					...
					?>
						...
						<tr class="<?php echo SIMUtil::repetition() ? 'row0' : 'row1' ?>">
							<td aling="center">
								<?
								$fotoprod = $dbo->getFields("Producto3", "Foto1", "IDProducto = '" . $r_detalle_pedido->IDProducto . "'");
								if (!empty($fotoprod)) {
							...
							<td><?php
								$datos_producto = $dbo->fetchAll("Producto3", " IDProducto = '" . $r_detalle_pedido->IDProducto . "' ", "array");
