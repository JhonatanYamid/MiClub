...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Numero', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Restaurante', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Funcionario', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Comentarios', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Fecha', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FormaDePago', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center",
