...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['Editar', 'Nombre', 'MostrarBotonHistorial', 'TextoBotonHistorial', 'Eliminar'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
                ...
                {
                    name: 'MostrarBotonHistorial',
                    index: 'MostrarBotonHistorial',
                    align: "left"
                },
                {
                    name: 'TextoBotonHistorial',
                    index: 'TextoBotonHistorial',
                    align: "left"
                },
                {
                    name: 'Eliminar',
            ...
            rowNum: 100,
            rowList: [20, 40, 100],
            sortname: 'IDConfiguracionEncuestaArbol',
            viewrecords: true,
            sortorder: "ASC",
