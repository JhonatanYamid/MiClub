		...
		<div class="widget-main padding-4">
			<div class="row">
				<div class="col-xs-12">
					...
					<a href="procedures/excel-canjes.php?IDClub=<?php echo SIMUser::get("club"); ?>"><img src="assets/img/xls.gif"><?= SIMUtil::get_traduccion('', '', 'Exportar', LANGSESSION); ?></a>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Numero', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Accion', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'CorreoElectronico', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Club', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaInicio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Estado', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
			colModel: [{
					name: 'Editar',
					index: '',
					align: "center"
