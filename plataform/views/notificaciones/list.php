...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'TituloMensaje', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Mensaje', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Enviados', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Leido', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Eliminar', LANGSESSION); ?>'],
            colModel: [{
                    name: 'Editar',
                    index: '',
                    align: "center"
