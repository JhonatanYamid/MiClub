                    ...
                    <form class="form-horizontal formvalida" role="form" method="post" id="frm<?php echo $script; ?>" action="<?php echo SIMUtil::lastURI() ?>" enctype="multipart/form-data">
                        <div class="form-group first ">
                            ...
                            <div class="form-group first">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="col-sm-4 control-label" for="SabadoLaboral"> <?= SIMUtil::get_traduccion('', '', 'Sabado laboral', LANGSESSION); ?> </label>

                                    <div class="col-sm-8"><? echo SIMHTML::formradiogroup(array_flip(SIMResources::$sino), $frm["SabadoLaboral"], 'SabadoLaboral', "class='input'") ?></div>
                                </div>
