            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="jqGrid_container">
                        <form name="frmexportapqr" id="frmexportapqr" method="post" enctype="multipart/form-data" action="procedures/excel-bquillanoresidentes.php">
                            <table>
                                <tr>
                                    <td><input type="text" id="FechaDeInicio" name="FechaDeInicio" placeholder="Fecha Inicio" class="col-xs-12 calendar" title="Fecha De Inicio" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td><input type="text" id="FechaFinal" name="FechaFinal" placeholder=" Fecha Final" class="col-xs-12 calendar" title="Fecha Final" value="<?php echo date("Y-m-d") ?>"></td>
                                    <td>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            colNames: ['<?= SIMUtil::get_traduccion('', '', 'Editar', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'Socio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'NombreVisitante', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaInicio', LANGSESSION); ?>', '<?= SIMUtil::get_traduccion('', '', 'FechaFin', LANGSESSION); ?>',
