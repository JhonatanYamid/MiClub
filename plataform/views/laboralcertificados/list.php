		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					colNames:['Editar','Usuario', 'Usuario Autoriza', 'Tipo','Estado','Fechas','A nombre de','Comentario','Comentario Aprobacion','Fecha Aprobación','Eliminar' ],
					colModel:[
						{name:'Editar',index:'', align:"center"},
						{name:'Usuario',index:'Usuario', align:"left"},
						{name:'UsuarioAutoriza',index:'UsuarioAutoriza', align:"left"},
						{name:'Tipo',index:'Tipo', align:"left"},
						{name:'Estado',index:'Estado', align:"left"},
						{name:'Fechas',index:'Fechas', align:"left"},
						{name:'Anombrede',index:'Anombrede', align:"left"},
						{name:'Comentario',index:'Comentario', align:"left"},
						{name:'ComentarioAprobacion',index:'ComentarioAprobacion', align:"left"},
						{name:'FechaAprobacion',index:'FechaAprobacion', align:"left"},
