...
include("procedures/configuraciondomiciliario.php");
include("cmp/seo.php");
?>
</head>
                    ...
                    ?>
                        <div class="ace-settings-container" id="ace-settings-container">
                            ...
                            <button class="btn btn-danger btnRedirect" rel="<?php echo $script ?>.php?action=add">
                                ...
                                <?= SIMUtil::get_traduccion('', '', 'Nuevo', LANGSESSION); ?> <?php echo $title; ?>
                            </button>
                                    ...
                                    <div class="widget-box transparent" id="recent-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title lighter smaller">
                                                <i class="ace-icon fa fa-users orange"></i><?= SIMUtil::get_traduccion('', '', 'Consultar ', LANGSESSION); ?><?php echo $title; ?>
                                            </h4>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                        ...
                                                                        <button type="button" class="btn btn-purple btn-sm btnEnviar" rel="frmfrmBuscar">
                                                                            ...
                                                                            <?= SIMUtil::get_traduccion('', '', 'Buscar ', LANGSESSION); ?> <?php echo $title; ?>
                                                                        </button>
                                                                    </span>
                                                                    <span class="input-group-btn">
