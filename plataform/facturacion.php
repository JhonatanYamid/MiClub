...
include("procedures/facturacion.php");
include("cmp/seo.php");
?>
</head>
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					SIMNotify::each();
					if ($view == "views/" . $script . "/list.php") {
						include("cmp/botoncrear.php");
					} else if($view == "views/" . $script . "/factura.php"){ ?>
						<div class="ace-settings-container" id="ace-settings-container">
							<button type="button" onclick="history.back()" class="btn btn-primary btn-sm btnRedirect" rel="<?php echo $script; ?>.php?action=search">
								<i class="ace-icon fa fa-undo align-top bigger-125"></i>
								<?= SIMUtil::get_traduccion('', '', 'Regresar', LANGSESSION); ?>
							</button>
						</div>
					<? } else{ ?>
						<div class="ace-settings-container" id="ace-settings-container">
