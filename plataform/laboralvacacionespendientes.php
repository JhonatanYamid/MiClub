                ...
                <div class="page-content">
                    ...
                    ?>
                        <div class="ace-settings-container" id="ace-settings-container">
                            ...
                            <br><br>
                            <button class="btn btn-info fancybox" href="cargamasivalaboralvacacionespendientes.php" data-fancybox-type="iframe">
                                <i class="ace-icon fa fa-cloud-upload align-top bigger-125"></i>
                                Carga Masiva laboral vacaciones pendientes
                            </button>
