...
include("procedures/diagnostico.php");
include("cmp/seo.php");
?>
</head>
...
<body class="no-skin">
    ...
    <div class="main-container" id="main-container">
        ...
        ?>
        <script>
            $("#exppqr").click(function() {
                var inicio = new Date($('#FechaInicioSocio').val())
                var fin = new Date($('#FechaFinSocio').val())

                var Diferencia = inicio.getTime() - fin.getTime();
                var Dias = Diferencia / (1000 * 3600 * 24);
                Dias = Math.round(Math.abs(Dias));
                if (Dias > 15) {
                    alert('Reporte no debe ser superior a 15 días');
                } else {
                    $('#frmexportapqrSocio').submit();
                }
