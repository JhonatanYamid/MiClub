<?
	...
	include( "procedures/autorizaciones.php" );
	include("cmp/seo.php");
			...
			<div class="main-content">
                ...
                <button class="btn btn-danger  fancybox" href="<?php echo $script?>.php?action=add" data-fancybox-type="iframe">
								...
								Nuevo <?php echo strtoupper(SIMReg::get( "title" ))?>							</button>
								 ...
								 <br><br>
                                 <button class="btn btn-info fancybox" href="cargamasivacontratista.php" data-fancybox-type="iframe">
								<i class="ace-icon fa fa-cloud-upload align-top bigger-125"></i>
								Carga Masiva de Contratistas						</button>
							<?php endif; ?>
							</div>
						<?
						}//end if
