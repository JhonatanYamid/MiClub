...
include("procedures/cartasbase.php");
include("cmp/seo.php");
?>
</head>
				...
				<div class="page-content">
					...
					?>
						<div class="ace-settings-container" id="ace-settings-container">
							...
							<br><br>
							<button class="btn btn-info fancybox" href="cargamasivacartabase.php" data-fancybox-type="iframe">
								<i class="ace-icon fa fa-cloud-upload align-top bigger-125"></i>
								<?= SIMUtil::get_traduccion('', '', 'CargaMasivaBaseCartera', LANGSESSION); ?> </button>
