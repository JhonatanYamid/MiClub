...
include("procedures/dashboardpqrfuncionario.php");
include("cmp/seo.php");
?>

<?php
header("Refresh: 1200; URL='https://miclubapp.com/plataform/dashboardpqrfuncionario.php'");
?>
...
<script>
	...
	function CargarDatoslineal() {
		...
		$.ajax({
			url: 'includes/async/dashboardpqrfuncionario.async.php',
			type: 'POST',
			DataType: 'json',
			data: ({
