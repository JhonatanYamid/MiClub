													...
													<div class="widget-body">
														<div class="widget-main padding-4">
															<div class="row">
																...
																<form class="form-horizontal formvalida" role="form" method="get" name="frm" id="frm" action="downloadsanciones.php" enctype="multipart/form-data">
																				...
																				<div class="col-sm-8">
																					<select name = "IDServicioElemento" id="IDServicioElemento"  >
																						...
																						while ($r_area = $dbo->fetchArray($qry_area_club)): ?>
																							<option value="<?php echo $r_area["IDServicioElemento"]; ?>" ><?php echo $r_area["Nombre"]; ?></option>
																							<?php
																						endwhile;?>
																					</select>
																				</div>
                                                                   ...
                                                                   <button class="btn btn-info btnEnviar" type="button" rel="frm" >
                                                                    ...
                                                                    <button class="btn btn-info btnEnviar" type="button" onClick="envia_planilla2();" >
                                                                        <i class="ace-icon fa fa-cloud-download bigger-110"></i>
                                                                        Exportar planilla golf formato 2
                                                                    </button>
																	<?php
																	}
																	?>
