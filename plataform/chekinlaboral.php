...
include("procedures/chekinlaboral.php");
include("cmp/seo.php");
?>
</head>
                ...
                <div class="page-content">
                    ...
                    ?>
                        <div class="ace-settings-container" id="ace-settings-container">
                            ...
                            <br><br>
                            <button class="btn btn-danger fancybox" href="chekinlaboraldespuesdeturno.php" data-fancybox-type="iframe">
                                <i class="ace-icon fa fa-file align-top bigger-125"></i>
                                <?= SIMUtil::get_traduccion('', '', 'Nuevo', LANGSESSION); ?> <?= SIMUtil::get_traduccion('', '', SIMReg::get("title"), LANGSESSION); ?> Despues Del Turno
                            </button>
