...
include("procedures/tiempoparamisolicitudinfinito.php");
include("cmp/seo.php");
?>
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    SIMNotify::each();
                    $disable = 1;
                    if ($view <> "views/" . $script . "/form.php" && $disable == 0) {
                    ?>
                        <div class="ace-settings-container" id="ace-settings-container">

                            <button class="btn btn-danger btnRedirect" rel="<?php echo $script ?>.php?action=add&IDModulo=<?php echo $_GET["IDModulo"] ?>">
                                                            ...
                                                            <div class="col-xs-12 col-sm-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary btn-sm btnRedirect" rel="<?php echo $script; ?>.php?action=search&IDModulo=<?php echo $_GET["IDModulo"] ?>">
                                                                            Ver Todos
                                                                        </button>
                                                                    </span>
                                                                </div>
