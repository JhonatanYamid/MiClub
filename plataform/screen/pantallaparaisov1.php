                ...
                <table>
                  <tr>
                      ...
                      -->
                        ...
                        <table>
                            <tr>
                                <td class="blanco">TOTAL PERSONAS EMPLEADOS</td>
                                <td class="verde"><?php echo $total_adentro; ?></td>
                            </tr>

                            <tr>
                                <td class="blanco"> Total personas socios e invitados</td>
                                <td class="verde"><?php echo $total_personas_casa_multi; ?></td>
                            </tr>
                        ...
                        <table>
                            <tr>
                                <td class="amarillo">Total personas</td>
                                <td class="verde"><?php echo $grantotal=$total_personas_club+$total_adentro; ?></td>
                            </tr>
