...
<body>
 ...
 $nombre_tomo_reserva;
    $result = str_replace("2 Cupos.", "", $nombre_tomo_reserva);
    $result1 = str_replace("1 Cupos.", "", $result);
    $result2 = str_replace("Socio pruebas pruebas", "", $result1);
 /*   
// ordeno y verifico si son los mismos clientes
sort($_SESSION['nombres'];
sort($nombre_tomo_reserva);
*/
if ($_SESSION['nombres'] == "$nombre_tomo_reserva" )
    echo "";
else 
    //le quito las palabras adicionales
 $a=$nombre_tomo_reserva;
    $resultado = str_replace("2 Cupos.", "", $a);
    $resultado1 = str_replace("1 Cupos.", "", $resultado);
    $resultado2 = str_replace("Socio pruebas pruebas", "", $resultado1);
    
    
    //guardo los clientes en session 
      echo  $resultado2; 
$_SESSION['nombres'] =  $nombre_tomo_reserva;                       
