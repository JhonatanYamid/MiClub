				...
				<div class="page-content">
					...
					?>
						<div class="ace-settings-container" id="ace-settings-container">
							...
							<button class="btn btn-success btnRedirect" rel="<?php echo $script ?>.php?action=add">
														...
														<form class="form-horizontal formvalida" id="frmfrmBuscar" name="frmfrmBuscar" role="form" action="<?php echo SIMUtil::lastURI() ?>" method="get">
															...
															<div class="col-xs-12 col-sm-8">
																<div class="input-group">
																	...
																	<input type="text" name="qryString" class="form-control search-query " placeholder="<?= SIMUtil::get_traduccion('', '', 'Ingreseelnúmerodederechoonombredelsocio', LANGSESSION); ?>">
																	...
																	<span class="input-group-btn">
																		...
																		<button type="button" class="btn btn-primary btn-sm btnRedirect" rel="socios.php?action=search">
