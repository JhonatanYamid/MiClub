...
class SIMWebServicePuertoAzul 
{
 
    public function App_AutenticarUser($email, $Clave)
    {
       
$url = "https://clubpuertoazul.dyndns.org/tisolucionesapi/socios/login";
...
curl_close($curl);
     ...
     $token=$resp[access_token]; */
       ...
       $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://clubpuertoazul.dyndns.org/tisolucionesapi/socios/datosocio", 
    ...
    {  
     $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://clubpuertoazul.dyndns.org/tisolucionesapi/socios/datosfamiliares", 
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
