...
class SIMWebServiceClasificados
{
	...
	public function get_configuracion_clasificado($IDClub, $IDSocio)
	{
		...
		if ($dbo->rows($qry) > 0) {
			...
			while ($r = $dbo->fetchArray($qry)) {
				...
				$sqlConfiguracionClasificado = "SELECT PermiteMostrarPalabraMeta,TextoPalabraMeta,LabelValor,PermiteAgregarMasFotos FROM ConfiguracionClasificados  WHERE IDClub = '" . $IDClub . "' AND ConfiguracionPara='S' AND Activo='S'";
				...
				if (!empty($ConfiguracionClasificado["LabelValor"])) {
					$configuracion["LabelValor"] = $ConfiguracionClasificado["LabelValor"];
				} else {
				...
				$configuracion["PermiteAgregarMasFotos"] = $ConfiguracionClasificado["PermiteAgregarMasFotos"];

				if (!empty($datos_config_clasif["TextoBotonWhatsApp"])) {
					$TextoBotonWhatsapp = $datos_config_clasif["TextoBotonWhatsApp"];
				} else {
					$TextoBotonWhatsapp = "Contactar por Whatsapp";
				}
				$configuracion["TextoBotonWhatsApp"] = $TextoBotonWhatsapp;
	...
	public function get_clasificado($id_club, $id_categoria = "", $id_clasificado = "", $tag = "", $IDSocio, $IDEstadoClasificado, $IDUsuario)
	{
		...
		if ($dbo->rows($qry) > 0) {
			...
			while ($r = $dbo->fetchArray($qry)) {
				...
				//MOSTRAR SOCIO QUE CREO EL CLASIFICADO
				$PermiteMostrarSocio = $dbo->getFields("ConfiguracionClasificados", "PermiteMostrarUsuario", "IDClub = '" . $id_club . "' AND Activo='S' AND ConfiguracionPara='S'");

				if ($PermiteMostrarSocio == "S") {
					$nombreSocio = $dbo->getFields("Socio", "Nombre", "IDSocio = '" . $r["IDSocio"] . "'") . " " . $dbo->getFields("Socio", "Apellido", "IDSocio = '" . $r["IDSocio"] . "'");
					$mostrarSocio = "<br><b>Creado por:" . $nombreSocio . "</b><br>";
				}
				$clasificado["Nombre"] = $r["Nombre"];

				$clasificado["Descripcion"] =  strip_tags($r["Descripcion"]) . $mostrarSocio . $Fechas;
				$clasificado["Telefono"] = $r["Telefono"];
				$clasificado["Email"] = $r["Email"];
				$clasificado["MensajeWhatsapp"] =  $r["MensajeWhatsapp"];
		...
		if (!empty($IDClub) && (!empty($IDSocio) || !empty($IDUsuario)) && !empty($IDCategoria) && !empty($Nombre) && !empty($Descripcion) && !empty($Telefono)) {
			...
			if (!empty($id_socio)) {
				...
				if ($TipoApp == "Empleado") :
					...
					$sql_clasificado = $dbo->query("Insert Into Clasificado (IDUsuario, IDSeccionClasificados, IDClub, IDEstadoClasificado, Nombre, Descripcion, Telefono, Email, Valor, FechaInicio, FechaFin, Foto1, Foto2, Foto3, Foto4, Foto5, Foto6,Foto7,Foto8,Foto9,Foto10,Foto11,UsuarioTrCr, FechaTrCr, Tipo,Whatsapp) Values ('" . $IDUsuario . "','" . $IDCategoria . "','" . $IDClub . "','" . $IDEstadoDefecto . "','" . $Nombre . "','" . $Descripcion . "','" . $Telefono . "','" . $Email . "','" . $Valor . "','" . $FechaInicio . "','" . $FechaFin . "','" . $Foto1 . "','" . $Foto2 . "','" . $Foto3 . "','" . $Foto4 . "','" . $Foto5 . "','" . $Foto6 . "','" . $Foto7 . "','" . $Foto8 . "','" . $Foto9 . "','" . $Foto10 . "','" . $Foto11 . "','App',NOW(), '$TipoApp', '" . $Whatsapp . "')");
				//$sql_clasificado = $dbo->query("Insert Into Clasificado (IDUsuario, IDSeccionClasificados, IDClub, IDEstadoClasificado, Nombre, Descripcion, Telefono, Email, Valor, FechaInicio, FechaFin, Foto1, Foto2, Foto3, Foto4, Foto5, Foto6, UsuarioTrCr, FechaTrCr, Tipo,Whatsapp) Values ('" . $IDUsuario . "','" . $IDCategoria . "','" . $IDClub . "','" . $IDEstadoDefecto . "','" . $Nombre . "','" . $Descripcion . "','" . $Telefono . "','" . $Email . "','" . $Valor . "','" . $FechaInicio . "','" . $FechaFin . "','" . $Foto1 . "','" . $Foto2 . "','" . $Foto3 . "','" . $Foto4 . "','" . $Foto5 . "','" . $Foto6 . "','App',NOW(), '$TipoApp', '" . $Whatsapp . "')");
					...
					//$sql_clasificado = $dbo->query("Insert Into Clasificado (IDSocio, IDSeccionClasificados, IDClub, IDEstadoClasificado, Nombre, Descripcion, Telefono, Email, Valor, FechaInicio, FechaFin, Foto1, Foto2, Foto3, Foto4, Foto5, Foto6,Foto7,Foto8,Foto9,Foto10,Foto11, UsuarioTrCr, FechaTrCr, Tipo,Whatsapp) Values ('" . $IDSocio . "','" . $IDCategoria . "','" . $IDClub . "','" . $IDEstadoDefecto . "','" . $Nombre . "','" . $Descripcion . "','" . $Telefono . "','" . $Email . "','" . $Valor . "','" . $FechaInicio . "','" . $FechaFin . "','" . $Foto1 . "','" . $Foto2 . "','" . $Foto3 . "','" . $Foto4 . "','" . $Foto5 . "','" . $Foto6 . "','", $Foto7 . "','" . $Foto8 . "','" . $Foto9 . "','" . $Foto10 . "','" . $Foto11 . "','App',NOW(), '$TipoApp','" . $Whatsapp . "')");
					$sql_clasificado = $dbo->query("Insert Into Clasificado (IDSocio, IDSeccionClasificados, IDClub, IDEstadoClasificado, Nombre, Descripcion, Telefono, Email, Valor, FechaInicio, FechaFin, Foto1, Foto2, Foto3, Foto4, Foto5, Foto6,Foto7,Foto8,Foto9,Foto10,Foto11,UsuarioTrCr, FechaTrCr, Tipo,Whatsapp) Values ('" . $IDSocio . "','" . $IDCategoria . "','" . $IDClub . "','" . $IDEstadoDefecto . "','" . $Nombre . "','" . $Descripcion . "','" . $Telefono . "','" . $Email . "','" . $Valor . "','" . $FechaInicio . "','" . $FechaFin . "','" . $Foto1 . "','" . $Foto2 . "','" . $Foto3 . "','" . $Foto4 . "','" . $Foto5 . "','" . $Foto6 . "','" . $Foto7 . "','" . $Foto8 . "','" . $Foto9 . "','" . $Foto10 . "','" . $Foto11 . "','App',NOW(), '$TipoApp', '" . $Whatsapp . "')");
				endif;
	...
	public function set_edita_clasificado($IDClub, $IDSocio, $IDClasificado, $IDEstadoClasificado, $IDCategoria, $Nombre, $Descripcion, $Telefono, $Email, $Valor, $FechaInicio, $FechaFin, $File = "", $UrlFoto1, $UrlFoto2, $UrlFoto3, $UrlFoto4, $UrlFoto5, $IDUsuario, $Whatsapp, $UrlFoto6, $UrlFoto7, $UrlFoto8, $UrlFoto9, $UrlFoto10, $UrlFoto11)
	{
		$dbo = &SIMDB::get();
		if (!empty($IDClub) && !empty($IDClasificado) && (!empty($IDSocio) || !empty($IDUsuario)) && !empty($IDCategoria) && !empty($Nombre) && !empty($Descripcion) && !empty($Telefono)) {
			...
			if (!empty($id_clasificado)) {
				...
				$sql_clasificado = "Update Clasificado set Foto1='',Foto2='',Foto3='',Foto4='',Foto5='',Foto6='',Foto7='',Foto8='',Foto9='',Foto10='',Foto11=''
				...
				if (!empty($UrlFoto6)) {
					$actualiza_foto .= " , Foto6 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto6) . "'";
				}
				if (!empty($UrlFoto7)) {
					$actualiza_foto .= " , Foto7 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto7) . "'";
				}
				if (!empty($UrlFoto8)) {
					$actualiza_foto .= " , Foto8 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto8) . "'";
				}
				if (!empty($UrlFoto9)) {
					$actualiza_foto .= " , Foto9 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto9) . "'";
				}
				if (!empty($UrlFoto10)) {
					$actualiza_foto .= " , Foto10 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto10) . "'";
				}
				if (!empty($UrlFoto11)) {
					$actualiza_foto .= " , Foto11 = '" . str_replace(CLASIFICADOS_ROOT, "", $UrlFoto11) . "'";
				}
